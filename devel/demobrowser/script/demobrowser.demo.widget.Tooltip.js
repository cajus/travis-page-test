...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.widget.Tooltip.4acdb1948a7d.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
,__KJ:4,__KK:0,add:function(B){this.container.add(B,{row:Math.floor(this.__KK/this.__KJ),column:this.__KK%this.__KJ});this.__KK+=1;}
