...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.bom.Window.df8f9ddd935a.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="Open Native Window",b="Open Native Modal Window",c="demobrowser.demo.bom.Window",d="Modal Window closed?",f="http://sourceforge.net",g="window1",h="window3",i="http://slashdot.org",j="Window closed?",k="http://qooxdoo.org",l="demobrowser/demo/html/ModalWindow.html",m="#eee",n="Open Faked Native Modal Window",o="window2",p="tap",q="button";qx.Class.define(c,{extend:qx.application.Native,members:{__Hx:null,main:function(){qx.application.Native.prototype.main.call(this);var r=qx.util.ResourceManager.getInstance();this.__Hx=[k,f,i,r.toUri(l)];var u=qx.bom.Input.create(q);qx.bom.Input.setValue(u,a);document.body.appendChild(u);qx.event.Registration.addListener(u,p,function(e){var x={width:400,height:200,top:200,left:100,scrollbars:false,menubar:true,status:false};this.window1=qx.bom.Window.open(this.__Hx[0],g,x);}
...
,this);var s=qx.bom.Input.create(q);qx.bom.Input.setValue(s,b);document.body.appendChild(s);qx.event.Registration.addListener(s,p,function(e){var y={width:400,height:200,top:200,left:100,scrollbars:false};this.window2=qx.bom.Window.open(this.__Hx[3],o,y,true);}
...
,this);var v=qx.bom.Input.create(q);qx.bom.Input.setValue(v,n);document.body.appendChild(v);qx.event.Registration.addListener(v,p,function(e){var A={width:800,height:600,top:200,left:100,scrollbars:false};var z=qx.bom.Window.getBlocker();z.setBlockerColor(m);z.setBlockerOpacity(0.5);this.window3=qx.bom.Window.open(this.__Hx[0],h,A,true,false);}
,this);}
...
(function(){var a="no",b="px",c="qx.bom.Window",d="Cross-Domain Scripting problem: Could not resize window!",e="' is not supported for native windows.",f="interval",g="dialogWidth",h="resizable",i=":",j="yes",k="dialogTop",l="qxNativeWindow",m="Cross-Domain Scripting problem: Could not move window!",n="",o="Option '",p="javascript:/",q="dialogLeft",r="dialogHeight",s="' is not supported for modal windows.",t='load',u="scrollbars",v="=",w=";",x="scroll",y=",";qx.Class.define(c,{statics:{__gy:null,__wE:null,__rq:null,__wF:{"top":k,left:q,width:g,height:r,scrollbars:x,resizable:h},__wG:{"top":1,left:1,width:1,height:1,dependent:1,resizable:1,status:1,location:1,menubar:1,scrollbars:1,toolbar:1},__wH:function(){return window.showModalDialog!=null;}
,open:function(z,name,H,E,A,D,self){var C=null;if(z==null){z=p;}
;if(name==null){name=l+new Date().getTime();}
;if(A==null){A=true;}
;var G=this.__wI(H,E&&A);if(E){if(this.__wH()&&A){C=window.showModalDialog(z,[window.self],G);}
else {this.getBlocker().block();if(this.__rq==null){this.__rq=new qx.event.Timer(500);this.__rq.addListener(f,this.__wJ,this);}
;this.__wE=window.open(z,name,G);this.__rq.restart();C=this.__wE;}
;}
...
;return C;}
,__wI:function(K,O){var M;var J;var N=[];if(O&&this.__wH()){for(var L in K){if(qx.bom.Window.__wF[L]){var I=n;if(L!=u&&L!=h){I=b;}
;J=qx.bom.Window.__wF[L]+i+K[L]+I;N.push(J);}
else {qx.log.Logger.warn(o+L+s);}
;}
;M=N.join(w);}
else {for(var L in K){if(qx.bom.Window.__wG[L]){if(qx.lang.Type.isBoolean(K[L])){J=L+v+(K[L]?j:a);}
else {J=L+v+K[L];}
;N.push(J);}
...
;M=N.join(y);}
;return M;}
,__wJ:function(){if(this.isClosed(this.__wE)){this.getBlocker().unblock();this.__rq.stop();}
;}
,getBlocker:function(){if(this.__gy==null){this.__gy=new qx.bom.Blocker;}
;return this.__gy;}
...
(function(){var a="resize",b="mshtml",c="backgroundColor",d="block",f="transparent",g="px",h="zIndex",i="src",j="engine.name",k="0px",l="allowTransparency",m="div",n="javascript:false;",o="qx.bom.Blocker",p="absolute";qx.Class.define(o,{extend:qx.core.Object,construct:function(){qx.core.Object.call(this);this.__nz();}
,members:{__wK:null,__hp:null,__wL:null,__wM:false,__wN:10000,__wO:0,__wP:f,block:function(r){if(!this.__wM){this.__wL=r;var q=this.__wS();this.__wT(q);this.__wM=true;}
;}
,unblock:function(){if(this.__wM){this.__wU();this.__wM=false;}
;}
,isBlocked:function(){return this.__wM;}
,getBlockerElement:function(){return this.__hp;}
,setBlockerColor:function(s){qx.bom.element.Style.set(this.__hp,c,s);}
,getBlockerColor:function(){return qx.bom.element.Style.get(this.__hp,c);}
,setBlockerOpacity:function(t){qx.bom.element.Opacity.set(this.__hp,t);}
,getBlockerOpacity:function(){return qx.bom.element.Opacity.get(this.__hp);}
,setBlockerZIndex:function(u){qx.bom.element.Style.set(this.__hp,h,u);}
,getBlockerZIndex:function(){return qx.bom.element.Style.get(this.__hp,h);}
,__nz:function(){this.__wQ();if((qx.core.Environment.get(j)==b)){this.__wR();}
;qx.event.Registration.addListener(window,a,this.__nd,this);}
,__wQ:function(){this.__hp=qx.dom.Element.create(m);qx.bom.element.Style.setStyles(this.__hp,{display:d,opacity:this.__wO,backgroundColor:this.__wP});this.setBlockerZIndex(this.__wN);}
,__wR:function(){this.__wK=qx.bom.Iframe.create();qx.bom.element.Attribute.set(this.__wK,l,false);qx.bom.element.Attribute.set(this.__wK,i,n);qx.bom.element.Style.setStyles(this.__wK,{display:d,opacity:this.__wO});}
,__wS:function(){var v={position:p};if(this.__wW()){v.left=k;v.top=k;v.right=null;v.bottom=null;v.width=qx.bom.Document.getWidth()+g;v.height=qx.bom.Document.getHeight()+g;}
else {v.width=qx.bom.element.Dimension.getWidth(this.__wL)+g;v.height=qx.bom.element.Dimension.getHeight(this.__wL)+g;v.left=qx.bom.element.Location.getLeft(this.__wL)+g;v.top=qx.bom.element.Location.getTop(this.__wL)+g;}
;return v;}
,__wT:function(w){var x=document.body;qx.bom.element.Style.setStyles(this.__hp,w);qx.dom.Element.insertEnd(this.__hp,x);if((qx.core.Environment.get(j)==b)){w.zIndex=this.getBlockerZIndex()-1;qx.bom.element.Style.setStyles(this.__wK,w);qx.dom.Element.insertEnd(this.__wK,document.body);}
;}
,__wU:function(){qx.dom.Element.remove(this.__hp);if((qx.core.Environment.get(j)==b)){qx.dom.Element.remove(this.__wK);}
;}
,__nd:function(e){if(this.__wW()){this.__wV({width:k,height:k});qx.event.Timer.once(function(){var y={width:qx.bom.Document.getWidth()+g,height:qx.bom.Document.getHeight()+g};this.__wV(y);}
,this,0);}
;}
,__wV:function(z){qx.bom.element.Style.setStyles(this.__hp,z);if((qx.core.Environment.get(j)==b)){qx.bom.element.Style.setStyles(this.__wK,z);}
;}
,__wW:function(){return (this.__wL==null||qx.dom.Node.isWindow(this.__wL)||qx.dom.Node.isDocument(this.__wL));}
},destruct:function(){qx.event.Registration.removeListener(window,a,this.__nd,this);this.__wK=this.__hp=this.__wL=null;}
});}
)();
