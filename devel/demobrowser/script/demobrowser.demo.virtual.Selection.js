...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.virtual.Selection.5cba55fdb2ee.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
;this.__gR=qx.bom.Stylesheet.createElement(p);this.__gS={};this.__gT={};}
,members:{__gR:null,__gS:null,__gT:null,getStylesheet:function(){return this.__gR;}
,getCssClass:function(q){return this.__gS[q]||null;}
,computeClassForStyles:function(t,r){var s=this.__gT[r];if(!s){var s=this.__gU();qx.bom.Stylesheet.addRule(this.__gR,k+s,r);this.__gT[r]=s;}
;this.__gS[t]=s;return s;}
,__gU:function(){return e+this.toHashCode()+a+(this.__gV++ );}
,__gV:0},destruct:function(){this.__gR=this.__gS=this.__gT=null;}
});}
)();
(function(){var a="-",b="backgroundColor",c="_applyTextAlign",d="px",e="paddingLeft",f="_applyFont",g="Integer",h="_applyBackgroundColor",j="_applyPadding",k="cell",l="center",m="font",n=":",o="shorthand",p="Color",q="String",r="_applyAppearance",s="background-color:",t="",u="textAlign",v="qx-cell ",w="left",x="textColor",y="text-align:",z="Font",A="paddingBottom",B="paddingTop",C="right",D="_applyTextColor",E="justify",F="color:",G="paddingRight",H=" ",I=";",J="qx.ui.virtual.cell.Cell";qx.Class.define(J,{extend:qx.ui.virtual.cell.Abstract,construct:function(){qx.ui.virtual.cell.Abstract.call(this);this.__gR=qx.ui.virtual.cell.CellStylesheet.getInstance();this.__gX={};this.__gY={};this.__ha={};this.__hb={};this.__hc={};this.__hd={};this.initAppearance();this.__hh();}
,properties:{appearance:{check:q,init:k,apply:r},backgroundColor:{nullable:true,check:p,apply:h,themeable:true},textColor:{nullable:true,check:p,apply:D,themeable:true},textAlign:{check:[w,l,C,E],nullable:true,themeable:true,apply:c},font:{nullable:true,apply:f,check:z,themeable:true},paddingTop:{check:g,init:0,apply:j,themeable:true},paddingRight:{check:g,nullable:true,apply:j,themeable:true},paddingBottom:{check:g,nullable:true,apply:j,themeable:true},paddingLeft:{check:g,nullable:true,apply:j,themeable:true},padding:{group:[B,G,A,e],mode:o,themeable:true}},members:{__he:null,__hf:null,__hc:null,__hd:null,__gY:null,__gX:null,__ha:null,__hb:null,__hg:false,__gR:null,__hh:function(){var M=qx.util.PropertyUtil;var K=qx.lang.Object.fromArray(this._getCssProperties());this.__he=[];var O=this.constructor;while(O){var L=M.getProperties(O);for(var N in L){if(!K[N]){this.__he.push(N);}
;}
;O=O.superclass;}
;}
,_getCssProperties:function(){return [b,x,m,u,B,G,A,e];}
,_applyAppearance:function(Q,P){if(P){this.__gY={};}
;}
...
;}
,_storeStyle:function(T,S){var U;if(this.__hg){U=this.__gY;}
else {U=this.__gX;}
...
;}
,_applyPadding:function(bh,bg,name){var bh=this._getValue(name);if(this.__hg){var bi=this.__hb;}
else {bi=this.__ha;}
...
,getCssClasses:function(br,bp){var bq=this.__gR.getCssClass(this.__hf)||t;return v+bq;}
,__hi:function(bs){if(!bs){bs={};}
;var bu=this.getAppearance();var bt=bu+a+Object.keys(bs).sort().join(H);if(this.__hf==bt){return;}
;this.__hf=bt;var bv=this.__hc[this.__hf];if(!bv){this.__hj();this.__hk(bs);this.__hl(bs);this.__hm();this.__hc[this.__hf]=1;}
;this.__hn();}
...
;}
,__hk:function(bz){this.__gY={};this.__hg=true;var bB=this.getAppearance();var bA=qx.util.PropertyUtil;var by=qx.theme.manager.Appearance.getInstance().styleFrom(bB,bz);for(var bC in by){if(by[bC]!==undefined){bA.setThemed(this,bC,by[bC]);}
;}
;this.__hg=false;}
,__hl:function(){var bD=qx.lang.Object.getValues(this.__gY).join(I);this.__gR.computeClassForStyles(this.__hf,bD);}
...
;}
,getStyles:function(bN,bM){return qx.lang.Object.getValues(this.__gX).join(I);}
,getInsets:function(bQ,bR){var bT=this.__ha;var bS=this.__hb;var top=(bT.paddingTop!==undefined?bT.paddingTop:bS.paddingTop)||0;var bO=(bT.paddingRight!==undefined?bT.paddingRight:bS.paddingRight)||0;var bP=(bT.paddingBottom!==undefined?bT.paddingBottom:bS.paddingBottom)||0;var bU=(bT.paddingLeft!==undefined?bT.paddingLeft:bS.paddingLeft)||0;return [bU+bO,top+bP];}
},destruct:function(){this.__gR=this.__gX=this.__gY=this.__ha=this.__hb=this.__hc=this.__hd=this.__he=null;}
});}
)();
