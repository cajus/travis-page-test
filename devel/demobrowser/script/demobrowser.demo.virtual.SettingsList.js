...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.virtual.SettingsList.fcb8983218d7.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="name",b="group.checked",c="#ddd",d="Fruits",f="label",g="Apple",h="Carrot",j="Vegetables",k="demobrowser.demo.virtual.SettingsList",l="value",m="changeValue",n="Orange",o="Potato",p="checked";qx.Class.define(k,{extend:qx.application.Standalone,members:{__iR:null,main:function(){qx.application.Standalone.prototype.main.call(this);var q=[];var s=[g,n,o,h];for(var i=0;i<s.length;i++ ){q[i]={name:s[i],checked:i<2,group:null};}
;this.__iR=qx.data.marshal.Json.createModel(q,true);var t=[];for(var i=0;i<2;i++ ){t[i]={name:null,checked:false};}
;t=qx.data.marshal.Json.createModel(t,true);t.getItem(0).setName(d);t.getItem(1).setName(j);this.__iR.toArray().forEach(function(u,v){v=v<2?0:1;u.setGroup(t.getItem(v));}
);var r=new qx.ui.list.List();r.setWidth(150);this.getRoot().add(r,{left:20,top:20});r.setDelegate(this);r.setModel(this.__iR);}
...
;var y=e.getData();this.__iR.forEach(function(z){if(x.getLabel()==z.getGroup().getName()){z.setChecked(y);}
;}
);}
,this);}
,bindItem:function(B,A,D){B.bindProperty(a,f,null,A,D);B.bindProperty(p,l,null,A,D);B.bindPropertyReverse(p,l,null,A,D);var C=this.__iR;B.bindPropertyReverse(b,l,{converter:function(H,J){var I=J.getItem(D);var F=I.getGroup();var G=C.toArray().filter(function(L){return L.getGroup()==F;}
