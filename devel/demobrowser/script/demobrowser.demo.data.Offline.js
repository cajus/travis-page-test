...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.data.Offline.846fa3d6553c.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
;this._storeModel=qx.util.Function.debounce(this.__gE.bind(this),qx.data.store.Offline.STORE_MODEL_DELAY);this._marshaler=new qx.data.marshal.Json(i);this._key=j;this._initializeModel();}
,properties:{model:{nullable:true,event:d,apply:g}},statics:{STORE_MODEL_DELAY:400},members:{_storage:null,__gD:null,__gE:function(){var k=qx.util.Serializer.toNativeObject(this.getModel());this._storage.setItem(this._key,k);}
,_applyModel:function(m,l){if(l){l.removeListenerById(this.__gD);l.dispose();this.__gD=null;}
;if(m){this.__gD=m.addListener(f,this._storeModel,this);this._storeModel();}
...
(function(){var a="html.storage.local",b="html.storage.userdata",c="qx.bom.Storage";qx.Bootstrap.define(c,{statics:{__gF:null,getLocal:function(){if(qx.core.Environment.get(a)){return qx.bom.storage.Web.getLocal();}
...
(function(){var a="local",b="session",c="Storage",d="qx.bom.storage.Web",f="Storage full.";qx.Bootstrap.define(d,{statics:{__gG:null,__gH:null,getLocal:function(){if(this.__gG){return this.__gG;}
;return this.__gG=new qx.bom.storage.Web(a);}
,getSession:function(){if(this.__gH){return this.__gH;}
;return this.__gH=new qx.bom.storage.Web(b);}
},construct:function(g){this.__gI=g;}
,members:{__gI:null,getStorage:function(){return window[this.__gI+c];}
,getLength:function(){return this.getStorage(this.__gI).length;}
,setItem:function(h,j){j=qx.lang.Json.stringify(j);try{this.getStorage(this.__gI).setItem(h,j);}
catch(e){throw new Error(f);}
;}
,getItem:function(l){var k=this.getStorage(this.__gI).getItem(l);if(qx.lang.Type.isString(k)){k=qx.lang.Json.parse(k);}
else if(k&&k.value&&qx.lang.Type.isString(k.value)){k=qx.lang.Json.parse(k.value);}
;return k;}
,removeItem:function(m){this.getStorage(this.__gI).removeItem(m);}
,clear:function(){var n=this.getStorage(this.__gI);if(!n.clear){for(var i=n.length-1;i>=0;i-- ){n.removeItem(n.key(i));}
;}
else {n.clear();}
;}
,getKey:function(o){return this.getStorage(this.__gI).key(o);}
,forEach:function(p,r){var length=this.getLength();for(var i=0;i<length;i++ ){var q=this.getKey(i);p.call(r,q,this.getItem(q));}
;}
}});}
)();
(function(){var a="session",b="head",c="none",d="qx",e="qx.bom.storage.UserData",f="div",g="local",h="qxtest",j="#default#userdata",k="display";qx.Bootstrap.define(e,{statics:{__gG:null,__gH:null,__gJ:0,getLocal:function(){if(this.__gG){return this.__gG;}
;return this.__gG=new qx.bom.storage.UserData(g);}
,getSession:function(){if(this.__gH){return this.__gH;}
;return this.__gH=new qx.bom.storage.UserData(a);}
},construct:function(m){this.__gK=document.createElement(f);this.__gK.style[k]=c;document.getElementsByTagName(b)[0].appendChild(this.__gK);this.__gK.addBehavior(j);this.__gL=m;this.__gK.load(this.__gL);this.__gM={};this.__gN={};var l=this.__gK.getAttribute(d+qx.bom.storage.UserData.__gJ);while(l!=undefined){l=qx.lang.Json.parse(l);this.__gM[l.key]=l.value;this.__gN[l.key]=d+qx.bom.storage.UserData.__gJ;qx.bom.storage.UserData.__gJ++ ;l=this.__gK.getAttribute(d+qx.bom.storage.UserData.__gJ);}
;}
,members:{__gK:null,__gL:h,__gM:null,__gN:null,getStorage:function(){return this.__gM;}
,getLength:function(){return Object.keys(this.__gM).length;}
,setItem:function(n,p){if(this.__gN[n]){var o=this.__gN[n];}
else {var o=d+qx.bom.storage.UserData.__gJ;qx.bom.storage.UserData.__gJ++ ;}
;var q=qx.lang.Json.stringify({key:n,value:p});this.__gK.setAttribute(o,q);this.__gK.save(this.__gL);this.__gM[n]=p;this.__gN[n]=o;}
,getItem:function(r){return this.__gM[r]||null;}
,removeItem:function(v){var u=this.__gN[v];if(u==undefined){return;}
;this.__gK.removeAttribute(u);qx.bom.storage.UserData.__gJ-- ;delete this.__gM[v];delete this.__gN[v];var t=d+qx.bom.storage.UserData.__gJ;if(this.__gK.getAttribute(t)){var w=this.__gK.getAttribute(d+qx.bom.storage.UserData.__gJ);this.__gK.removeAttribute(t);this.__gK.setAttribute(u,w);var s=qx.lang.Json.parse(w).key;this.__gN[s]=u;}
;this.__gK.save(this.__gL);}
,clear:function(){for(var x in this.__gN){this.__gK.removeAttribute(this.__gN[x]);}
;this.__gK.save(this.__gL);this.__gM={};this.__gN={};}
,getKey:function(y){return Object.keys(this.__gM)[y];}
,forEach:function(z,B){var length=this.getLength();for(var i=0;i<length;i++ ){var A=this.getKey(i);z.call(B,A,this.getItem(A));}
;}
}});}
)();
(function(){var a="qx.bom.storage.Memory";qx.Bootstrap.define(a,{statics:{__gG:null,__gH:null,getLocal:function(){if(this.__gG){return this.__gG;}
;return this.__gG=new qx.bom.storage.Memory();}
,getSession:function(){if(this.__gH){return this.__gH;}
;return this.__gH=new qx.bom.storage.Memory();}
},construct:function(){this.__gM={};}
,members:{__gM:null,getStorage:function(){return this.__gM;}
,getLength:function(){return Object.keys(this.__gM).length;}
,setItem:function(b,c){c=qx.lang.Json.stringify(c);this.__gM[b]=c;}
,getItem:function(e){var d=this.__gM[e];if(qx.lang.Type.isString(d)){d=qx.lang.Json.parse(d);}
;return d;}
,removeItem:function(f){delete this.__gM[f];}
,clear:function(){this.__gM={};}
,getKey:function(h){var g=Object.keys(this.__gM);return g[h];}
