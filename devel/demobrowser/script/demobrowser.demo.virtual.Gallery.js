...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.virtual.Gallery.f21451779e08.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
;}
}});qx.Class.define(f,{extend:demobrowser.demo.virtual.AbstractGallery,construct:function(bv){demobrowser.demo.virtual.AbstractGallery.call(this,bv);this.__Km=new demobrowser.demo.virtual.GalleryCell();}
,members:{__Km:null,_createScroller:function(){var bw=new qx.ui.virtual.core.Scroller(1,this.itemPerLine,this.itemHeight,this.itemWidth);this.layer=new qx.ui.virtual.layer.WidgetCell(this);bw.getPane().addLayer(this.layer);new qx.ui.virtual.behavior.Prefetch(bw,{minLeft:0,maxLeft:0,minRight:0,maxRight:0,minAbove:200,maxAbove:300,minBelow:600,maxBelow:800}).set({interval:500});return bw;}
...
;if(by){this.__Km.updateStates(bx,{selected:1});}
else {this.__Km.updateStates(bx,{});}
;}
;}
...
;var bE=this.__Km.getCellWidget(bF,bD);bE.setUserData(n,bH);return bE;}
,poolCellWidget:function(bJ){this.__Km.pool(bJ);}
...
(function(){var a="_applyInterval",b="appear",c="qx.debug",d="interval",e="qx.ui.virtual.behavior.Prefetch",f="scroll",g="_applyScroller",h="qx.ui.virtual.core.Scroller",i="__rq",j="scrollbar-x",k="Integer",l="scrollbar-y";qx.Class.define(e,{extend:qx.core.Object,construct:function(m,n){if(qx.core.Environment.get(c)){this.assertObject(n);this.assertPositiveInteger(n.minLeft);this.assertPositiveInteger(n.maxLeft);this.assertPositiveInteger(n.minRight);this.assertPositiveInteger(n.maxRight);this.assertPositiveInteger(n.minAbove);this.assertPositiveInteger(n.maxAbove);this.assertPositiveInteger(n.minBelow);this.assertPositiveInteger(n.maxBelow);}
;qx.core.Object.call(this);this.setPrefetchX(n.minLeft,n.maxLeft,n.minRight,n.maxRight);this.setPrefetchY(n.minAbove,n.maxAbove,n.minBelow,n.maxBelow);this.__rq=new qx.event.Timer(this.getInterval());this.__rq.addListener(d,this._onInterval,this);if(m){this.setScroller(m);}
;}
,properties:{scroller:{check:h,nullable:true,init:null,apply:g},interval:{check:k,init:200,apply:a}},members:{__vF:null,__vG:null,__rq:null,__vH:null,__vI:null,setPrefetchX:function(o,r,p,q){this.__vF=[o,r,p,q];}
,setPrefetchY:function(v,u,t,s){this.__vG=[v,u,t,s];}
,_onInterval:function(){var w=this.__vF;if(w[1]&&w[3]){this.getScroller().getPane().prefetchX(w[0],w[1],w[2],w[3]);qx.ui.core.queue.Manager.flush();}
;var x=this.__vG;if(x[1]&&x[3]){this.getScroller().getPane().prefetchY(x[0],x[1],x[2],x[3]);qx.ui.core.queue.Manager.flush();}
;}
,_applyScroller:function(z,y){if(y){if(this.__vH){y.getChildControl(j).removeListenerById(this.__vH);}
;if(this.__vI){y.getChildControl(l).removeListenerById(this.__vI);}
;}
;if(z){if(!z.getContentElement().getDomElement()){this.__rq.stop();z.addListenerOnce(b,this.__rq.start,this.__rq);}
else {this.__rq.restart();}
;this.__vH=z.getChildControl(j).addListener(f,this.__rq.restart,this.__rq);this.__vI=z.getChildControl(l).addListener(f,this.__rq.restart,this.__rq);}
else {this.__rq.stop();}
;}
,_applyInterval:function(B,A){this.__rq.setInterval(B);}
},destruct:function(){this.setScroller(null);this.__vF=this.__vG=null;this._disposeObjects(i);}
});}
)();
...
;this.__lp=[];this.__lq=[];this._isHorizontal=(w||c)==c;}
,properties:{defaultLineColor:{init:h,check:s,themeable:true},defaultLineSize:{init:1,check:t,themeable:true}},members:{__lp:null,__lq:null,isHorizontal:function(){return this._isHorizontal;}
...
;this.__lp[B]=A;if(this.__lr(B)){this.updateLayerData();}
;}
...
;this.__lq[C]=D;if(this.__lr(C)){this.updateLayerData();}
;}
,__lr:function(E){if(this._isHorizontal){var I=this.getFirstColumn();var G=I+this.getColumnSizes().length-1;return E>=I&&E<=G;}
else {var H=this.getFirstRow();var F=H+this.getRowSizes().length-1;return E>=H&&E<=F;}
;}
,getLineSize:function(J){return this.__lq[J]||this.getDefaultLineSize();}
,getLineColor:function(K){return this.__lp[K]||this.getDefaultLineColor();}
,__ls:function(P,M,O){var top=0;var L,N;for(var y=0;y<O.length-1;y++ ){L=this.getLineColor(M+y);N=this.getLineSize(M+y);top+=O[y];P.push(m,g,f+N+q,j,d,top-((N>1)?Math.floor(N/2):1),q,b,L,n,a);}
;}
,__lt:function(T,Q,S){var V=0;var R,U;for(var x=0;x<S.length-1;x++ ){R=this.getLineColor(Q+x);U=this.getLineSize(Q+x);V+=S[x];T.push(m,g,k+U+q,l,u,p,V-((U>1)?Math.floor(U/2):1),q,b,R,n,a);}
;}
,_fullUpdate:function(ba,bb,X,W){var Y=[];if(this._isHorizontal){this.__ls(Y,ba,X);}
else {this.__lt(Y,bb,W);}
...
;}
},destruct:function(){this.__lp=this.__lq=null;}
});}
)();
