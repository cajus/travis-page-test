...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.widget.Flash.50268f8f320b.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="2) this html page is not loaded from the file system, but a webserver.",b="Flash Player Version",c="__Ky",d="right",f="qooxdoo is the best!",g="Message from Flash:",h="execute",i="__lG",j="Simple demo with FlashVars",k="bgcolor",l="__Kw",m="demobrowser.demo.widget.Flash",n="demobrowser/demo/flash/TestFlash.swf",o="1) no pop-up or advertising blocker is activated.\n",p="Send to Flash",q="__lX",r="demobrowser/demo/flash/FlashVersion.swf",s="No message.",t="Flash:",u="<b>qooxdoo:</b>",v="__Kx",w="demobrowser.demo.widget.Flash.sendMessage",x="demobrowser.demo.widget.Flash.flashReady",y="Couldn't connect to Flash Player! Please make sure that:\n",z="demobrowser/demo/flash/fo_tester.swf",A="this is passed in via FlashVars",B="Two way communication (ActionScript <-> JavaScript)",C="Message to Flash:",D="Show Flash Player version",E="noscale",F="#FF6600";qx.Class.define(m,{extend:qx.application.Standalone,members:{__lG:null,main:function(){qx.application.Standalone.prototype.main.call(this);var J=new qx.ui.tabview.TabView();J.setContentPadding([8,8,8,8]);var G=this.getRoot();G.add(J,{edge:0});var H=new qx.ui.tabview.Page(j);H.setLayout(new qx.ui.layout.Canvas());H.add(this.createFlashDemo1(),{edge:0});J.add(H);var I=new qx.ui.tabview.Page(B);I.setLayout(new qx.ui.layout.Canvas());I.add(this.createFlashDemo2(),{edge:0});J.add(I);this.__lG=this.createWindow();G.add(this.__lG,{top:20,left:20});}
,createWindow:function(){var K=new qx.ui.window.Window(b).set({width:300,height:200,contentPadding:[0,0,0,0]});K.setLayout(new qx.ui.layout.Canvas());K.add(new qx.ui.embed.Flash(r),{edge:0});return K;}
,createFlashDemo1:function(){var N=new qx.ui.container.Composite(new qx.ui.layout.VBox(4));var L={flashVarText:A};var M=new qx.ui.embed.Flash(z).set({scale:E,variables:L});M.getContentElement().setParam(k,F);N.add(M,{flex:1});var O=new qx.ui.form.Button(D);O.addListener(h,function(){this.__lG.open();}
,this);N.add(O);return N;}
,__lX:null,__Kw:null,__Kx:null,__Ky:null,createFlashDemo2:function(){this.self(arguments).setCallBackInstance(this);var R=new qx.ui.container.Composite(new qx.ui.layout.HBox(8));var Q=new qx.ui.container.Composite(new qx.ui.layout.VBox(4));R.add(Q,{flex:1});Q.add(new qx.ui.basic.Label(u).set({rich:true}));Q.add(new qx.ui.basic.Label(g));this.__Kw=new qx.ui.form.TextArea(s);this.__Kw.setEnabled(false);Q.add(this.__Kw,{flex:1});Q.add(new qx.ui.basic.Label(C));this.__Kx=new qx.ui.form.TextArea(f);Q.add(this.__Kx,{flex:1});var S=new qx.ui.container.Composite(new qx.ui.layout.HBox(0,d));this.__Ky=new qx.ui.form.Button(p);this.__Ky.setEnabled(false);this.__Ky.addListener(h,function(e){this.__lX.getFlashElement().sendMessage(this.__Kx.getValue());}
,this);S.add(this.__Ky);Q.add(S);var P=new qx.ui.container.Composite(new qx.ui.layout.VBox(4));R.add(P,{flex:1});P.add(new qx.ui.basic.Label(t).set({rich:true}));this.__lX=new qx.ui.embed.Flash(n);this.__lX.setVariables({init:x});P.add(this.__lX,{flex:1});return R;}
,sendMessage:function(T){this.__Kw.setValue(T);}
,initFlash:function(){if(this.__lX.getFlashElement().setup){this.__lX.getFlashElement().setup(w);this.__Ky.setEnabled(true);}
else {alert(y+o+a);}
;}
},statics:{__Kz:null,setCallBackInstance:function(U){demobrowser.demo.widget.Flash.__Kz=U;}
,sendMessage:function(V){demobrowser.demo.widget.Flash.__Kz.sendMessage(V);}
,flashReady:function(){demobrowser.demo.widget.Flash.__Kz.initFlash();}
},destruct:function(){this._disposeObjects(l,v,c,q,i);}
});}
)();
...
(function(){var a="bottom",b="button",c="qx.event.type.Data",d="lastTab",f="barRight",g="beforeChangeSelection",h="qx.debug",j="horizontal",k="changeSelection",m="bar",n="close-button",o="Index should be less than : ",p="tabview",q="vertical",r="page",s="Incompatible child for TabView: ",t="close",u="_applyBarPosition",v="barLeft",w="top",x="right",y="qx.ui.tabview.TabView",z="barTop",A="barBottom",B="__ov",C="pane",D="left",E="firstTab";qx.Class.define(y,{extend:qx.ui.core.Widget,implement:qx.ui.core.ISingleSelection,include:[qx.ui.core.MContentPadding],construct:function(G){qx.ui.core.Widget.call(this);this.__ou={top:z,right:f,bottom:A,left:v};this._createChildControl(m);this._createChildControl(C);var F=this.__ov=new qx.ui.form.RadioGroup;F.setWrap(false);F.addListener(k,this._onChangeSelection,this);if(G!=null){this.setBarPosition(G);}
else {this.initBarPosition();}
;}
,events:{"changeSelection":c},properties:{appearance:{refine:true,init:p},barPosition:{check:[D,x,w,a],init:w,apply:u}},members:{__ov:null,_createChildControlImpl:function(J,I){var H;switch(J){case m:H=new qx.ui.container.SlideBar();H.setZIndex(10);this._add(H);break;case C:H=new qx.ui.container.Stack;H.setZIndex(5);this._add(H,{flex:1});break;};return H||qx.ui.core.Widget.prototype._createChildControlImpl.call(this,J);}
...
;}
;var K=O.getButton();var L=this.getChildControl(m);var N=this.getChildControl(C);O.exclude();L.add(K);N.add(O);this.__ov.add(K);O.addState(this.__ou[this.getBarPosition()]);O.addState(d);var M=this.getChildren();if(M[0]==O){O.addState(E);}
...
;var R=U.getButton();var Q=this.getChildControl(m);var T=this.getChildControl(C);U.exclude();Q.addAt(R,P);T.addAt(U,P);this.__ov.add(R);U.addState(this.__ou[this.getBarPosition()]);S=this.getChildren();if(P==S.length-1){U.addState(d);}
...
;}
;W.remove(X);ba.remove(Y);this.__ov.remove(X);Y.removeState(this.__ou[this.getBarPosition()]);if(Y.hasState(E)){Y.removeState(E);if(bb[0]){bb[0].addState(E);}
;}
...
,__ou:null,_applyBarPosition:function(bg,bi){var bd=this.getChildControl(m);var bj=this.getChildControl(C);var bl=bg==D||bg==x;var bm=bg==x||bg==a;var bk=bl?qx.ui.layout.HBox:qx.ui.layout.VBox;var bn=this._getLayout();if(bn&&bn instanceof bk){}
else {this._setLayout(bn=new bk);}
;bn.setReversed(bm);bd.setOrientation(bl?q:j);var bh=this.getChildren();var i,l;if(bi){var bf=this.__ou[bi];bd.removeState(bf);bj.removeState(bf);for(i=0,l=bh.length;i<l;i++ ){bh[i].removeState(bf);}
;}
;if(bg){var be=this.__ou[bg];bd.addState(be);bj.addState(be);for(i=0,l=bh.length;i<l;i++ ){bh[i].addState(be);}
;}
;}
,getSelection:function(){var bo=this.__ov.getSelection();var bp=[];for(var i=0;i<bo.length;i++ ){bp.push(bo[i].getUserData(r));}
;return bp;}
,setSelection:function(br){var bq=[];for(var i=0;i<br.length;i++ ){bq.push(br[i].getChildControl(b));}
;this.__ov.setSelection(bq);}
,resetSelection:function(){this.__ov.resetSelection();}
,isSelected:function(bs){var bt=bs.getChildControl(b);return this.__ov.isSelected(bt);}
,isSelectionEmpty:function(){return this.__ov.isSelectionEmpty();}
,getSelectables:function(bv){var bu=this.__ov.getSelectables(bv);var bw=[];for(var i=0;i<bu.length;i++ ){bw.push(bu[i].getUserData(r));}
;return bw;}
...
},destruct:function(){this._disposeObjects(B);this.__ou=null;}
});}
)();
...
,__Dh:function(e){var m=e.getOldData()[0];var n=e.getData()[0];if(m){if(this.isDynamic()){m.exclude();}
else {m.hide();}
;}
;if(n){n.show();}
;}
...
,_checkLoading:function(){var bo=this.getSource();if(bo!=F&&bo!=null&&bo!=bf){if(!this.isLoaded()){if(!this.__kM){this.__kM=new Date().getTime();}
;var bp=new Date().getTime()-this.__kM;if(this.getLoadTimeout()>bp){var bq=qx.util.TimerManager.getInstance();bq.start(this._checkLoading,0,this,null,10);this.fireEvent(x);}
else {if(qx.core.Environment.get(u)){this.debug(A+bp);}
;this.fireEvent(P);this.__kM=null;}
;}
else {this.fireEvent(p);this.__kM=null;}
;}
;}
...
,_applyQuality:function(bB,bA){this.__kN(c,bB);}
,_applyScale:function(bD,bC){this.__kN(h,bD);}
,_applyWmode:function(bF,bE){this.__kN(m,bF);}
,_applyPlay:function(bH,bG){this.__kN(I,bH);}
,_applyLoop:function(bJ,bI){this.__kN(s,bJ);}
,_applyMenu:function(bL,bK){this.__kN(v,bL);}
,_applyAllowScriptAccess:function(bN,bM){this.__kN(t,bN);}
,_applyLiveConnect:function(bP,bO){this.__kN(z,bP);}
,__kN:function(bQ,bR){this.getContentElement().setParam(bQ,bR);qx.ui.core.queue.Layout.add(this);}
}});}
)();
(function(){var a="$$",b="Invalid attribute 'value'.",c="The id cannot be modified after initial creation",d="The variables cannot be modified after initial creation",e="qx.debug",f="$$widget",g="Invalid attribute 'key'.",h="movie",i="div",j="The attributes cannot be modified after initial creation",k="The source cannot be modified after initial creation",l="The params cannot be modified after initial creation",m="Invalid attribute 'value' expected String, Boolean or null.",n="id",o="qx.html.Flash";qx.Class.define(o,{extend:qx.html.Element,construct:function(p,q){qx.html.Element.call(this,i,p,q);this.__lU={};this.__lV={};this.__lW={};}
,members:{__lU:null,__lW:null,__lV:null,__lX:null,_createDomElement:function(){return qx.dom.Element.create(i);}
,createFlash:function(){this.__lX=qx.bom.Flash.create(this.getDomElement(),this.getAttributes(),this.__lV,this.__lU);}
,setSource:function(r){if(qx.core.Environment.get(e)){qx.core.Assert.assertString(r,b);}
;if(this.__lX){throw new Error(k);}
;this.setAttribute(h,r);}
,setId:function(s){if(qx.core.Environment.get(e)){qx.core.Assert.assertString(s,b);}
;if(this.__lX){throw new Error(c);}
;this.setAttribute(n,s);}
,getVariables:function(){return this.__lV;}
,setVariables:function(t){if(qx.core.Environment.get(e)){qx.core.Assert.assertMap(t,b);}
;if(this.__lX){throw new Error(d);}
;this.__lV=t;}
,getAttributes:function(){return this.__lW;}
...
else if(this.__lX){throw new Error(j);}
;if(v===null||v===undefined){delete this.__lW[u];}
else {this.__lW[u]=v;}
;}
,getParams:function(){return this.__lU;}
...
;}
;}
;if(this.__lX){throw new Error(l);}
;if(x===null||x===undefined){delete this.__lU[w];}
else {this.__lU[w]=x;}
;}
,getFlashElement:function(){return this.__lX;}
},destruct:function(){if(this.__lX){qx.bom.Flash.destroy(this.__lX);}
...
;}
;}
;var O=this.__mJ(P,R,Q,M);this._flashObjects[R.id]=O;return O;}
,destroy:function(T,S){if(qx.core.Environment.get(D)==v&&qx.core.Environment.get(q)<11){T=this.__mE(T);if(T.readyState==4){this.__mF(T);}
else {if(!S){S=window;}
;qx.bom.Event.addNativeListener(S,p,function(){qx.bom.Flash.__mF(T);}
);}
;}
else {T=this.__mE(T);if(T.parentNode){T.parentNode.removeChild(T);}
;delete this._flashObjects[T.id];}
;}
,__mE:function(U){if(!U){throw new Error(z);}
;if(U.tagName.toLowerCase()!==L){U=U.firstChild;}
;if(!U||U.tagName.toLowerCase()!==L){throw new Error(A);}
;return U;}
,__mF:qx.core.Environment.select(D,{"mshtml":qx.event.GlobalError.observeMethod(function(V){for(var i in V){if(typeof V[i]==b){V[i]=null;}
;}
;if(V.parentNode){V.parentNode.removeChild(V);}
;delete this._flashObjects[V.id];}
),"default":null}),__mG:qx.event.GlobalError.observeMethod(function(){for(var W in qx.bom.Flash._flashObjects){qx.bom.Flash.destroy(qx.bom.Flash._flashObjects[W]);}
;window.__mH=function(){}
;window.__mI=function(){}
;qx.bom.Event.removeNativeListener(window,F,qx.bom.Flash.__mG);}
),__mJ:function(bb,bd,bc,X){if(qx.core.Environment.get(D)==v&&qx.core.Environment.get(q)<11){bc.movie=bd.data;delete bd.data;delete bd.classid;var Y=u;for(var name in bc){Y+=m+name+J+bc[name]+E;}
...
},defer:function(bf){if(qx.core.Environment.get(D)==v){qx.bom.Event.addNativeListener(window,F,bf.__mG);}
;}
});}
)();
(function(){var a="number",b="qx.util.TimerManager",c="interval",d="singleton";qx.Class.define(b,{extend:qx.core.Object,type:d,statics:{__mO:[],__mP:{},__mQ:0},members:{__mR:false,start:function(h,g,j,e,k){if(typeof k!=a){k=g||0;}
;var f=(new Date()).getTime()+k;this.self(arguments).__mP[ ++this.self(arguments).__mQ]={callback:h,userData:e||null,expireAt:f,recurTime:g,context:j||this};this.__mS(f,this.self(arguments).__mQ);return this.self(arguments).__mQ;}
,stop:function(l){var m=this.self(arguments).__mO;var length=m.length;for(var i=0;i<length;i++ ){if(m[i]==l){m.splice(i,1);break;}
;}
;delete this.self(arguments).__mP[l];if(m.length==0&&this.__mR){qx.event.Idle.getInstance().removeListener(c,this.__mT,this);this.__mR=false;}
;}
,__mS:function(n,q){var p=this.self(arguments).__mO;var o=this.self(arguments).__mP;var length=p.length;for(var i=0;i<length;i++ ){if(o[p[i]].expireAt>n){p.splice(i,0,q);break;}
;}
;if(p.length==length){p.push(q);}
;if(!this.__mR){qx.event.Idle.getInstance().addListener(c,this.__mT,this);this.__mR=true;}
;}
,__mT:function(){var s=(new Date()).getTime();var u=this.self(arguments).__mO;var t=this.self(arguments).__mP;while(u.length>0&&t[u[0]].expireAt<=s){var w=u.shift();var r=t[w];r.callback.call(r.context,r.userData,w);if(r.recurTime&&t[w]){var v=(new Date()).getTime();r.expireAt=v+r.recurTime;this.__mS(r.expireAt,w);}
else {delete t[w];}
;}
;if(u.length==0&&this.__mR){qx.event.Idle.getInstance().removeListener(c,this.__mT,this);this.__mR=false;}
;}
}});}
)();
