...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.widget.Iframe.dd06f99e03fc.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
,properties:{appearance:{refine:true,init:r},scrollbarX:{check:[u,q,o],init:u,themeable:true,apply:i},scrollbarY:{check:[u,q,o],init:u,themeable:true,apply:i},scrollbar:{group:[k,l]}},members:{__hL:null,__hM:null,_getIframeElement:function(){return this.getChildControl(j).getContentElement();}
...
;}
,_startIframeObserver:function(){if(this.__hM){this._stopIframeObserver();}
;var F=qx.event.Idle.getInstance();this.__hM=F.addListener(c,this._onIframeObserverInterval,this);}
,_stopIframeObserver:function(){this.__hL=null;if(!this.__hM){return;}
;var G=qx.event.Idle.getInstance();G.removeListenerById(this.__hM);}
,_onIframeObserverInterval:function(){var H=this._getIframeSize();if(!H){this._disableScollbars();return;}
;if(this.__hL&&H.width==this.__hL.width&&H.height==this.__hL.height){return;}
;this.__hL=H;this._preventIframeScrolling();this._updateScrollbars();}
...
;}
,_updateScrollbars:function(){var K=this.__hL;var N=this.getChildControl(j).getBounds();var L=this.getChildControl(j).getInnerSize();if(!K||!L||!L){return;}
...
;}
},destruct:function(){this._stopIframeObserver();this.__hL=null;}
});}
)();
