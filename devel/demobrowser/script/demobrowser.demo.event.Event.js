...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.event.Event.e47c7551ad7d.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
;}
,_initLogger:function(p,n,o){this.__Hy=f+p.join(c)+a;this.__Hz=o||50;this.__HA=n;this._clearLog();}
,_clearLog:function(){this.__HA.innerHTML=this.__Hy+k;this.__HB=[];}
,_log:function(q){this.__HB.unshift(q);this.__HB=this.__HB.slice(0,this.__Hz);var r=[this.__Hy];for(var i=0;i<this.__HB.length;i++ ){r.push(g,this.__HB[i].join(e),l);}
;r.push(k);this.__HA.innerHTML=r.join(d);this.__HA.scrollTop=0;}
,__Hy:null,__Hz:null,__HA:null,__HB:null},destruct:function(){this.__HA=this.__HB=null;}
});}
)();
