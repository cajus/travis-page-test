...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.mobile.PingPong.62d9d825ad74.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
;this.__LN=this.__LS(L);U.add(this.__LN);var Q=this.__LS(A);U.add(Q);this.__LE=this.__LT(L);this.__LN.add(this.__LE);this.__LN.addListener(M,qx.lang.Function.bind(this.__LR,this),this);this.__LD=this.__LT(A);Q.add(this.__LD);Q.addListener(M,qx.lang.Function.bind(this.__LR,this),this);this.__LF=this.__LU();U.add(this.__LF);this.__LL=this.__LV();this.__LN.add(this.__LL);this.__LM=this.__LV();Q.add(this.__LM);this.__LK=[0,0];this.__LO();}
,__LO:function(){this.__LF.setStyles({"left":k,"top":k});this.__LG=new qx.event.Timer(40);this.__LG.addListener(n,function(){var x=(parseInt(this.__LF.getStyle(L))+this.__LH*this.__LI);var y=(parseInt(this.__LF.getStyle(z))+this.__LH*this.__LJ);this.__LF.setStyle(L,x+c);this.__LF.setStyle(z,y+c);this.__LQ();}
,this);this.__LG.start();}
,__LP:function(V){this.__LG.stop();this.__LG.dispose();this.__LH=5;this.__LK[V]=this.__LK[V]+1;this.__LL.setAttribute(w,this.__LK[0]);this.__LM.setAttribute(w,this.__LK[1]);this.__LO();}
,__LQ:function(){var X=this.getBoundsFor(this.__LF);if(X.top<=0){this.__LJ=1;}
;if(X.bottom>=window.innerHeight-5){this.__LJ=-1;}
;if(X.left<=0||X.right>=window.innerWidth){this.__LP(X.left<=0?1:0);}
;var Y=this.getBoundsFor(this.__LE);if(X.left<=Y.right&&X.bottom>=Y.top&&X.top<=Y.bottom){this.__LI=1;this.__LH=Math.min(this.__LH+1,20);}
;var W=this.getBoundsFor(this.__LD);if(X.right>=W.left&&X.bottom>=W.top&&X.top<=W.bottom){this.__LI=-1;this.__LH=Math.min(this.__LH+1,20);}
;}
,__LR:function(e){var ba;if(qx.dom.Hierarchy.contains(this.__LN.getDomElement(),e.getTarget())){ba=this.__LE;}
else {ba=this.__LD;}
...
,__LS:function(bd){var bc={"width":C,"height":h,"position":N,"backgroundColor":a};if(bd==L){bc[J]=u;}
else {bc[L]=C;bc[d]=u;}
;return new qx.html.Element(g,bc);}
,__LT:function(bf){var be={"width":l,"height":t,"top":t,"position":N,"backgroundColor":K};be[bf]=F;return new qx.html.Element(g,be);}
,__LU:function(){var bg={"width":F,"height":F,"position":N,"backgroundColor":K,"userSelect":I};return new qx.html.Element(g,bg);}
,__LV:function(){var bh={"width":h,"height":h,"textAlign":r,"fontSize":H,"color":b,"fontFamily":B};var bi=new qx.html.Element(g,bh);bi.setAttribute(w,j);return bi;}
}});}
)();
