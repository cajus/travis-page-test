...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.ui.CommandGroupManager.24ef069ad05f.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
,members:{__uC:null,__uD:null,add:function(j){if(qx.core.Environment.get(c)){this.assertInstance(j,qx.ui.command.Group,f);}
...
;}
;if(this.getActive()===m){this.__uD=null;}
...
;return false;}
;for(var i=0;i<this.__uC.length;i++ ){var n=this.__uC[i];if(n==o){n.setActive(true);this.__uD=n;continue;}
;n.setActive(false);}
;return true;}
,getActive:function(){return this.__uD;}
,block:function(){if(this.__uD){this.__uD.setActive(false);}
;}
,unblock:function(){if(this.__uD){this.__uD.setActive(true);}
;}
,_getGroup:function(q){var p=this.__uC.indexOf(q);if(p===-1){return null;}
;return this.__uC[p];}
},destruct:function(){this.__uC=this.__uD=null;}
});}
)();
