...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.widget.Canvas.ccade531cab1.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="resize",b="_applyCanvasWidth",c="redraw",d="Boolean",f="__mU",g="_applyCanvasHeight",h="qx.ui.embed.Canvas",i="Integer",j="qx.event.type.Data";qx.Class.define(h,{extend:qx.ui.core.Widget,construct:function(l,k){qx.ui.core.Widget.call(this);this.__mU=new qx.util.DeferredCall(this.__mV,this);this.addListener(a,this._onResize,this);if(l!==undefined){this.setCanvasWidth(l);}
;if(k!==undefined){this.setCanvasHeight(k);}
;}
,events:{"redraw":j},properties:{syncDimension:{check:d,init:false},canvasWidth:{check:i,init:300,apply:b},canvasHeight:{check:i,init:150,apply:g}},members:{__mU:null,_createContentElement:function(){return new qx.html.Canvas();}
,__mV:function(){var n=this.getContentElement();var p=n.getHeight();var m=n.getWidth();var o=n.getContext2d();this._draw(m,p,o);this.fireNonBubblingEvent(c,qx.event.type.Data,[{width:m,height:p,context:o}]);}
,_applyCanvasWidth:function(r,q){this.getContentElement().setWidth(r);this.__mU.schedule();}
,_applyCanvasHeight:function(t,s){this.getContentElement().setHeight(t);this.__mU.schedule();}
,update:function(){this.__mU.schedule();}
...
(function(){var a="canvas",b="2d",c="qx.html.Canvas";qx.Class.define(c,{extend:qx.html.Element,construct:function(d,e){qx.html.Element.call(this,a,d,e);this.__mW=document.createElement(a);}
,members:{__mW:null,_createDomElement:function(){return this.__mW;}
,getCanvas:function(){return this.__mW;}
,setWidth:function(f){this.__mW.width=f;}
,getWidth:function(){return this.__mW.width;}
,setHeight:function(g){this.__mW.height=g;}
,getHeight:function(){return this.__mW.height;}
,getContext2d:function(){return this.__mW.getContext(b);}
