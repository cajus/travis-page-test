...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.virtual.List.7db971ebe81b.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
;var dc=qx.data.marshal.Json.createModel(cV);var cQ=this.__Kp=new qx.ui.list.List(dc).set({scrollbarX:ci,selectionMode:cx,height:280,width:150,labelPath:cH,iconPath:H,iconOptions:{converter:function(de){return bS+de+cm;}
...
;}
;var cU=new qx.ui.form.RadioButton(cg);var cL=new qx.ui.form.RadioButton(D);var cW=new qx.ui.form.RadioButton(W);var db=new qx.ui.form.RadioButton(cC);cU.setUserData(ct,cz);cL.setUserData(ct,cx);cW.setUserData(ct,t);db.setUserData(ct,c);cM.add(cU,{left:160,top:20});cM.add(cL,{left:160,top:40});cM.add(cW,{left:160,top:60});cM.add(db,{left:160,top:80});var cR=new qx.ui.form.RadioButton(P);var dd=new qx.ui.form.RadioButton(b);var cK=new qx.ui.form.RadioButton(I);cR.setUserData(ct,cH);dd.setUserData(ct,H);cK.setUserData(ct,co);cM.add(cR,{left:160,top:120});cM.add(dd,{left:160,top:140});cM.add(cK,{left:160,top:160});var cS=this.__Kq=new qx.ui.form.CheckBox(G);var cY=this.__Kr=new qx.ui.form.CheckBox(Q).set({enabled:false});cM.add(cS,{left:160,top:200});cM.add(cY,{left:160,top:220});var da=new qx.ui.form.RadioGroup(cU,cL,cW,db);da.setSelection([cL]);da.addListener(m,this.onSelectionModeChange,this);var cO=new qx.ui.form.RadioGroup(cR,dd,cK);cO.setSelection([cK]);cO.addListener(m,this.onShowModeChange,this);cS.addListener(g,this.onDragCheckChange,this);cY.addListener(g,this.onQuickCheckChange,this);return cM;}
...
,onSelectionModeChange:function(e){var dy=e.getData()[0].getUserData(ct);this.__Kp.setSelectionMode(dy);if(dy==cz||dy==c){this.__Kq.setEnabled(false);this.__Kr.setEnabled(true);}
else if(dy==cx||dy==bV){this.__Kq.setEnabled(true);this.__Kr.setEnabled(false);}
;}
,onShowModeChange:function(e){var dz=e.getData()[0].getUserData(ct);this.setShowMode(dz);}
,onDragCheckChange:function(e){if(e.getData()){var dA=this.__Kp.getSelectionMode();if(dA==cz||dA==c){this.debug(M);}
;}
;this.__Kp.setDragSelection(e.getData());}
,onQuickCheckChange:function(e){if(e.getData()){var dB=this.__Kp.getSelectionMode();if(dB==cx||dB==t){this.debug(A);}
;}
;this.__Kp.setQuickSelection(e.getData());}
}});}
)();
...
(function(){var a="scrollY",b="The method 'getItemRight' is not implemented!",c="update",d="scrollX",f="The method 'getItemLeft' is not implemented!",g="The method 'getItemBottom' is not implemented!",h="The method 'getItemTop' is not implemented!",i="pane",j="os.scrollBarOverlayed",k="qx.ui.virtual.core.Scroller";qx.Class.define(k,{extend:qx.ui.core.scroll.AbstractScrollArea,construct:function(o,l,n,m){qx.ui.core.scroll.AbstractScrollArea.call(this);this.__qT=new qx.ui.virtual.core.Pane(o,l,n,m);this.__qT.addListener(c,this._computeScrollbars,this);this.__qT.addListener(d,this._onScrollPaneX,this);this.__qT.addListener(a,this._onScrollPaneY,this);if(qx.core.Environment.get(j)){this._add(this.__qT,{edge:0});}
else {this._add(this.__qT,{row:0,column:0});}
;}
,properties:{width:{refine:true,init:null},height:{refine:true,init:null}},members:{__qT:null,getPane:function(){return this.__qT;}
,_createChildControlImpl:function(q,p){if(q==i){return this.__qT;}
...
,_onScrollBarX:function(e){this.__qT.setScrollX(e.getData());}
,_onScrollBarY:function(e){this.__qT.setScrollY(e.getData());}
},destruct:function(){this.__qT.dispose();this.__qT=null;}
});}
)();
(function(){var a="scrollY",b="__fO",c="__fV",d="cellTap",f="qx.event.type.Data",g="change",h="qx.debug",j="qx.event.type.Event",k="cellContextmenu",l="dbltap",m="resize",n="cellDbltap",o="__fN",p="scrollX",q="__fW",r="appear",s="pointerdown",t="qx.ui.virtual.core.Pane",u="qx.ui.virtual.core.CellEvent",v="update",w="contextmenu",x="tap";qx.Class.define(t,{extend:qx.ui.core.Widget,construct:function(B,y,A,z){qx.ui.core.Widget.call(this);this.__fN=new qx.ui.virtual.core.Axis(A,B);this.__fO=new qx.ui.virtual.core.Axis(z,y);this.__fP=0;this.__fQ=0;this.__fR=0;this.__fS=0;this.__fT={};this.__fU={};this.__fV=new qx.ui.container.Composite();this.__fV.setUserBounds(0,0,0,0);this._add(this.__fV);this.__fW=[];this.__fN.addListener(g,this.fullUpdate,this);this.__fO.addListener(g,this.fullUpdate,this);this.addListener(m,this._onResize,this);this.addListenerOnce(r,this._onAppear,this);this.addListener(s,this._onPointerDown,this);this.addListener(x,this._onTap,this);this.addListener(l,this._onDbltap,this);this.addListener(w,this._onContextmenu,this);}
,events:{cellTap:u,cellContextmenu:u,cellDbltap:u,update:j,scrollX:f,scrollY:f},properties:{width:{refine:true,init:400},height:{refine:true,init:300}},members:{__fN:null,__fO:null,__fP:null,__fQ:null,__fR:null,__fS:null,__fT:null,__fU:null,__fV:null,__fW:null,__fX:null,__fY:null,__ga:null,__gb:null,getRowConfig:function(){return this.__fN;}
,getColumnConfig:function(){return this.__fO;}
...
;this.__fW.push(C);C.setUserBounds(0,0,0,0);this.__fV.add(C);}
,getLayers:function(){return this.__fW;}
,getVisibleLayers:function(){var D=[];for(var i=0;i<this.__fW.length;i++ ){var E=this.__fW[i];if(E.isVisible()){D.push(E);}
;}
;return D;}
,getScrollMaxX:function(){var F=this.getInnerSize();if(F){return Math.max(0,this.__fO.getTotalSize()-F.width);}
;return 0;}
,getScrollMaxY:function(){var G=this.getInnerSize();if(G){return Math.max(0,this.__fN.getTotalSize()-G.height);}
;return 0;}
,setScrollY:function(J){var H=this.getScrollMaxY();if(J<0){J=0;}
else if(J>H){J=H;}
;if(this.__fP!==J){var I=this.__fP;this.__fP=J;this._deferredUpdateScrollPosition();this.fireDataEvent(a,J,I);}
;}
,getScrollY:function(){return this.__fP;}
,setScrollX:function(M){var K=this.getScrollMaxX();if(M<0){M=0;}
else if(M>K){M=K;}
;if(M!==this.__fQ){var L=this.__fQ;this.__fQ=M;this._deferredUpdateScrollPosition();this.fireDataEvent(p,M,L);}
;}
,getScrollX:function(){return this.__fQ;}
,getScrollSize:function(){return {width:this.__fO.getTotalSize(),height:this.__fN.getTotalSize()};}
...
,this,0);}
,this);return;}
;var R=this.__fN.getItemPosition(P);var O=R+this.__fN.getItemSize(P);var N=this.getScrollY();if(R<N){this.setScrollY(R);}
...
,this,0);}
,this);return;}
;var U=this.__fO.getItemPosition(S);var T=U+this.__fO.getItemSize(S);var W=this.getScrollX();if(U<W){this.setScrollX(U);}
...
;bf=this.__fN.getItemAtPosition(this.getScrollY()+bc-bd.top);be=this.__fO.getItemAtPosition(this.getScrollX()+bb-bd.left);if(!bf||!be){return null;}
...
;var bn=this.__fQ+bl.width;var bo=this.__fS-bn;if(this.__fQ-this.__fT.left<Math.min(this.__fQ,bj)||this.__fT.right-bn<Math.min(bo,bk)){var bp=Math.min(this.__fQ,bm);var bh=Math.min(bo,bi);this._setLayerWindow(bg,this.__fQ-bp,this.__fP,bl.width+bp+bh,bl.height,false);}
;}
,prefetchY:function(bz,bv,br,bu){var bq=this.getVisibleLayers();if(bq.length==0){return;}
;var bw=this.getBounds();if(!bw){return;}
;var bs=this.__fP+bw.height;var bt=this.__fR-bs;if(this.__fP-this.__fT.top<Math.min(this.__fP,bz)||this.__fT.bottom-bs<Math.min(bt,br)){var by=Math.min(this.__fP,bv);var bx=Math.min(bt,bu);this._setLayerWindow(bq,this.__fQ,this.__fP-by,bw.width,bw.height+by+bx,false);}
;}
,_onResize:function(){if(this.getContentElement().getDomElement()){this.__fX=true;this._updateScrollPosition();this.__fX=null;this.fireEvent(v);}
;}
,_onAppear:function(){this.fullUpdate();}
,_onPointerDown:function(e){this.__gb=this.getCellAtPosition(e.getDocumentLeft(),e.getDocumentTop());}
,_onTap:function(e){this.__gc(e,d);}
,_onContextmenu:function(e){this.__gc(e,k);}
,_onDbltap:function(e){this.__gc(e,n);}
,__gc:function(e,bC){var bB=this.getCellAtPosition(e.getDocumentLeft(),e.getDocumentTop());if(!bB){return;}
;var bA=this.__gb;if(bA==null||bA.row!==bB.row||bA.column!==bB.column){return;}
;this.fireNonBubblingEvent(bC,qx.ui.virtual.core.CellEvent,[this,e,bB.row,bB.column]);}
,syncWidget:function(bD){if(this.__fU._fullUpdate){this._fullUpdate();}
else if(this.__fU._updateScrollPosition){this._updateScrollPosition();}
;this.__fU={};}
,_setLayerWindow:function(bE,bT,top,bP,bL,bV){var bK=this.__fN.getItemAtPosition(top);if(bK){var bN=bK.index;var bR=this.__fN.getItemSizes(bN,bL+bK.offset);var bM=qx.lang.Array.sum(bR);var bU=top-bK.offset;var bQ=top-bK.offset+bM;}
else {var bN=0;var bR=[];var bM=0;var bU=0;var bQ=0;}
;var bF=this.__fO.getItemAtPosition(bT);if(bF){var bJ=bF.index;var bH=this.__fO.getItemSizes(bJ,bP+bF.offset);var bO=qx.lang.Array.sum(bH);var bS=bT-bF.offset;var bI=bT-bF.offset+bO;}
else {var bJ=0;var bH=[];var bO=0;var bS=0;var bI=0;}
;this.__fT={top:bU,bottom:bQ,left:bS,right:bI};this.__fV.setUserBounds((this.getPaddingLeft()||0)+(this.__fT.left-this.__fQ),(this.getPaddingTop()||0)+(this.__fT.top-this.__fP),bO,bM);this.__fY=bH;this.__ga=bR;for(var i=0;i<this.__fW.length;i++ ){var bG=this.__fW[i];bG.setUserBounds(0,0,bO,bM);if(bV){bG.fullUpdate(bN,bJ,bR,bH);}
else {bG.updateLayerWindow(bN,bJ,bR,bH);}
;}
;}
,__gd:function(){if(this.__fX){return;}
;var bW=this.getScrollSize();if(this.__fR!==bW.height||this.__fS!==bW.width){this.__fR=bW.height;this.__fS=bW.width;this.fireEvent(v);}
;}
,fullUpdate:function(){this.__fU._fullUpdate=1;qx.ui.core.queue.Widget.add(this);}
,isUpdatePending:function(){return !!this.__fU._fullUpdate;}
,_fullUpdate:function(){var bX=this.getVisibleLayers();if(bX.length==0){this.__gd();return;}
;var bY=this.getBounds();if(!bY){return;}
;this._setLayerWindow(bX,this.__fQ,this.__fP,bY.width,bY.height,true);this.__gd();}
,_deferredUpdateScrollPosition:function(){this.__fU._updateScrollPosition=1;qx.ui.core.queue.Widget.add(this);}
,_updateScrollPosition:function(){var ca=this.getVisibleLayers();if(ca.length==0){this.__gd();return;}
;var cc=this.getBounds();if(!cc){return;}
;var cb={top:this.__fP,bottom:this.__fP+cc.height,left:this.__fQ,right:this.__fQ+cc.width};if(this.__fT.top<=cb.top&&this.__fT.bottom>=cb.bottom&&this.__fT.left<=cb.left&&this.__fT.right>=cb.right){this.__fV.setUserBounds((this.getPaddingLeft()||0)+(this.__fT.left-cb.left),(this.getPaddingTop()||0)+(this.__fT.top-cb.top),this.__fT.right-this.__fT.left,this.__fT.bottom-this.__fT.top);}
else {this._setLayerWindow(ca,this.__fQ,this.__fP,cc.width,cc.height,false);}
;this.__gd();}
},destruct:function(){this._disposeArray(q);this._disposeObjects(o,b,c);this.__fT=this.__fU=this.__fY=this.__ga=null;}
});}
)();
...
,events:{"change":e},members:{__ge:null,getDefaultItemSize:function(){return this.defaultItemSize;}
,setDefaultItemSize:function(k){if(this.defaultItemSize!==k){this.defaultItemSize=k;this.__ge=null;this.fireNonBubblingEvent(c);}
;}
,getItemCount:function(){return this.itemCount;}
,setItemCount:function(l){if(this.itemCount!==l){this.itemCount=l;this.__ge=null;this.fireNonBubblingEvent(c);}
;}
...
;this.__ge=null;this.fireNonBubblingEvent(c);}
,getItemSize:function(o){return this.customSizes[o]||this.defaultItemSize;}
,resetItemSizes:function(){this.customSizes={};this.__ge=null;this.fireNonBubblingEvent(c);}
...
;}
;if(y.length==0){var u=[{startIndex:0,endIndex:q-1,firstItemSize:s,rangeStart:0,rangeEnd:q*s-1}];this.__ge=u;return u;}
...
;var z=u[u.length-1];var w=(q-z.startIndex-1)*s;z.rangeEnd=z.rangeStart+z.firstItemSize+w-1;z.endIndex=q-1;this.__ge=u;return u;}
,__gg:function(F){var B=this.__ge||this.__gf();var C=0;var A=B.length-1;while(true){var E=C+((A-C)>>1);var D=B[E];if(D.rangeEnd<F){C=E+1;}
else if(D.rangeStart>F){A=E-1;}
else {return D;}
;}
;}
,getItemAtPosition:function(K){if(K<0||K>=this.getTotalSize()){return null;}
;var J=this.__gg(K);var L=J.rangeStart;var G=J.startIndex;var I=J.firstItemSize;if(L+I>K){return {index:G,offset:K-L};}
else {var H=this.defaultItemSize;return {index:G+1+Math.floor((K-L-I)/H),offset:(K-L-I)%H};}
;}
,__gh:function(M){var O=this.__ge||this.__gf();var P=0;var N=O.length-1;while(true){var R=P+((N-P)>>1);var Q=O[R];if(Q.endIndex<M){P=R+1;}
else if(Q.startIndex>M){N=R-1;}
else {return Q;}
;}
;}
,getItemPosition:function(S){if(S<0||S>=this.itemCount){return null;}
;var T=this.__gh(S);if(T.startIndex==S){return T.rangeStart;}
else {return T.rangeStart+T.firstItemSize+(S-T.startIndex-1)*this.defaultItemSize;}
;}
,getTotalSize:function(){var U=this.__ge||this.__gf();return U[U.length-1].rangeEnd+1;}
...
(function(){var a="one",b="Boolean",c="qx.ui.virtual.selection.MModel",d="qx.data.Array",f="multi",g="selected",h="_applySelection",j="change",k="_applyDragSelection",l="single",m="_applyQuickSelection",n="changeSelection",o="_applySelectionMode",p="additive",q="qx.event.type.Data";qx.Mixin.define(c,{construct:function(){this._initSelectionManager();this.__Iz=new qx.data.Array();this.initSelection(this.__Iz);}
,properties:{selection:{check:d,event:n,apply:h,nullable:false,deferredInit:true},selectionMode:{check:[l,f,p,a],init:l,apply:o},dragSelection:{check:b,init:false,apply:k},quickSelection:{check:b,init:false,apply:m}},events:{"changeSelection":q},members:{_manager:null,__IJ:false,__IK:false,__Iz:null,_initSelectionManager:function(){var self=this;var r={isItemSelectable:function(s){return self._provider.isSelectable(s);}
...
,_onChangeSelection:function(e){if(this.__IK==true){return;}
;this.__IJ=true;var G=this.getSelection();var I=[];for(var i=0;i<G.getLength();i++ ){var H=G.getItem(i);var J=this._getSelectables();var F=-1;if(J!=null){F=J.indexOf(H);}
...
;this.__IE();if(this._afterApplySelection!=null&&qx.lang.Type.isFunction(this._afterApplySelection)){this._afterApplySelection();}
;this.__IJ=false;}
,_onManagerChangeSelection:function(e){if(this.__IJ==true){return;}
;this.__IK=true;this.__IE();this.__IK=false;}
,__IE:function(){if(this.__IM()){return;}
;var M=this._manager.getSelection();var N=[];for(var i=0;i<M.length;i++ ){var O=this._getDataFromRow(M[i]);if(O!=null){N.push(O);}
;}
;this.__IL(N);}
,__IL:function(R){var Q=this.getSelection();if(R.length>0){var P=[0,Q.getLength()];P=P.concat(R);var S=Q.splice.apply(Q,P);S.dispose();}
else {Q.removeAll();}
;}
,__IM:function(){var U=this.getSelection();var W=this._manager.getSelection();if(U.getLength()!==W.length){return false;}
...
;}
},destruct:function(){this._manager.dispose();this._manager=null;if(this.__Iz){this.__Iz.dispose();}
;}
});}
)();
...
,_init:function(){this._provider=new qx.ui.list.provider.WidgetProvider(this);this.__dh=[];this.__IO=[];this.__IP={};this.__IQ=false;this.__IR=false;this.__IS=false;this.getPane().addListener(d,this._onResize,this);this._initBackground();this._initLayer();}
...
;}
,_getLookupTable:function(){return this.__dh;}
,_lookup:function(Q){return this.__dh[Q];}
,_lookupGroup:function(R){return this.__IO.indexOf(R);}
,_reverseLookup:function(S){if(S<0){return -1;}
;return this.__dh.indexOf(S);}
...
,_applyGroupRowHeight:function(ba,Y){this.__IT();}
...
,_applyDelegate:function(bo,bn){this._provider.setDelegate(bo);this.__IU();}
,_onResize:function(e){this.getPane().getColumnConfig().setItemSize(0,e.getData().width);}
,_onModelChange:function(e){this._provider.removeBindings();this.__IU();this._applyDefaultSelection();}
,__dq:function(){this.getPane().getRowConfig().setItemCount(this.__dh.length);this.getPane().fullUpdate();}
,__IT:function(){var bp=this.getPane().getRowConfig();var bq=this.getGroupItemHeight();bp.resetItemSizes();if(bq){for(var i=0,l=this.__dh.length;i<l; ++i){if(this.__dh[i]==-1){bp.setItemSize(i,bq);}
;}
;}
;}
,__IU:function(){this.__dh=[];this.__IO=[];this.__IP={};if(this.isAutoGrouping()){this.getGroups().removeAll();}
;var br=this.getModel();if(br!=null){this._runDelegateFilter(br);this._runDelegateSorter(br);this._runDelegateGroup(br);}
;this._updateSelection();this.__IT();this.__dq();}
,_runDelegateFilter:function(bt){var bs=qx.util.Delegate.getMethod(this.getDelegate(),D);for(var i=0,l=bt.length;i<l; ++i){if(bs==null||bs(bt.getItem(i))){this.__dh.push(i);}
;}
;}
,_runDelegateSorter:function(bu){if(this.__dh.length==0){return;}
;var bv=qx.util.Delegate.getMethod(this.getDelegate(),t);if(bv!=null){this.__dh.sort(function(a,b){return bv(bu.getItem(a),bu.getItem(b));}
);}
;}
,_runDelegateGroup:function(bz){var bA=qx.util.Delegate.getMethod(this.getDelegate(),v);if(bA!=null){for(var i=0,l=this.__dh.length;i<l; ++i){var bw=this.__dh[i];var by=this.getModel().getItem(bw);var bx=bA(by);this.__IV(bx,bw);}
;this.__dh=this.__IW();}
;}
,__IV:function(bC,bB){if(bC==null){this.__IS=true;bC=A;}
;var name=this.__IX(bC);if(this.__IP[name]==null){this.__IP[name]=[];if(this.isAutoGrouping()){this.getGroups().push(bC);}
;}
;this.__IP[name].push(bB);}
,__IW:function(){this.__IY();var bG=[];var bI=0;var bE=this.getGroups();for(var i=0;i<bE.getLength();i++ ){var bD=bE.getItem(i);bG.push(-1);this.__IO.push(bI);bI++ ;var bH=this.__IX(bD);var bF=this.__IP[bH];if(bF!=null){for(var k=0;k<bF.length;k++ ){bG.push(bF[k]);bI++ ;}
;}
;}
;return bG;}
,__IX:function(bK){var name=null;if(!qx.lang.Type.isString(bK)){var bJ=this.getGroups().indexOf(bK);this.__IR=true;name=v;if(bJ==-1){name+=this.getGroups().getLength();}
else {name+=bJ;}
;}
else {this.__IQ=true;var name=bK;}
;return name;}
,__IY:function(){if(this.__IR&&this.__IS||this.__IR&&this.__IQ){throw new Error(r+z);}
;}
...
;this._background.dispose();this._provider.dispose();this._layer.dispose();this._background=this._provider=this._layer=this.__dh=this.__IO=this.__IP=null;if(this.__IN){this.__IN.dispose();}
;}
});}
)();
(function(){var a="qx.ui.virtual.layer.Abstract",b="abstract",c="Abstract method '_fullUpdate' called!";qx.Class.define(a,{extend:qx.ui.core.Widget,type:b,implement:[qx.ui.virtual.core.ILayer],construct:function(){qx.ui.core.Widget.call(this);this.__fU={};}
,properties:{anonymous:{refine:true,init:true}},members:{__fU:null,__kw:null,__Ja:null,__Jb:null,__ga:null,__fY:null,getFirstRow:function(){return this.__Ja;}
,getFirstColumn:function(){return this.__Jb;}
,getRowSizes:function(){return this.__ga||[];}
,getColumnSizes:function(){return this.__fY||[];}
,syncWidget:function(e){if(!this.getContentElement().getDomElement()){return;}
;if(this.__fU.fullUpdate||this.__fU.updateLayerWindow&&this.__fU.updateLayerData){this._fullUpdate.apply(this,this.__kw);}
else if(this.__fU.updateLayerWindow){this._updateLayerWindow.apply(this,this.__kw);}
else if(this.__fU.updateLayerData&&this.__ga){this._updateLayerData();}
;if(this.__fU.fullUpdate||this.__fU.updateLayerWindow){var d=this.__kw;this.__Ja=d[0];this.__Jb=d[1];this.__ga=d[2];this.__fY=d[3];}
;this.__fU={};}
,_updateLayerData:function(){this._fullUpdate(this.__Ja,this.__Jb,this.__ga,this.__fY);}
,_fullUpdate:function(g,i,h,f){throw new Error(c);}
,_updateLayerWindow:function(k,m,l,j){this._fullUpdate(k,m,l,j);}
,updateLayerData:function(){this.__fU.updateLayerData=true;qx.ui.core.queue.Widget.add(this);}
,fullUpdate:function(p,q,o,n){this.__kw=arguments;this.__fU.fullUpdate=true;qx.ui.core.queue.Widget.add(this);}
,updateLayerWindow:function(t,u,s,r){this.__kw=arguments;this.__fU.updateLayerWindow=true;qx.ui.core.queue.Widget.add(this);}
},destruct:function(){this.__fU=this.__kw=this.__ga=this.__fY=null;}
});}
)();
...
;this.__Jc={};this.__Jd={};}
,properties:{colorEven:{nullable:true,check:c,apply:b,themeable:true},colorOdd:{nullable:true,check:c,apply:a,themeable:true}},members:{__Je:null,__Jf:null,__Jc:null,__Jd:null,setColor:function(h,g){if(g){this.__Jc[h]=qx.theme.manager.Color.getInstance().resolve(g);}
else {delete (this.__Jc[h]);}
;}
,clearCustomColors:function(){this.__Jc={};this.updateLayerData();}
,getColor:function(i){var j=this.__Jc[i];if(j){return j;}
else {return i%2==0?this.__Je:this.__Jf;}
;}
,_applyColorEven:function(l,k){if(l){this.__Je=qx.theme.manager.Color.getInstance().resolve(l);}
else {this.__Je=null;}
;this.updateLayerData();}
,_applyColorOdd:function(n,m){if(n){this.__Jf=qx.theme.manager.Color.getInstance().resolve(n);}
else {this.__Jf=null;}
;this.updateLayerData();}
,setBackground:function(o,p){if(p){this.__Jd[o]=qx.theme.manager.Decoration.getInstance().resolve(p);}
else {delete (this.__Jd[o]);}
;this.updateLayerData();}
,getBackground:function(q){return this.__Jd[q];}
...
;}
,setColor:function(J,I){qx.ui.virtual.layer.AbstractBackground.prototype.setColor.call(this,J,I);if(this.__st(J)){this.updateLayerData();}
;}
,setBackground:function(K,L){qx.ui.virtual.layer.AbstractBackground.prototype.setBackground.call(this,K,L);if(this.__st(K)){this.updateLayerData();}
;}
,__st:function(M){var O=this.getFirstRow();var N=O+this.getRowSizes().length-1;return M>=O&&M<=N;}
}});}
)();
...
(function(){var a="cell.type",b="model[",c="groups[",d="model",f="",g="changeDelegate",h="label",i="qx.ui.list.core.MWidgetController",j="icon",k="]",l="value",m="BindingIds",n=".",o="group",p="String";qx.Mixin.define(i,{construct:function(){this.__dB=[];}
...
;}
,bindProperty:function(u,x,v,t,s){var y=t.getUserData(a);var w=this.__dC(s,u,y);if(v){v.ignoreConverter=d;}
;var z=this._list.bind(w,t,x,v);this.__dD(t,z);}
,bindPropertyReverse:function(D,B,E,F,A){var G=F.getUserData(a);var C=this.__dC(A,D,G);var H=F.bind(B,this._list,C,E);this.__dD(F,H);}
,removeBindings:function(){while(this.__dB.length>0){var I=this.__dB.pop();this._removeBindingsFrom(I);}
;}
...
;}
,_removeBindingsFrom:function(T){var U=this.__dE(T);while(U.length>0){var V=U.pop();try{this._list.removeBinding(V);}
catch(e){T.removeBinding(V);}
;}
;if(qx.lang.Array.contains(this.__dB,T)){qx.lang.Array.remove(this.__dB,T);}
;}
,__dC:function(X,ba,Y){var W=b+X+k;if(Y==o){W=c+X+k;}
;if(ba!=null&&ba!=f){W+=n+ba;}
;return W;}
,__dD:function(bc,bd){var bb=this.__dE(bc);if(!qx.lang.Array.contains(bb,bd)){bb.push(bd);}
;if(!qx.lang.Array.contains(this.__dB,bc)){this.__dB.push(bc);}
;}
,__dE:function(be){var bf=be.getUserData(m);if(bf==null){bf=[];be.setUserData(m,bf);}
;return bf;}
...
,styleSelectabled:function(v){var u=this.__Jg(v);this._styleSelectabled(u);}
,styleUnselectabled:function(x){var w=this.__Jg(x);this._styleUnselectabled(w);}
...
;}
,_styleSelectabled:function(A){this.__Jh(A,{selected:1});}
,_styleUnselectabled:function(B){this.__Jh(B,{});}
...
,__Jg:function(G){return this._list._layer.getRenderedCellWidget(G,0);}
,__Jh:function(I,H){if(I==null){return;}
...
;this._cellProvider=h;this.__gq=[];}
,properties:{anonymous:{refine:true,init:false}},events:{updated:c},members:{__gq:null,getRenderedCellWidget:function(q,n){if(this._getChildren().length===0){return null;}
...
;}
,_getSpacer:function(){var r=this.__gq.pop();if(!r){r=new qx.ui.core.Spacer();r.setUserData(g,1);}
;return r;}
...
;}
;}
,_fullUpdate:function(B,v,A,z){var C=this._cellProvider;var H=this._getChildren().concat();for(var i=0;i<H.length;i++ ){var F=H[i];if(F.getUserData(g)){this.__gq.push(F);}
...
;}
;}
;var L=this._cellProvider;var P=this._getChildren().concat();for(var i=0;i<P.length;i++ ){if(!bb[i]){var W=P[i];if(W.getUserData(g)){this.__gq.push(W);}
...
;this._cellProvider=this.__gq=null;}
});}
)();
...
(function(){var a="created",b="qx.ui.virtual.cell.AbstractWidget",c="cell.states",d="abstract method call",e="qx.event.type.Data";qx.Class.define(b,{extend:qx.core.Object,implement:[qx.ui.virtual.cell.IWidgetCell],construct:function(){qx.core.Object.call(this);this.__nk=[];}
,events:{"created":e},members:{__nk:null,_createWidget:function(){throw new Error(d);}
...
;}
;j.setUserData(c,h);}
,getCellWidget:function(o,m){var n=this.__Ji();this.updateStates(n,m);this.updateData(n,o);return n;}
,pool:function(p){this.__nk.push(p);}
,_cleanupPool:function(){var q=this.__nk.pop();while(q){q.destroy();q=this.__nk.pop();}
;}
,__Ji:function(){var r=this.__nk.shift();if(r==null){r=this._createWidget();this.fireDataEvent(a,r);}
;return r;}
},destruct:function(){this._cleanupPool();this.__nk=null;}
});}
)();
