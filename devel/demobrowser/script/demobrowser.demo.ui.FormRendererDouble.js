...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.ui.FormRendererDouble.3ed028d999d7.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
;this.__ov=new qx.ui.form.RadioGroup();this.__ov.addListener(j,function(e){this.fireDataEvent(j,e.getData(),e.getOldData());}
,this);}
...
;}
,getRadioGroup:function(){return this.__ov;}
,getChildren:function(){return this._getChildren();}
,add:function(w,v){this.__ov.add(w);this._add(w,v);}
,remove:function(x){this.__ov.remove(x);this._remove(x);}
,removeAll:function(){var y=this.__ov.getItems();for(var i=y.length-1;i>=0;i-- ){this.__ov.remove(y[i]);}
;return this._removeAll();}
,getSelection:function(){return this.__ov.getSelection();}
,setSelection:function(z){this.__ov.setSelection(z);}
,resetSelection:function(){this.__ov.resetSelection();}
,isSelected:function(A){return this.__ov.isSelected(A);}
,isSelectionEmpty:function(){return this.__ov.isSelectionEmpty();}
,getSelectables:function(B){return this.__ov.getSelectables(B);}
},destruct:function(){this._disposeObjects(g);}
});}
)();
