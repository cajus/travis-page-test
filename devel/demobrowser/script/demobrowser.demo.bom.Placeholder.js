...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.bom.Placeholder.9ccd156c696d.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
,getWindow:function(N){return qx.dom.Node.getWindow(qx.module.Traversing.__pj(N));}
...
,getDocument:function(Q){return qx.dom.Node.getDocument(qx.module.Traversing.__pj(Q));}
,getNodeName:function(R){return qx.dom.Node.getName(qx.module.Traversing.__pj(R));}
,getNodeText:function(S){return qx.dom.Node.getText(qx.module.Traversing.__pj(S));}
,isBlockNode:function(T){return qx.dom.Node.isBlockNode(qx.module.Traversing.__pj(T));}
,equalNodes:function(bd,bf){bd=qx.module.Traversing.__pk(bd);bf=qx.module.Traversing.__pk(bf);if(!bd||!bf){return false;}
...
;}
;if(bc){var U=qx.module.Traversing.__pl(bd);var be=qx.module.Traversing.__pl(bf);for(var W in U){if(U[W]!==be[W]){return false;}
;}
;}
...
;return true;}
;}
},members:{__pi:null,add:function(bg){if(bg instanceof qxWeb){bg=bg[0];}
...
;}
;return bq;}
,getAncestors:function(bt){return this.__pi(null,bt);}
,getAncestorsUntil:function(bv,bu){return this.__pi(bv,bu);}
...
;return bO;}
,getNextAll:function(bR){var bQ=qx.module.Traversing.__pm(this,f,bR);return qxWeb.$init(bQ,qxWeb);}
...
;return bX;}
,getPrevAll:function(cb){var ca=qx.module.Traversing.__pm(this,k,cb);return qxWeb.$init(ca,qxWeb);}
...
,getSiblings:function(ci){var ch=qx.module.Traversing.__pm(this,n,ci);return qxWeb.$init(ch,qxWeb);}
...
},defer:function(cp){qxWeb.$attachAll(this);qxWeb.$attach({"__pi":cp.__pi});}
});}
)();
...
;}
;var Y,bb=[];for(var i=0,l=X.length;i<l;i++ ){Y=X[i];if(typeof Y===k){Y=this.__dT(Y,bc);}
...
(function(){var a="scrollLeft",b="qx.module.Manipulating",c="ease-in",d="scrollTop";qx.Bootstrap.define(b,{statics:{_animationDescription:{scrollLeft:{duration:700,timing:c,keep:100,keyFrames:{'0':{},'100':{scrollLeft:1}}},scrollTop:{duration:700,timing:c,keep:100,keyFrames:{'0':{},'100':{scrollTop:1}}}},__dN:function(f,g,e){var h=qx.lang.Object.clone(qx.module.Manipulating._animationDescription[f],true);h.keyFrames[100][f]=g;return this.animate(h,e);}
,__dO:function(o){var k;if(qx.lang.Type.isArray(o)){k=qxWeb(o);}
else {var n=qx.bom.Html.clean([o]);if(n.length>0&&qx.dom.Node.isElement(n[0])){k=qxWeb(n);}
else {k=qxWeb(o);}
;}
;return k;}
,__dP:function(p){if(p.childNodes.length==0){return p;}
;for(var i=0,l=p.childNodes.length;i<l;i++ ){if(p.childNodes[i].nodeType===1){return this.__dP(p.childNodes[i]);}
;}
;return p;}
,__dQ:function(r){if(!qx.lang.Type.isArray(r)){var q=qxWeb(r);r=q.length>0?q:[r];}
...
,appendTo:function(parent){parent=qx.module.Manipulating.__dQ(parent);for(var i=0,l=parent.length;i<l;i++ ){this._forEachElement(function(C,j){if(i==0){qx.dom.Element.insertEnd(this[j],parent[i]);}
else {qx.dom.Element.insertEnd(this.eq(j).clone(true)[0],parent[i]);}
;}
);}
;return this;}
,insertBefore:function(D){D=qx.module.Manipulating.__dQ(D);for(var i=0,l=D.length;i<l;i++ ){this._forEachElement(function(E,F){if(i==0){qx.dom.Element.insertBefore(E,D[i]);}
else {qx.dom.Element.insertBefore(this.eq(F).clone(true)[0],D[i]);}
;}
);}
;return this;}
,insertAfter:function(G){G=qx.module.Manipulating.__dQ(G);for(var i=0,l=G.length;i<l;i++ ){for(var j=this.length-1;j>=0;j-- ){if(!this[j]||this[j].nodeType!==1){continue;}
;if(i==0){qx.dom.Element.insertAfter(this[j],G[i]);}
else {qx.dom.Element.insertAfter(this.eq(j).clone(true)[0],G[i]);}
;}
;}
;return this;}
,wrap:function(H){H=qx.module.Manipulating.__dO(H);if(H.length==0){return this;}
;this._forEachElement(function(I){var J=H.eq(0).clone(true);qx.dom.Element.insertAfter(J[0],I);var K=qx.module.Manipulating.__dP(J[0]);qx.dom.Element.insertEnd(I,K);}
);return this;}
...
;return Y.scrollTop;}
,setScrollLeft:function(bb,bc){var Node=qx.dom.Node;if(bc&&qx.bom.element&&qx.bom.element.AnimationJs){qx.module.Manipulating.__dN.bind(this,a,bb,bc)();}
...
;}
;return this;}
,setScrollTop:function(be,bf){var Node=qx.dom.Node;if(bf&&qx.bom.element&&qx.bom.element.AnimationJs){qx.module.Manipulating.__dN.bind(this,d,be,bf)();}
...
;var U=W.getProperty(qx.module.Placeholder.PLACEHOLDER_NAME);if(!U){U=qx.module.Placeholder.__up(W);}
;var V=W.isRendered();var X=U.isRendered();if(V&&!X){W.before(U);}
else if(!V&&X){U.remove();return this;}
;qx.module.Placeholder.__uo(W);}
;}
;return this;}
