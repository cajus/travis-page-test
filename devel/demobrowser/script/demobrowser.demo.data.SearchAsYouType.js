...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.data.SearchAsYouType.044b1cf20917.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="_applySearchString",b="demobrowser.demo.data.filter.SearchAsYouTypeFilter",c="String",d="";qx.Class.define(b,{extend:qx.core.Object,construct:function(e){qx.core.Object.call(this);this.__LA=e;this.filter=qx.lang.Function.bind(function(f){return f.search(this.getSearchString())!=-1;}
,this);this.__mQ=null;}
,properties:{searchString:{check:c,apply:a,init:d}},members:{__mQ:null,__LA:null,_applySearchString:function(h,g){var i=qx.util.TimerManager.getInstance();if(this.__mQ!=null){i.stop(this.__mQ);this.__mQ=null;}
;this.__mQ=i.start(function(){this.__LA.update();this.__mQ=null;}
,0,this,null,200);}
,filter:null},destruct:function(){this.__LA=null;}
});}
)();
