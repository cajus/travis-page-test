...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.data.Form.5aa32613fa04.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
,properties:{appearance:{refine:true,init:t}},members:{__Iw:null,_createChildControlImpl:function(B,A){var z;switch(B){case s:z=new qx.ui.core.Spacer();this._add(z,{flex:1});break;case y:z=new qx.ui.basic.Atom(v);z.setCenter(false);z.setAnonymous(true);this._add(z,{flex:1});break;case n:z=new qx.ui.basic.Image();z.setAnonymous(true);this._add(z);break;};return z||qx.ui.form.AbstractSelectBox.prototype._createChildControlImpl.call(this,B);}
...
,__Dh:function(e){var D=e.getData()[0];var C=this.getChildControl(l);if(C.getSelection()[0]!=D){if(D){C.setSelection([D]);}
else {C.resetSelection();}
;}
;this.__Jt();this.__Ju();}
,__Jt:function(){var F=this.getChildControl(l).getSelection()[0];var E=this.getChildControl(y);var G=F?F.getIcon():q;G==null?E.resetIcon():E.setIcon(G);}
,__Ju:function(){var J=this.getChildControl(l).getSelection()[0];var H=this.getChildControl(y);var I=J?J.getLabel():q;var K=this.getFormat();if(K!=null){I=K.call(this,J);}
...
,_onKeyPress:function(e){var L=e.getKeyIdentifier();if(L==b||L==i){if(this.__Iw){this.setSelection([this.__Iw]);this.__Iw=null;}
;this.toggle();}
...
,_onListPointerDown:function(e){if(this.__Iw){this.setSelection([this.__Iw]);this.__Iw=null;}
;}
,_onListChangeSelection:function(e){var Q=e.getData();var O=e.getOldData();if(O&&O.length>0){O[0].removeListener(h,this.__Jt,this);O[0].removeListener(g,this.__Ju,this);}
;if(Q.length>0){var N=this.getChildControl(u);var P=this.getChildControl(l);var R=P.getSelectionContext();if(N.isVisible()&&(R==p||R==k)){this.__Iw=Q[0];}
else {this.setSelection([Q[0]]);this.__Iw=null;}
;Q[0].addListener(h,this.__Jt,this);Q[0].addListener(g,this.__Ju,this);}
