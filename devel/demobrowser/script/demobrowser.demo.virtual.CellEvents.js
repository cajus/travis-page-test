...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.virtual.CellEvents.5f5863ddc4b4.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
,_onCellTap:function(e){var q=f+e.getRow()+i+e.getColumn()+h;this.__Ki(q);}
,_onContextMenu:function(e){var r=d+e.getRow()+i+e.getColumn()+h;this.__Ki(r);}
,_onDbltapPane:function(e){var s=g+e.getRow()+i+e.getColumn()+h;this.__Ki(s);}
,__Ki:function(t){this.logger.setHtml(this.logger.getHtml()+t);}
