...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.widget.ColorPopup.eb97102f0960.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
;var bn=this._tables[this.__gn].values;var bo=this.__gj[this.__gn];if(!bn){return;}
;var bp=this.getValue();if(!bp){return;}
;var bm=bn.indexOf(bp);if(bm!=-1){qx.lang.Array.removeAt(bn,bm);}
else if(bn.length==this.__go){bn.shift();}
...
;this.__gl.setRed(bx);this.__gl.setGreen(bw);this.__gl.setBlue(bv);this.__gk.open();}
,_onColorSelectorOk:function(){var by=this.__gl;this.setValue(qx.util.ColorUtil.rgbToRgbString([by.getRed(),by.getGreen(),by.getBlue()]));this.__gk.close();}
,_onColorSelectorCancel:function(){this.__gk.close();}
...
;}
,_tables:{core:{label:qx.locale.Manager.tr(a),values:[n,k,g,J,w,F,U,T,I,o,b,d]},recent:{label:qx.locale.Manager.tr(Q),values:[]}}},destruct:function(){if(this.__gk){this.__gk.destroy();this.__gl.destroy();this.__gm.destroy();}
;this._tables=this.__gj=null;}
});}
)();
...
,setValue:function(da){var cY;if(da==null){this.__fK=true;cY=[255,255,255];}
else {cY=qx.util.ColorUtil.stringToRgb(da);this.__fK=false;}
;this.__fL=true;this.setRed(cY[0]);this.setGreen(cY[1]);this.__fL=false;this.setBlue(cY[2]);}
,getValue:function(){return this.__fK?null:qx.util.ColorUtil.rgbToHexString([this.getRed(),this.getGreen(),this.getBlue()]);}
,resetValue:function(){this.__fK=true;this.__fL=true;this.setRed(255);this.setGreen(255);this.__fL=false;this.setBlue(255);}
,__fM:function(){if(!this.__fL){this.__fK=false;this.fireDataEvent(f,this.getValue());}
;}
,_applyRed:function(dc,db){if(this.__fE===null){this.__fE=bU;}
;if(this.__fE!==cK){this.getChildControl(m).setValue(dc);}
;if(this.__fE!==n){this._setHexFromRgb();}
;switch(this.__fE){case cK:case n:case bU:this._setHueFromRgb();};this._setPreviewFromRgb();this.__fM();if(this.__fE===bU){this.__fE=null;}
;}
,_applyGreen:function(de,dd){if(this.__fE===null){this.__fE=cq;}
;if(this.__fE!==cK){this.getChildControl(O).setValue(de);}
;if(this.__fE!==n){this._setHexFromRgb();}
;switch(this.__fE){case cK:case n:case cq:this._setHueFromRgb();};this._setPreviewFromRgb();this.__fM();if(this.__fE===cq){this.__fE=null;}
;}
,_applyBlue:function(dg,df){if(this.__fE===null){this.__fE=d;}
;if(this.__fE!==cK){this.getChildControl(cG).setValue(dg);}
;if(this.__fE!==n){this._setHexFromRgb();}
;switch(this.__fE){case cK:case n:case d:this._setHueFromRgb();};this._setPreviewFromRgb();this.__fM();if(this.__fE===d){this.__fE=null;}
;}
,_applyHue:function(di,dh){if(this.__fE===null){this.__fE=cr;}
;if(this.__fE!==F){this.getChildControl(cu).setValue(di);}
;if(this.__fE!==R){if(this.getChildControl(V).getBounds()){this.getChildControl(V).setDomLeft(Math.round(di/1.40625)+this.getChildControl(cc).getPaddingLeft());}
else {this.getChildControl(V).setLayoutProperties({left:Math.round(di/1.40625)});}
;}
;switch(this.__fE){case F:case R:case cr:this._setRgbFromHue();};this._setBrightnessGradiant();if(this.__fE===cr){this.__fE=null;}
;}
,_applySaturation:function(dk,dj){if(this.__fE===null){this.__fE=s;}
;if(this.__fE!==F){this.getChildControl(cx).setValue(dk);}
;if(this.__fE!==R){this._setBrightnessGradiant();if(this.getChildControl(V).getBounds()){this.getChildControl(V).setDomTop(256-Math.round(dk*2.56)+this.getChildControl(cc).getPaddingTop());}
else {this.getChildControl(V).setLayoutProperties({top:256-Math.round(dk*2.56)});}
;}
;switch(this.__fE){case F:case R:case s:this._setRgbFromHue();};if(this.__fE===s){this.__fE=null;}
;}
,_applyBrightness:function(dn,dm){if(this.__fE===null){this.__fE=c;}
;if(this.__fE!==F){this.getChildControl(bT).setValue(dn);}
;if(this.__fE!==P){var dl=256-Math.round(dn*2.56);if(this.getChildControl(cM).getBounds()){this.getChildControl(cM).setDomTop(dl+this.getChildControl(cE).getPaddingTop());}
else {this.getChildControl(cM).setLayoutProperties({top:dl});}
;}
;switch(this.__fE){case F:case P:case c:this._setRgbFromHue();};if(this.__fE===c){this.__fE=null;}
;}
,_onBrightnessHandlePointerDown:function(e){this.getChildControl(cM).capture();this.__fG=cM;var dr=this.getChildControl(cf).getContentLocation();var dq=this.getChildControl(cM).getContentLocation();var dp=this.getChildControl(cf).getBounds();this.__fH=dr.top+(e.getDocumentTop()-dq.top)-dp.top;e.stopPropagation();}
,_onBrightnessHandlePointerUp:function(e){this.getChildControl(cM).releaseCapture();this.__fG=null;}
,_onBrightnessHandlePointerMove:function(e){if(this.__fG===cM){this._setBrightnessOnFieldEvent(e);e.stopPropagation();}
;}
,_onBrightnessFieldPointerDown:function(e){var location=this.getChildControl(cf).getContentLocation();var ds=this.getChildControl(cM).getBounds();this.__fH=location.top+(ds.height/2);this._setBrightnessOnFieldEvent(e);this.getChildControl(cM).capture();this.__fG=cM;}
...
,_setBrightnessOnFieldEvent:function(e){var dt=qx.lang.Number.limit(e.getDocumentTop()-this.__fH,0,256);this.__fE=P;if(this.getChildControl(cM).getBounds()){this.getChildControl(cM).setDomTop(dt);}
else {this.getChildControl(cM).setLayoutProperties({top:dt});}
;this.setBrightness(100-Math.round(dt/2.56));this.__fE=null;}
,_onHueSaturationHandlePointerUp:function(e){if(this.__fG){e.stopPropagation();this.getChildControl(V).releaseCapture();this.__fG=null;}
;}
,_onHueSaturationHandlePointerMove:function(e){if(this.__fG===V){this._setHueSaturationOnFieldEvent(e);e.stopPropagation();}
;}
,_onHueSaturationFieldPointerDown:function(e){var location=this.getChildControl(ca).getContentLocation();var du=this.getChildControl(V).getBounds();var dv=this.getChildControl(ca).getBounds();this.__fI=location.top+(du.height/2)-dv.top;this.__fJ=location.left+(du.width/2)-dv.left;this._setHueSaturationOnFieldEvent(e);this.getChildControl(V).capture();this.__fG=V;}
...
,_setHueSaturationOnFieldEvent:function(e){var dy=qx.lang.Number.limit(e.getDocumentTop()-this.__fI,0,256);var dx=qx.lang.Number.limit(e.getDocumentLeft()-this.__fJ,0,256);this.getChildControl(V).setDomPosition(dx,dy);this.__fE=R;this.setSaturation(100-Math.round(dy/2.56));this.setHue(Math.round(dx*1.40625));this.__fE=null;}
,_setRedFromSpinner:function(){if(this.__fE!==null){return;}
;this.__fE=cK;this.setRed(this.getChildControl(m).getValue());this.__fE=null;}
,_setGreenFromSpinner:function(){if(this.__fE!==null){return;}
;this.__fE=cK;this.setGreen(this.getChildControl(O).getValue());this.__fE=null;}
,_setBlueFromSpinner:function(){if(this.__fE!==null){return;}
;this.__fE=cK;this.setBlue(this.getChildControl(cG).getValue());this.__fE=null;}
,_setHueFromSpinner:function(){if(this.__fE!==null){return;}
;this.__fE=F;this.setHue(this.getChildControl(cu).getValue());this.__fE=null;}
,_setSaturationFromSpinner:function(){if(this.__fE!==null){return;}
;this.__fE=F;this.setSaturation(this.getChildControl(cx).getValue());this.__fE=null;}
,_setBrightnessFromSpinner:function(){if(this.__fE!==null){return;}
;this.__fE=F;this.setBrightness(this.getChildControl(bT).getValue());this.__fE=null;}
,_onHexFieldChange:function(e){if(this.__fE!==null){return;}
;try{var dA=this.getChildControl(cD);var dz=qx.util.ColorUtil.hexStringToRgb(J+dA.getValue());}
catch(dB){return;}
;this.__fE=n;this.setRed(dz[0]);this.setGreen(dz[1]);this.setBlue(dz[2]);this.__fE=null;}
...
,_setHueFromRgb:function(){switch(this.__fE){case F:case R:case P:break;default:var dF=qx.util.ColorUtil.rgbToHsb([this.getRed(),this.getGreen(),this.getBlue()]);this.setHue(dF[0]);this.setSaturation(dF[1]);this.setBrightness(dF[2]);};}
,_setRgbFromHue:function(){switch(this.__fE){case cK:case n:break;default:var dG=qx.util.ColorUtil.hsbToRgb([this.getHue(),this.getSaturation(),this.getBrightness()]);this.setRed(dG[0]);this.setGreen(dG[1]);this.setBlue(dG[2]);};}
