...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.mobile.Fingers.d244d9bcf992.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="black",b="px",c="green",d="div",f="100%",g="yellow",h="30px",j="qx.debug",k="0px",l="12px",m="<b>This demo is intended for WebKit-based browsers and IE11+.</b>",n="browser.documentmode",o="100px",p="demobrowser.demo.mobile.Fingers",q='Lucida Grande',r="50px",s="innerHTML",t="pointerdown",u="mshtml",v="engine.name",w="20px",x="red",y="webkit",z="none",A="white",B="<b>Use your fingers to move the dots</b>",C="pointermove",D="blue",E="absolute";qx.Class.define(p,{extend:qx.application.Native,members:{__LB:null,__LC:null,main:function(){qx.application.Native.prototype.main.call(this);if(qx.core.Environment.get(j)){qx.log.appender.Native;qx.log.appender.Console;}
...
;this.__LB=[];this.__LC=[];O.addListener(t,this._onPointerDown,this);O.addListener(C,this._onPointerMove,this);}
,_onPointerDown:function(e){this.__LB[e.getPointerId()]=parseInt(e.getTarget().style.left)-e.getDocumentLeft();this.__LC[e.getPointerId()]=parseInt(e.getTarget().style.top)-e.getDocumentTop();}
,_onPointerMove:function(e){if(e.getTarget()==document.body){return;}
;qx.bom.element.Style.setStyles(e.getTarget(),{"left":(e.getDocumentLeft()+this.__LB[e.getPointerId()])+b,"top":(e.getDocumentTop()+this.__LC[e.getPointerId()])+b});e.preventDefault();}
}});}
)();
