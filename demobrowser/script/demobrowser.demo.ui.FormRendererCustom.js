...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.ui.FormRendererCustom.a0cbeb1dc8f7.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
}});qx.Class.define(j,{extend:qx.ui.form.renderer.Single,members:{__Oe:0,__Of:0,addItems:function(E,H,D,I){var J=0;if(D!=null){this._add(this._createHeader(D),{row:J,column:this.__Oe,colSpan:2});J++ ;}
;for(var i=0;i<E.length;i++ ){var F=this._createLabel(H[i],E[i]);this._add(F,{row:J,column:this.__Oe});var G=E[i];F.setBuddy(G);if(G instanceof qx.ui.form.RadioGroup){G=this._createWidgetForRadioGroup(G);}
;this._add(G,{row:J,column:this.__Oe+1});if(I[i]&&I[i].placeholder){G.setPlaceholder(I[i].placeholder);}
;J++ ;}
;this.__Oe+=2;this.__Of<J?this.__Of=J:null;}
,addButton:function(K){if(this._buttonRow==null){this._buttonRow=new qx.ui.container.Composite();this._buttonRow.setMarginTop(5);var L=new qx.ui.layout.HBox();L.setAlignX(s);L.setSpacing(5);this._buttonRow.setLayout(L);this._add(this._buttonRow,{row:this.__Of,column:0,colSpan:this.__Oe});}
