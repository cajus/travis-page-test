...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.widget.Tooltip.0ff5de396725.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
,__OI:4,__OJ:0,add:function(B){this.container.add(B,{row:Math.floor(this.__OJ/this.__OI),column:this.__OJ%this.__OI});this.__OJ+=1;}
