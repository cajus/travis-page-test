...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.widget.Iframe.1ef29af3cb51.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
,properties:{appearance:{refine:true,init:r},scrollbarX:{check:[u,q,o],init:u,themeable:true,apply:i},scrollbarY:{check:[u,q,o],init:u,themeable:true,apply:i},scrollbar:{group:[k,l]}},members:{__Fc:null,__Fd:null,_getIframeElement:function(){return this.getChildControl(j).getContentElement();}
...
;}
,_startIframeObserver:function(){if(this.__Fd){this._stopIframeObserver();}
;var F=qx.event.Idle.getInstance();this.__Fd=F.addListener(c,this._onIframeObserverInterval,this);}
,_stopIframeObserver:function(){this.__Fc=null;if(!this.__Fd){return;}
;var G=qx.event.Idle.getInstance();G.removeListenerById(this.__Fd);}
,_onIframeObserverInterval:function(){var H=this._getIframeSize();if(!H){this._disableScollbars();return;}
;if(this.__Fc&&H.width==this.__Fc.width&&H.height==this.__Fc.height){return;}
;this.__Fc=H;this._preventIframeScrolling();this._updateScrollbars();}
...
;}
,_updateScrollbars:function(){var K=this.__Fc;var N=this.getChildControl(j).getBounds();var L=this.getChildControl(j).getInnerSize();if(!K||!L||!L){return;}
...
;}
},destruct:function(){this._stopIframeObserver();this.__Fc=null;}
});}
)();
