...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.virtual.Cells.9f9ad0b26e8f.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
,testStringCell:function(){var J={value:[A,p,r,null],states:[{},{selected:1}]};var I=new qx.ui.virtual.cell.String;qx.util.Permutation.permute(J,function(L){var K=this.__KV(I,L.value,L.states);this.container.add(K);}
,this);}
...
;var O=this.__KV(N,P.value,P.states);this.container.add(O);}
,this);}
...
;var S=this.__KV(R,T.value,T.states);this.container.add(S);}
,this);}
,testHtmlCell:function(){var U={value:[A,p,r,null],states:[{},{selected:1}]};var V=new qx.ui.virtual.cell.Html;qx.util.Permutation.permute(U,function(X){var W=this.__KV(V,X.value,X.states);this.container.add(W);}
,this);}
,testImageCell:function(){var Y={value:[{url:C,tooltip:E},{url:w,tooltip:u},null],states:[{},{selected:1}]};var ba=new qx.ui.virtual.cell.Image;qx.util.Permutation.permute(Y,function(bc){var bb=this.__KV(ba,bc.value,bc.states);this.container.add(bb);}
,this);}
,testBooleanCell:function(){var bd={value:[true,false,null],states:[{},{selected:1}]};var be=new qx.ui.virtual.cell.Boolean;qx.util.Permutation.permute(bd,function(bg){var bf=this.__KV(be,bg.value,bg.states);this.container.add(bf);}
,this);}
,testBooleanCellCustomImage:function(){var bh={value:[true,false,null],states:[{},{selected:1}]};var bi=new qx.ui.virtual.cell.Boolean;bi.setIconFalse(B);bi.setIconTrue(D);qx.util.Permutation.permute(bh,function(bk){var bj=this.__KV(bi,bk.value,bk.states);this.container.add(bj);}
,this);}
,__KV:function(bn,bo,bq){var br=100;var bp=30;var bt=new qx.ui.embed.Html().set({width:br,height:bp,decorator:bq.selected?null:z});var bm=bn.getCellProperties(bo,bq);var bl=bm.insets;var bs=[d,F,this._getCellSizeStyle(br,bp,bl[0],bl[1]),bm.style,e,g,bm.classes,e,bm.attributes,l,bm.content,c].join(r);bt.setHtml(bs);return bt;}
...
;this.__dF=qx.bom.Stylesheet.createElement(p);this.__EI={};this.__lW={};}
,members:{__dF:null,__EI:null,__lW:null,getStylesheet:function(){return this.__dF;}
,getCssClass:function(q){return this.__EI[q]||null;}
,computeClassForStyles:function(t,r){var s=this.__lW[r];if(!s){var s=this.__EJ();qx.bom.Stylesheet.addRule(this.__dF,k+s,r);this.__lW[r]=s;}
;this.__EI[t]=s;return s;}
,__EJ:function(){return e+this.toHashCode()+a+(this.__EK++ );}
,__EK:0},destruct:function(){this.__dF=this.__EI=this.__lW=null;}
});}
)();
(function(){var a="-",b="backgroundColor",c="_applyTextAlign",d="px",e="paddingLeft",f="_applyFont",g="Integer",h="_applyBackgroundColor",j="_applyPadding",k="cell",l="center",m="font",n=":",o="shorthand",p="Color",q="String",r="_applyAppearance",s="background-color:",t="",u="textAlign",v="qx-cell ",w="left",x="textColor",y="text-align:",z="Font",A="paddingBottom",B="paddingTop",C="right",D="_applyTextColor",E="justify",F="color:",G="paddingRight",H=" ",I=";",J="qx.ui.virtual.cell.Cell";qx.Class.define(J,{extend:qx.ui.virtual.cell.Abstract,construct:function(){qx.ui.virtual.cell.Abstract.call(this);this.__dF=qx.ui.virtual.cell.CellStylesheet.getInstance();this.__EL={};this.__EM={};this.__EN={};this.__EO={};this.__jO={};this.__EP={};this.initAppearance();this.__ET();}
,properties:{appearance:{check:q,init:k,apply:r},backgroundColor:{nullable:true,check:p,apply:h,themeable:true},textColor:{nullable:true,check:p,apply:D,themeable:true},textAlign:{check:[w,l,C,E],nullable:true,themeable:true,apply:c},font:{nullable:true,apply:f,check:z,themeable:true},paddingTop:{check:g,init:0,apply:j,themeable:true},paddingRight:{check:g,nullable:true,apply:j,themeable:true},paddingBottom:{check:g,nullable:true,apply:j,themeable:true},paddingLeft:{check:g,nullable:true,apply:j,themeable:true},padding:{group:[B,G,A,e],mode:o,themeable:true}},members:{__EQ:null,__ER:null,__jO:null,__EP:null,__EM:null,__EL:null,__EN:null,__EO:null,__ES:false,__dF:null,__ET:function(){var M=qx.util.PropertyUtil;var K=qx.lang.Object.fromArray(this._getCssProperties());this.__EQ=[];var O=this.constructor;while(O){var L=M.getProperties(O);for(var N in L){if(!K[N]){this.__EQ.push(N);}
;}
;O=O.superclass;}
;}
,_getCssProperties:function(){return [b,x,m,u,B,G,A,e];}
,_applyAppearance:function(Q,P){if(P){this.__EM={};}
;}
,_getValue:function(R){if(this.__ES){return qx.util.PropertyUtil.getThemeValue(this,R);}
else {return qx.util.PropertyUtil.getUserValue(this,R);}
;}
,_storeStyle:function(T,S){var U;if(this.__ES){U=this.__EM;}
else {U=this.__EL;}
...
;}
,_applyPadding:function(bh,bg,name){var bh=this._getValue(name);if(this.__ES){var bi=this.__EO;}
else {bi=this.__EN;}
...
;}
,getCellProperties:function(bk,bj){this.__EU(bj);return {classes:this.getCssClasses(bk,bj),style:this.getStyles(bk,bj),attributes:this.getAttributes(bk,bj),content:this.getContent(bk,bj),insets:this.getInsets(bk,bj)};}
,getAttributes:function(bm,bl){return t;}
,getContent:function(bo,bn){return bo;}
,getCssClasses:function(br,bp){var bq=this.__dF.getCssClass(this.__ER)||t;return v+bq;}
,__EU:function(bs){if(!bs){bs={};}
;var bu=this.getAppearance();var bt=bu+a+Object.keys(bs).sort().join(H);if(this.__ER==bt){return;}
;this.__ER=bt;var bv=this.__jO[this.__ER];if(!bv){this.__EV();this.__EW(bs);this.__EX(bs);this.__EY();this.__jO[this.__ER]=1;}
;this.__Fa();}
,__EV:function(){var bw=qx.util.PropertyUtil;var bx=this._getCssProperties();for(var i=0;i<bx.length;i++ ){bw.deleteThemeValue(this,bx[i]);}
;}
,__EW:function(bz){this.__EM={};this.__ES=true;var bB=this.getAppearance();var bA=qx.util.PropertyUtil;var by=qx.theme.manager.Appearance.getInstance().styleFrom(bB,bz);for(var bC in by){if(by[bC]!==undefined){bA.setThemed(this,bC,by[bC]);}
;}
;this.__ES=false;}
,__EX:function(){var bD=qx.lang.Object.getValues(this.__EM).join(I);this.__dF.computeClassForStyles(this.__ER,bD);}
,__EY:function(){var bI=this.__EQ;var bE=qx.util.PropertyUtil;var bG={};for(var i=0;i<bI.length;i++ ){var bH=bI[i];var bF=bE.getThemeValue(this,bH);if(bF!==undefined){bG[bH]=bF;}
;}
;this.__EP[this.__ER]=bG;}
,__Fa:function(){var bK=qx.util.PropertyUtil;var bJ=this.__EP[this.__ER]||{};for(var bL in bJ){bK.setThemed(this,bL,bJ[bL]);}
;}
,getStyles:function(bN,bM){return qx.lang.Object.getValues(this.__EL).join(I);}
,getInsets:function(bQ,bR){var bT=this.__EN;var bS=this.__EO;var top=(bT.paddingTop!==undefined?bT.paddingTop:bS.paddingTop)||0;var bO=(bT.paddingRight!==undefined?bT.paddingRight:bS.paddingRight)||0;var bP=(bT.paddingBottom!==undefined?bT.paddingBottom:bS.paddingBottom)||0;var bU=(bT.paddingLeft!==undefined?bT.paddingLeft:bS.paddingLeft)||0;return [bU+bO,top+bP];}
},destruct:function(){this.__dF=this.__EL=this.__EM=this.__EN=this.__EO=this.__jO=this.__EP=this.__EQ=null;}
});}
)();
...
,members:{__FK:16,__FL:16,_aliasManager:null,__FN:function(v){var w=qx.util.ResourceManager.getInstance();var u=qx.io.ImageLoader;var t,x;if(w.has(v)){t=w.getImageWidth(v),x=w.getImageHeight(v);}
else if(u.isLoaded(v)){t=u.getWidth(v);x=u.getHeight(v);}
else {t=this.__FK;x=this.__FL;}
;return {width:t,height:x};}
,__GH:function(z){if(typeof (z)==r){z={url:z};}
...
(function(){var a="_applyIconFalse",b="qx.ui.virtual.cell.Boolean",c="_applyIconTrue",d="String",e="cell-boolean";qx.Class.define(b,{extend:qx.ui.virtual.cell.AbstractImage,construct:function(){qx.ui.virtual.cell.AbstractImage.call(this);this.__FO=qx.util.AliasManager.getInstance();}
,properties:{appearance:{refine:true,init:e},iconTrue:{check:d,themeable:true,apply:c},iconFalse:{check:d,themeable:true,apply:a}},members:{__HR:null,__HS:null,__FO:null,_applyIconTrue:function(f){this.__HR=this.__FO.resolve(f);}
,_applyIconFalse:function(g){this.__HS=this.__FO.resolve(g);}
,_identifyImage:function(h){return h==true?this.__HR:this.__HS;}
}});}
)();
