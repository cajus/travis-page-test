...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.root.Inline_Window.e5a1910a3709.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="resize",b="qx.ui.root.Page",c="engine.name",d="mshtml",f="gecko",g="paddingLeft",h="$$widget",i="The root widget does not support 'left', or 'top' paddings!",j="div",k="left",l="paddingTop",m="qxIsRootPage",n="absolute";qx.Class.define(b,{extend:qx.ui.root.Abstract,construct:function(o){this.__qY=o;qx.ui.root.Abstract.call(this);this._setLayout(new qx.ui.layout.Basic());this.setZIndex(10000);qx.ui.core.queue.Layout.add(this);this.addListener(a,this.__nd,this);qx.ui.core.FocusHandler.getInstance().connectTo(this);if((qx.core.Environment.get(c)==d)){this.setKeepFocus(true);}
;}
,members:{__rq:null,__qY:null,_createContentElement:function(){var q=this.__qY.createElement(j);this.__qY.body.appendChild(q);var p=new qx.html.Root(q);p.setStyles({position:n,textAlign:k});p.setAttribute(h,this.toHashCode());if((qx.core.Environment.get(c)==f)){p.setAttribute(m,1);}
;return p;}
...
;this.__bX=w;w.style.overflow=p;w.style.textAlign=r;this.__bY=x||false;this.__ca=v||false;this.__cb();qx.ui.root.Abstract.call(this);this._setLayout(new qx.ui.layout.Basic());qx.ui.core.queue.Layout.add(this);qx.ui.core.FocusHandler.getInstance().connectTo(this);if((qx.core.Environment.get(c)==b)){this.setKeepFocus(true);}
...
,members:{__bY:false,__ca:false,__bX:null,__cb:function(){if(this.__bY||this.__ca){var y=qx.bom.element.Dimension.getSize(this.__bX);if(this.__bY&&y.width<1){throw new Error(s+this.__bX+t+this+k);}
;if(this.__ca){if(y.height<1){throw new Error(s+this.__bX+t+this+g);}
;if(y.height>=1&&qx.bom.element.Style.get(this.__bX,j,3)==f){qx.bom.element.Style.set(this.__bX,j,y.height+h);}
;}
;qx.event.Registration.addListener(this.__bX,a,this._onResize,this);}
;}
,_createContentElement:function(){var z=this.__bX;if(this.__bY||this.__ca){var B=document.createElement(q);z.appendChild(B);}
else {B=z;}
...
,this,0);return A;}
,_onResize:function(e){var C=e.getData();if((C.oldWidth!==C.width)&&this.__bY||(C.oldHeight!==C.height)&&this.__ca){qx.ui.core.queue.Layout.add(this);}
;}
...
;}
,_computeSizeHint:function(){var H=this.__bY;var E=this.__ca;if(!H||!E){var D=qx.ui.root.Abstract.prototype._computeSizeHint.call(this);}
else {D={};}
;var I=qx.bom.element.Dimension;if(H){var G=I.getContentWidth(this.__bX);D.width=G;D.minWidth=G;D.maxWidth=G;}
;if(E){var F=I.getContentHeight(this.__bX);D.height=F;D.minHeight=F;D.maxHeight=F;}
;return D;}
},defer:function(J,K){qx.ui.core.MLayoutHandling.remap(K);}
,destruct:function(){qx.event.Registration.removeListener(this.__bX,a,this._onResize,this);this.__bX=null;}
});}
)();
(function(){var a="resize",b="interval",c="__rq",d="body",f="qx.event.handler.ElementResize";qx.Class.define(f,{extend:qx.core.Object,implement:qx.event.IEventHandler,construct:function(g){qx.core.Object.call(this);this.__ff=g;this.__ur={};this.__rq=new qx.event.Timer(200);this.__rq.addListener(b,this._onInterval,this);}
,statics:{PRIORITY:qx.event.Registration.PRIORITY_NORMAL,SUPPORTED_TYPES:{resize:true},TARGET_CHECK:qx.event.IEventHandler.TARGET_DOMNODE,IGNORE_CAN_HANDLE:false},members:{__ur:null,__ff:null,__rq:null,canHandleEvent:function(i,h){return i.tagName.toLowerCase()!==d;}
,registerEvent:function(m,n,j){var l=qx.core.ObjectRegistry.toHashCode(m);var k=this.__ur;if(!k[l]){k[l]={element:m,width:qx.bom.element.Dimension.getWidth(m),height:qx.bom.element.Dimension.getHeight(m)};this.__rq.start();}
;}
,unregisterEvent:function(r,s,o){var q=qx.core.ObjectRegistry.toHashCode(r);var p=this.__ur;if(p[q]){delete p[q];if(qx.lang.Object.isEmpty(p)){this.__rq.stop();}
;}
;}
...
;}
;}
},destruct:function(){this.__ff=this.__ur=null;this._disposeObjects(c);}
