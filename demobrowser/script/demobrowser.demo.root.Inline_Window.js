...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.root.Inline_Window.deb22dfe84e7.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
;this.__zF=w;w.style.overflow=p;w.style.textAlign=r;this.__zG=x||false;this.__zH=v||false;this.__zI();qx.ui.root.Abstract.call(this);this._setLayout(new qx.ui.layout.Basic());qx.ui.core.queue.Layout.add(this);qx.ui.core.FocusHandler.getInstance().connectTo(this);if((qx.core.Environment.get(c)==b)){this.setKeepFocus(true);}
...
,members:{__zG:false,__zH:false,__zF:null,__zI:function(){if(this.__zG||this.__zH){var y=qx.bom.element.Dimension.getSize(this.__zF);if(this.__zG&&y.width<1){throw new Error(s+this.__zF+t+this+k);}
;if(this.__zH){if(y.height<1){throw new Error(s+this.__zF+t+this+g);}
;if(y.height>=1&&qx.bom.element.Style.get(this.__zF,j,3)==f){qx.bom.element.Style.set(this.__zF,j,y.height+h);}
;}
;qx.event.Registration.addListener(this.__zF,a,this._onResize,this);}
;}
,_createContentElement:function(){var z=this.__zF;if(this.__zG||this.__zH){var B=document.createElement(q);z.appendChild(B);}
else {B=z;}
...
,this,0);return A;}
,_onResize:function(e){var C=e.getData();if((C.oldWidth!==C.width)&&this.__zG||(C.oldHeight!==C.height)&&this.__zH){qx.ui.core.queue.Layout.add(this);}
;}
...
;}
,_computeSizeHint:function(){var H=this.__zG;var E=this.__zH;if(!H||!E){var D=qx.ui.root.Abstract.prototype._computeSizeHint.call(this);}
else {D={};}
;var I=qx.bom.element.Dimension;if(H){var G=I.getContentWidth(this.__zF);D.width=G;D.minWidth=G;D.maxWidth=G;}
;if(E){var F=I.getContentHeight(this.__zF);D.height=F;D.minHeight=F;D.maxHeight=F;}
;return D;}
},defer:function(J,K){qx.ui.core.MLayoutHandling.remap(K);}
,destruct:function(){qx.event.Registration.removeListener(this.__zF,a,this._onResize,this);this.__zF=null;}
});}
)();
(function(){var a="resize",b="__du",c="interval",d="body",f="qx.event.handler.ElementResize";qx.Class.define(f,{extend:qx.core.Object,implement:qx.event.IEventHandler,construct:function(g){qx.core.Object.call(this);this.__dh=g;this.__zJ={};this.__du=new qx.event.Timer(200);this.__du.addListener(c,this._onInterval,this);}
,statics:{PRIORITY:qx.event.Registration.PRIORITY_NORMAL,SUPPORTED_TYPES:{resize:true},TARGET_CHECK:qx.event.IEventHandler.TARGET_DOMNODE,IGNORE_CAN_HANDLE:false},members:{__zJ:null,__dh:null,__du:null,canHandleEvent:function(i,h){return i.tagName.toLowerCase()!==d;}
,registerEvent:function(m,n,j){var l=qx.core.ObjectRegistry.toHashCode(m);var k=this.__zJ;if(!k[l]){k[l]={element:m,width:qx.bom.element.Dimension.getWidth(m),height:qx.bom.element.Dimension.getHeight(m)};this.__du.start();}
;}
,unregisterEvent:function(r,s,o){var q=qx.core.ObjectRegistry.toHashCode(r);var p=this.__zJ;if(p[q]){delete p[q];if(qx.lang.Object.isEmpty(p)){this.__du.stop();}
;}
;}
,_onInterval:function(e){var u=this.__zJ;for(var x in u){var y=u[x];var t=y.element;var w=qx.bom.element.Dimension.getWidth(t);var v=qx.bom.element.Dimension.getHeight(t);if(y.height!==v||y.width!==w){qx.event.Registration.fireNonBubblingEvent(t,a,qx.event.type.Data,[{width:w,oldWidth:y.width,height:v,oldHeight:y.height}]);y.width=w;y.height=v;}
;}
;}
},destruct:function(){this.__dh=this.__zJ=null;this._disposeObjects(b);}
