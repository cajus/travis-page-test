...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.widget.Flash.abb3bbec2df2.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="2) this html page is not loaded from the file system, but a webserver.",b="__Gf",c="Flash Player Version",d="right",f="qooxdoo is the best!",g="Message from Flash:",h="execute",i="__Ov",j="__Ox",k="Simple demo with FlashVars",l="bgcolor",m="demobrowser.demo.widget.Flash",n="demobrowser/demo/flash/TestFlash.swf",o="1) no pop-up or advertising blocker is activated.\n",p="Send to Flash",q="demobrowser/demo/flash/FlashVersion.swf",r="No message.",s="Flash:",t="<b>qooxdoo:</b>",u="__cE",v="__Ow",w="demobrowser.demo.widget.Flash.sendMessage",x="demobrowser.demo.widget.Flash.flashReady",y="Couldn't connect to Flash Player! Please make sure that:\n",z="demobrowser/demo/flash/fo_tester.swf",A="this is passed in via FlashVars",B="Two way communication (ActionScript <-> JavaScript)",C="Message to Flash:",D="Show Flash Player version",E="noscale",F="#FF6600";qx.Class.define(m,{extend:qx.application.Standalone,members:{__cE:null,main:function(){qx.application.Standalone.prototype.main.call(this);var J=new qx.ui.tabview.TabView();J.setContentPadding([8,8,8,8]);var G=this.getRoot();G.add(J,{edge:0});var H=new qx.ui.tabview.Page(k);H.setLayout(new qx.ui.layout.Canvas());H.add(this.createFlashDemo1(),{edge:0});J.add(H);var I=new qx.ui.tabview.Page(B);I.setLayout(new qx.ui.layout.Canvas());I.add(this.createFlashDemo2(),{edge:0});J.add(I);this.__cE=this.createWindow();G.add(this.__cE,{top:20,left:20});}
...
,createFlashDemo1:function(){var N=new qx.ui.container.Composite(new qx.ui.layout.VBox(4));var L={flashVarText:A};var M=new qx.ui.embed.Flash(z).set({scale:E,variables:L});M.getContentElement().setParam(l,F);N.add(M,{flex:1});var O=new qx.ui.form.Button(D);O.addListener(h,function(){this.__cE.open();}
,this);N.add(O);return N;}
,__Gf:null,__Ov:null,__Ow:null,__Ox:null,createFlashDemo2:function(){this.self(arguments).setCallBackInstance(this);var R=new qx.ui.container.Composite(new qx.ui.layout.HBox(8));var Q=new qx.ui.container.Composite(new qx.ui.layout.VBox(4));R.add(Q,{flex:1});Q.add(new qx.ui.basic.Label(t).set({rich:true}));Q.add(new qx.ui.basic.Label(g));this.__Ov=new qx.ui.form.TextArea(r);this.__Ov.setEnabled(false);Q.add(this.__Ov,{flex:1});Q.add(new qx.ui.basic.Label(C));this.__Ow=new qx.ui.form.TextArea(f);Q.add(this.__Ow,{flex:1});var S=new qx.ui.container.Composite(new qx.ui.layout.HBox(0,d));this.__Ox=new qx.ui.form.Button(p);this.__Ox.setEnabled(false);this.__Ox.addListener(h,function(e){this.__Gf.getFlashElement().sendMessage(this.__Ow.getValue());}
,this);S.add(this.__Ox);Q.add(S);var P=new qx.ui.container.Composite(new qx.ui.layout.VBox(4));R.add(P,{flex:1});P.add(new qx.ui.basic.Label(s).set({rich:true}));this.__Gf=new qx.ui.embed.Flash(n);this.__Gf.setVariables({init:x});P.add(this.__Gf,{flex:1});return R;}
,sendMessage:function(T){this.__Ov.setValue(T);}
,initFlash:function(){if(this.__Gf.getFlashElement().setup){this.__Gf.getFlashElement().setup(w);this.__Ox.setEnabled(true);}
else {alert(y+o+a);}
;}
},statics:{__Oy:null,setCallBackInstance:function(U){demobrowser.demo.widget.Flash.__Oy=U;}
,sendMessage:function(V){demobrowser.demo.widget.Flash.__Oy.sendMessage(V);}
,flashReady:function(){demobrowser.demo.widget.Flash.__Oy.initFlash();}
},destruct:function(){this._disposeObjects(i,v,j,b,u);}
});}
)();
...
(function(){var a="__xa",b="bottom",c="button",d="qx.event.type.Data",f="lastTab",g="barRight",h="beforeChangeSelection",j="qx.debug",k="horizontal",m="changeSelection",n="bar",o="close-button",p="Index should be less than : ",q="tabview",r="vertical",s="page",t="Incompatible child for TabView: ",u="close",v="_applyBarPosition",w="barLeft",x="top",y="right",z="qx.ui.tabview.TabView",A="barTop",B="barBottom",C="pane",D="left",E="firstTab";qx.Class.define(z,{extend:qx.ui.core.Widget,implement:qx.ui.core.ISingleSelection,include:[qx.ui.core.MContentPadding],construct:function(G){qx.ui.core.Widget.call(this);this.__yW={top:A,right:g,bottom:B,left:w};this._createChildControl(n);this._createChildControl(C);var F=this.__xa=new qx.ui.form.RadioGroup;F.setWrap(false);F.addListener(m,this._onChangeSelection,this);if(G!=null){this.setBarPosition(G);}
else {this.initBarPosition();}
;}
,events:{"changeSelection":d},properties:{appearance:{refine:true,init:q},barPosition:{check:[D,y,x,b],init:x,apply:v}},members:{__xa:null,_createChildControlImpl:function(J,I){var H;switch(J){case n:H=new qx.ui.container.SlideBar();H.setZIndex(10);this._add(H);break;case C:H=new qx.ui.container.Stack;H.setZIndex(5);this._add(H,{flex:1});break;};return H||qx.ui.core.Widget.prototype._createChildControlImpl.call(this,J);}
...
;}
;var K=O.getButton();var L=this.getChildControl(n);var N=this.getChildControl(C);O.exclude();L.add(K);N.add(O);this.__xa.add(K);O.addState(this.__yW[this.getBarPosition()]);O.addState(f);var M=this.getChildren();if(M[0]==O){O.addState(E);}
...
;var R=U.getButton();var Q=this.getChildControl(n);var T=this.getChildControl(C);U.exclude();Q.addAt(R,P);T.addAt(U,P);this.__xa.add(R);U.addState(this.__yW[this.getBarPosition()]);S=this.getChildren();if(P==S.length-1){U.addState(f);}
...
;}
;W.remove(X);ba.remove(Y);this.__xa.remove(X);Y.removeState(this.__yW[this.getBarPosition()]);if(Y.hasState(E)){Y.removeState(E);if(bb[0]){bb[0].addState(E);}
;}
...
,__yW:null,_applyBarPosition:function(bg,bi){var bd=this.getChildControl(n);var bj=this.getChildControl(C);var bl=bg==D||bg==y;var bm=bg==y||bg==b;var bk=bl?qx.ui.layout.HBox:qx.ui.layout.VBox;var bn=this._getLayout();if(bn&&bn instanceof bk){}
else {this._setLayout(bn=new bk);}
;bn.setReversed(bm);bd.setOrientation(bl?r:k);var bh=this.getChildren();var i,l;if(bi){var bf=this.__yW[bi];bd.removeState(bf);bj.removeState(bf);for(i=0,l=bh.length;i<l;i++ ){bh[i].removeState(bf);}
;}
;if(bg){var be=this.__yW[bg];bd.addState(be);bj.addState(be);for(i=0,l=bh.length;i<l;i++ ){bh[i].addState(be);}
;}
;}
,getSelection:function(){var bo=this.__xa.getSelection();var bp=[];for(var i=0;i<bo.length;i++ ){bp.push(bo[i].getUserData(s));}
;return bp;}
,setSelection:function(br){var bq=[];for(var i=0;i<br.length;i++ ){bq.push(br[i].getChildControl(c));}
;this.__xa.setSelection(bq);}
,resetSelection:function(){this.__xa.resetSelection();}
,isSelected:function(bs){var bt=bs.getChildControl(c);return this.__xa.isSelected(bt);}
,isSelectionEmpty:function(){return this.__xa.isSelectionEmpty();}
,getSelectables:function(bv){var bu=this.__xa.getSelectables(bv);var bw=[];for(var i=0;i<bu.length;i++ ){bw.push(bu[i].getUserData(s));}
;return bw;}
...
},destruct:function(){this._disposeObjects(a);this.__yW=null;}
});}
)();
...
(function(){var a="qx.ui.window.Manager",b="__yi";qx.Class.define(a,{extend:qx.core.Object,implement:qx.ui.window.IWindowManager,members:{__yi:null,setDesktop:function(c){this.__yi=c;this.updateStack();}
,getDesktop:function(){return this.__yi;}
,changeActiveWindow:function(d,e){if(d){this.bringToFront(d);d.setActive(true);}
;if(e){e.resetActive();}
;}
,_minZIndex:1e5,updateStack:function(){qx.ui.core.queue.Widget.add(this);}
,syncWidget:function(){this.__yi.forceUnblock();var h=this.__yi.getWindows();var g=this._minZIndex;var m=g+h.length*2;var j=g+h.length*4;var k=null;for(var i=0,l=h.length;i<l;i++ ){var f=h[i];if(!f.isVisible()){continue;}
;k=k||f;if(f.isModal()){f.setZIndex(j);this.__yi.blockContent(j-1);j+=2;k=f;}
else if(f.isAlwaysOnTop()){f.setZIndex(m);m+=2;}
else {f.setZIndex(g);g+=2;}
;if(!k.isModal()&&f.isActive()||f.getZIndex()>k.getZIndex()){k=f;}
;}
;this.__yi.setActiveWindow(k);}
,bringToFront:function(o){var n=this.__yi.getWindows();var p=qx.lang.Array.remove(n,o);if(p){n.push(o);this.updateStack();}
;}
,sendToBack:function(r){var q=this.__yi.getWindows();var s=qx.lang.Array.remove(q,r);if(s){q.unshift(r);this.updateStack();}
;}
},destruct:function(){this._disposeObjects(b);}
});}
)();
(function(){var a="pointerup",b="Boolean",c="losecapture",d="move",f="qx.ui.core.MMovable",g="__yj",h="The move handle could not be redefined!",i="pointerdown",j="maximized",k="__yk",l="pointermove",m="roll",n="move-frame";qx.Mixin.define(f,{properties:{movable:{check:b,init:true},useMoveFrame:{check:b,init:false}},members:{__yj:null,__yk:null,__yl:null,__ym:null,__yn:null,__yo:null,__yp:null,__yq:false,__yr:null,__ys:0,_activateMoveHandle:function(o){if(this.__yj){throw new Error(h);}
;this.__yj=o;o.addListener(i,this._onMovePointerDown,this);o.addListener(a,this._onMovePointerUp,this);o.addListener(l,this._onMovePointerMove,this);o.addListener(c,this.__yw,this);}
,__yt:function(){var p=this.__yk;if(!p){p=this.__yk=new qx.ui.core.Widget();p.setAppearance(n);p.exclude();qx.core.Init.getApplication().getRoot().add(p);}
;return p;}
,__yu:function(){var location=this.getContentLocation();var r=this.getBounds();var q=this.__yt();q.setUserBounds(location.left,location.top,r.width,r.height);q.show();q.setZIndex(this.getZIndex()+1);}
,__yv:function(e){var t=this.__yl;var s=Math.max(t.left,Math.min(t.right,e.getDocumentLeft()));var v=Math.max(t.top,Math.min(t.bottom,e.getDocumentTop()));var u=this.__ym+s;var w=this.__yn+v;return {viewportLeft:parseInt(u,10),viewportTop:parseInt(w,10),parentLeft:parseInt(u-this.__yo,10),parentTop:parseInt(w-this.__yp,10)};}
,_onMoveRoll:function(e){e.stop();}
,_onMovePointerDown:function(e){if(!this.getMovable()||this.hasState(j)){return;}
;this.addListener(m,this._onMoveRoll,this);var parent=this.getLayoutParent();var x=parent.getContentLocation();var z=parent.getBounds();if(qx.Class.implementsInterface(parent,qx.ui.window.IDesktop)){if(!parent.isBlocked()){this.__yr=parent.getBlockerColor();this.__ys=parent.getBlockerOpacity();parent.setBlockerColor(null);parent.setBlockerOpacity(1);parent.blockContent(this.getZIndex()-1);this.__yq=true;}
;}
;this.__yl={left:x.left,top:x.top,right:x.left+z.width,bottom:x.top+z.height};var y=this.getContentLocation();this.__yo=x.left;this.__yp=x.top;this.__ym=y.left-e.getDocumentLeft();this.__yn=y.top-e.getDocumentTop();this.addState(d);this.__yj.capture();if(this.getUseMoveFrame()){this.__yu();}
;e.stop();}
,_onMovePointerMove:function(e){if(!this.hasState(d)){return;}
;var B=this.__yv(e);if(this.getUseMoveFrame()){this.__yt().setDomPosition(B.viewportLeft,B.viewportTop);}
...
;this.removeState(d);var parent=this.getLayoutParent();if(qx.Class.implementsInterface(parent,qx.ui.window.IDesktop)){if(this.__yq){parent.unblock();parent.setBlockerColor(this.__yr);parent.setBlockerOpacity(this.__ys);this.__yr=null;this.__ys=0;this.__yq=false;}
;}
;this.__yj.releaseCapture();var D=this.__yv(e);var C=this.getLayoutParent().getInsets();this.setLayoutProperties({left:D.parentLeft-(C.left||0),top:D.parentTop-(C.top||0)});if(this.getUseMoveFrame()){this.__yt().exclude();}
;e.stopPropagation();}
,__yw:function(e){if(!this.hasState(d)){return;}
;this.removeState(d);if(this.getUseMoveFrame()){this.__yt().exclude();}
;}
},destruct:function(){this._disposeObjects(k,g);this.__yl=null;}
});}
)();
...
;this.__yx=qx.event.Registration.getManager(B).getHandler(qx.event.handler.DragDrop);}
,properties:{resizableTop:{check:a,init:true},resizableRight:{check:a,init:true},resizableBottom:{check:a,init:true},resizableLeft:{check:a,init:true},resizable:{group:[z,g,w,l],mode:n},resizeSensitivity:{check:j,init:5},useResizeFrame:{check:a,init:true}},members:{__yx:null,__yy:null,__yz:null,__yA:null,__yB:null,__yC:null,__yD:null,RESIZE_TOP:1,RESIZE_BOTTOM:2,RESIZE_LEFT:4,RESIZE_RIGHT:8,_getResizeFrame:function(){var C=this.__yy;if(!C){C=this.__yy=new qx.ui.core.Widget();C.setAppearance(v);C.exclude();qx.core.Init.getApplication().getRoot().add(C);}
;return C;}
,__yE:function(){var location=this.getContentLocation();var D=this._getResizeFrame();D.setUserBounds(location.left,location.top,location.right-location.left,location.bottom-location.top);D.show();D.setZIndex(this.getZIndex()+1);}
,__yF:function(e){var F=this.__yz;var E=this.getSizeHint();var I=this.__yD;var H=this.__yC;var J=H.width;var G=H.height;var L=H.left;var top=H.top;var K;if((F&this.RESIZE_TOP)||(F&this.RESIZE_BOTTOM)){K=Math.max(I.top,Math.min(I.bottom,e.getDocumentTop()))-this.__yB;if(F&this.RESIZE_TOP){G-=K;}
else {G+=K;}
;if(G<E.minHeight){G=E.minHeight;}
else if(G>E.maxHeight){G=E.maxHeight;}
;if(F&this.RESIZE_TOP){top+=H.height-G;}
;}
;if((F&this.RESIZE_LEFT)||(F&this.RESIZE_RIGHT)){K=Math.max(I.left,Math.min(I.right,e.getDocumentLeft()))-this.__yA;if(F&this.RESIZE_LEFT){J-=K;}
else {J+=K;}
...
,__yG:{'1':f,'2':x,'4':b,'8':k,'5':q,'6':d,'9':h,'10':i},__yH:function(e){var location=this.getContentLocation();var O=this.getResizeSensitivity();var N=e.getDocumentLeft();var P=e.getDocumentTop();var M=this.__yI(location,N,P,O);if(M>0){M=M|this.__yI(location,N,P,O*2);}
;this.__yz=M;}
,__yI:function(location,T,R,S){var Q=0;if(this.getResizableTop()&&Math.abs(location.top-R)<S&&T>location.left-S&&T<location.right+S){Q+=this.RESIZE_TOP;}
...
;return Q;}
,__yJ:function(e){if(!this.__yz||!this.getEnabled()||e.getPointerType()==c){return;}
;this.addState(p);this.__yA=e.getDocumentLeft();this.__yB=e.getDocumentTop();var location=this.getContentLocation();var V=this.getBounds();this.__yC={top:location.top,left:location.left,width:location.right-location.left,height:location.bottom-location.top,bounds:qx.lang.Object.clone(V)};var parent=this.getLayoutParent();var W=parent.getContentLocation();var U=parent.getBounds();this.__yD={left:W.left,top:W.top,right:W.left+U.width,bottom:W.top+U.height};if(this.getUseResizeFrame()){this.__yE();}
;this.capture();e.stop();}
,__yK:function(e){if(!this.hasState(p)||!this.getEnabled()||e.getPointerType()==c){return;}
;if(this.getUseResizeFrame()){this._getResizeFrame().exclude();}
;var X=this.__yF(e);this.setWidth(X.width);this.setHeight(X.height);if(this.getResizableLeft()||this.getResizableTop()){this.setLayoutProperties({left:X.parentLeft,top:X.parentTop});}
;this.__yz=0;this.removeState(p);this.resetCursor();this.getApplicationRoot().resetGlobalCursor();this.releaseCapture();e.stopPropagation();}
,__yL:function(e){if(!this.__yz){return;}
...
;}
,__yM:function(e){if(!this.getEnabled()||e.getPointerType()==c){return;}
;if(this.hasState(p)){var ba=this.__yF(e);if(this.getUseResizeFrame()){var Y=this._getResizeFrame();Y.setUserBounds(ba.viewportLeft,ba.viewportTop,ba.width,ba.height);}
...
;}
;e.stopPropagation();}
else if(!this.hasState(o)&&!this.__yx.isSessionActive()){this.__yH(e);var bd=this.__yz;var bc=this.getApplicationRoot();if(bd){var bb=this.__yG[bd];this.setCursor(bb);bc.setGlobalCursor(bb);}
else if(this.getCursor()){this.resetCursor();bc.resetGlobalCursor();}
;}
;}
,__yN:function(e){if(e.getPointerType()==c){return;}
;if(this.getCursor()&&!this.hasState(p)){this.resetCursor();this.getApplicationRoot().resetGlobalCursor();}
;}
},destruct:function(){if(this.__yy!=null&&!qx.core.ObjectRegistry.inShutDown){this.__yy.destroy();this.__yy=null;}
;this.__yx=null;}
});}
)();
...
;var br=this.getLayoutProperties();this.__yP=br.left===undefined?0:br.left;this.__yO=br.top===undefined?0:br.top;this.setLayoutProperties({left:null,top:null,edge:0});this.addState(F);this._updateCaptionBar();this.fireEvent(Q);}
;}
;}
,minimize:function(){if(!this.isVisible()){return;}
;if(this.fireNonBubblingEvent(b,qx.event.type.Event,[false,true])){var bs=this.getLayoutProperties();this.__yP=bs.left===undefined?0:bs.left;this.__yO=bs.top===undefined?0:bs.top;this.removeState(F);this.hide();this.fireEvent(v);}
;}
...
;var bt=this.__yP;var top=this.__yO;this.setLayoutProperties({edge:null,left:bt,top:top});this.removeState(F);this._updateCaptionBar();this.fireEvent(S);}
;}
...
,_checkLoading:function(){var bo=this.getSource();if(bo!=F&&bo!=null&&bo!=bf){if(!this.isLoaded()){if(!this.__Ga){this.__Ga=new Date().getTime();}
;var bp=new Date().getTime()-this.__Ga;if(this.getLoadTimeout()>bp){var bq=qx.util.TimerManager.getInstance();bq.start(this._checkLoading,0,this,null,10);this.fireEvent(x);}
else {if(qx.core.Environment.get(u)){this.debug(A+bp);}
;this.fireEvent(P);this.__Ga=null;}
;}
else {this.fireEvent(p);this.__Ga=null;}
;}
;}
...
,_applyQuality:function(bB,bA){this.__Gb(c,bB);}
,_applyScale:function(bD,bC){this.__Gb(h,bD);}
,_applyWmode:function(bF,bE){this.__Gb(m,bF);}
,_applyPlay:function(bH,bG){this.__Gb(I,bH);}
,_applyLoop:function(bJ,bI){this.__Gb(s,bJ);}
,_applyMenu:function(bL,bK){this.__Gb(v,bL);}
,_applyAllowScriptAccess:function(bN,bM){this.__Gb(t,bN);}
,_applyLiveConnect:function(bP,bO){this.__Gb(z,bP);}
,__Gb:function(bQ,bR){this.getContentElement().setParam(bQ,bR);qx.ui.core.queue.Layout.add(this);}
}});}
)();
(function(){var a="$$",b="Invalid attribute 'value'.",c="The id cannot be modified after initial creation",d="The variables cannot be modified after initial creation",e="qx.debug",f="$$widget",g="Invalid attribute 'key'.",h="movie",i="div",j="The attributes cannot be modified after initial creation",k="The source cannot be modified after initial creation",l="The params cannot be modified after initial creation",m="Invalid attribute 'value' expected String, Boolean or null.",n="id",o="qx.html.Flash";qx.Class.define(o,{extend:qx.html.Element,construct:function(p,q){qx.html.Element.call(this,i,p,q);this.__Gc={};this.__Gd={};this.__Ge={};}
,members:{__Gc:null,__Ge:null,__Gd:null,__Gf:null,_createDomElement:function(){return qx.dom.Element.create(i);}
,createFlash:function(){this.__Gf=qx.bom.Flash.create(this.getDomElement(),this.getAttributes(),this.__Gd,this.__Gc);}
,setSource:function(r){if(qx.core.Environment.get(e)){qx.core.Assert.assertString(r,b);}
;if(this.__Gf){throw new Error(k);}
;this.setAttribute(h,r);}
,setId:function(s){if(qx.core.Environment.get(e)){qx.core.Assert.assertString(s,b);}
;if(this.__Gf){throw new Error(c);}
;this.setAttribute(n,s);}
,getVariables:function(){return this.__Gd;}
,setVariables:function(t){if(qx.core.Environment.get(e)){qx.core.Assert.assertMap(t,b);}
;if(this.__Gf){throw new Error(d);}
;this.__Gd=t;}
,getAttributes:function(){return this.__Ge;}
...
else if(this.__Gf){throw new Error(j);}
;if(v===null||v===undefined){delete this.__Ge[u];}
else {this.__Ge[u]=v;}
;}
,getParams:function(){return this.__Gc;}
...
;}
;}
;if(this.__Gf){throw new Error(l);}
;if(x===null||x===undefined){delete this.__Gc[w];}
else {this.__Gc[w]=x;}
;}
,getFlashElement:function(){return this.__Gf;}
},destruct:function(){if(this.__Gf){qx.bom.Flash.destroy(this.__Gf);}
;this.__Gc=this.__Gd=this.__Ge=null;}
});}
)();
...
;}
;}
;var O=this.__Gl(P,R,Q,M);this._flashObjects[R.id]=O;return O;}
,destroy:function(T,S){if(qx.core.Environment.get(D)==v&&qx.core.Environment.get(q)<11){T=this.__Gg(T);if(T.readyState==4){this.__Gh(T);}
else {if(!S){S=window;}
;qx.bom.Event.addNativeListener(S,p,function(){qx.bom.Flash.__Gh(T);}
);}
;}
else {T=this.__Gg(T);if(T.parentNode){T.parentNode.removeChild(T);}
;delete this._flashObjects[T.id];}
;}
,__Gg:function(U){if(!U){throw new Error(z);}
;if(U.tagName.toLowerCase()!==L){U=U.firstChild;}
;if(!U||U.tagName.toLowerCase()!==L){throw new Error(A);}
;return U;}
,__Gh:qx.core.Environment.select(D,{"mshtml":qx.event.GlobalError.observeMethod(function(V){for(var i in V){if(typeof V[i]==b){V[i]=null;}
;}
;if(V.parentNode){V.parentNode.removeChild(V);}
;delete this._flashObjects[V.id];}
),"default":null}),__Gi:qx.event.GlobalError.observeMethod(function(){for(var W in qx.bom.Flash._flashObjects){qx.bom.Flash.destroy(qx.bom.Flash._flashObjects[W]);}
;window.__Gj=function(){}
;window.__Gk=function(){}
;qx.bom.Event.removeNativeListener(window,F,qx.bom.Flash.__Gi);}
),__Gl:function(bb,bd,bc,X){if(qx.core.Environment.get(D)==v&&qx.core.Environment.get(q)<11){bc.movie=bd.data;delete bd.data;delete bd.classid;var Y=u;for(var name in bc){Y+=m+name+J+bc[name]+E;}
...
},defer:function(bf){if(qx.core.Environment.get(D)==v){qx.bom.Event.addNativeListener(window,F,bf.__Gi);}
;}
});}
)();
(function(){var a="number",b="qx.util.TimerManager",c="interval",d="singleton";qx.Class.define(b,{extend:qx.core.Object,type:d,statics:{__Gm:[],__Gn:{},__oi:0},members:{__Go:false,start:function(h,g,j,e,k){if(typeof k!=a){k=g||0;}
;var f=(new Date()).getTime()+k;this.self(arguments).__Gn[ ++this.self(arguments).__oi]={callback:h,userData:e||null,expireAt:f,recurTime:g,context:j||this};this.__Gp(f,this.self(arguments).__oi);return this.self(arguments).__oi;}
,stop:function(l){var m=this.self(arguments).__Gm;var length=m.length;for(var i=0;i<length;i++ ){if(m[i]==l){m.splice(i,1);break;}
;}
;delete this.self(arguments).__Gn[l];if(m.length==0&&this.__Go){qx.event.Idle.getInstance().removeListener(c,this.__Gq,this);this.__Go=false;}
;}
,__Gp:function(n,q){var p=this.self(arguments).__Gm;var o=this.self(arguments).__Gn;var length=p.length;for(var i=0;i<length;i++ ){if(o[p[i]].expireAt>n){p.splice(i,0,q);break;}
;}
;if(p.length==length){p.push(q);}
;if(!this.__Go){qx.event.Idle.getInstance().addListener(c,this.__Gq,this);this.__Go=true;}
;}
,__Gq:function(){var s=(new Date()).getTime();var u=this.self(arguments).__Gm;var t=this.self(arguments).__Gn;while(u.length>0&&t[u[0]].expireAt<=s){var w=u.shift();var r=t[w];r.callback.call(r.context,r.userData,w);if(r.recurTime&&t[w]){var v=(new Date()).getTime();r.expireAt=v+r.recurTime;this.__Gp(r.expireAt,w);}
else {delete t[w];}
;}
;if(u.length==0&&this.__Go){qx.event.Idle.getInstance().removeListener(c,this.__Gq,this);this.__Go=false;}
;}
}});}
)();
...
,properties:{wrap:{check:b,init:true,apply:f},appearance:{refine:true,init:j},singleStep:{check:i,init:20},minimalLineHeight:{check:i,apply:h,init:4},autoSize:{check:b,apply:w,init:false}},members:{__wp:null,__wq:null,__wr:null,setValue:function(M){M=qx.ui.form.AbstractField.prototype.setValue.call(this,M);this.__ws();return M;}
...
;}
,__ws:function(){if(this.isAutoSize()){var R=this.__wt();if(R&&this.getBounds()){this.__wr=this.__wr||this._getAreaHeight();var T=this._getScrolledAreaHeight();if(this.getMaxHeight()){var P=this.getInsets();var Q=-P.top+this.getMaxHeight()-P.bottom;if(T>Q){this.getContentElement().setStyle(I,k);}
else {this.getContentElement().setStyle(I,H);}
;}
;var S=Math.max(T,this.__wr);this._setAreaHeight(S);}
else {this.getContentElement().addListenerOnce(x,function(){this.__ws();}
,this);}
;}
;}
,_getAreaHeight:function(){return this.getInnerSize().height;}
,_setAreaHeight:function(U){if(this._getAreaHeight()!==U){this.__wq=U;qx.ui.core.queue.Layout.add(this);qx.ui.core.queue.Manager.flush();this.__ww();}
;}
,_getScrolledAreaHeight:function(){var W=this.__wt();var V=W.getDomElement();if(V){if(!V.parentNode){qx.html.Element.flush();return this._getScrolledAreaHeight();}
...
;this.__wv(W);if(qx.core.Environment.get(C)==B&&qx.core.Environment.get(s)==8){if(!V.scrollTop){qx.html.Element.flush();}
;}
;return V.scrollTop;}
;}
,__wt:function(){this.__wp=this.__wp||this.__wu();return this.__wp;}
,__wu:function(){var ba,Y,bb,X;ba=this.getContentElement();if(!ba.getDomElement()){return null;}
;bb=qx.bom.Element.clone(ba.getDomElement());X=new qx.html.Input(j);X.useElement(bb);Y=X;Y.setStyles({position:K,top:0,left:o,height:0,overflow:H},true);Y.removeAttribute(G);Y.removeAttribute(z);Y.setAttribute(y,g);Y.setValue(ba.getValue()||t);Y.insertBefore(ba);this.__wv(Y);return Y;}
,__wv:function(bc){bc=bc.getDomElement();if(bc){bc.scrollTop=10000;}
;}
...
,_applyAutoSize:function(bh,bg){if(qx.core.Environment.get(m)){this.__wx();}
;if(bh){this.__ws();this.addListener(a,this.__ws,this);if(!this.getBounds()){this.addListenerOnce(x,function(){this.getContentElement().setStyle(I,H);}
);}
else {this.getContentElement().setStyle(I,H);}
;}
else {this.removeListener(a,this.__ws);this.getContentElement().setStyle(I,k);}
;}
,_applyDimension:function(bi){qx.ui.form.AbstractField.prototype._applyDimension.call(this);if(qx.core.Environment.get(m)){this.__wx();}
;if(bi===this.getMaxHeight()){this.__ws();}
;}
,__ww:function(){var content=this.getContentElement();var bk=content.getDomElement();var bj=content.getStyle(u);content.setStyle(u,parseInt(bj,10)+1000+c,true);if(bk){qx.bom.element.Dimension.getWidth(bk);}
;content.setStyle(u,bj,true);}
,__wx:function(){if(this.isAutoSize()&&this.getHeight()){this.warn(n+J+v);}
;}
,_getContentHint:function(){var bl=qx.ui.form.AbstractField.prototype._getContentHint.call(this);bl.height=bl.height*this.getMinimalLineHeight();bl.width=this._getTextSize().width*20;if(this.isAutoSize()){bl.height=this.__wq||bl.height;}
;return bl;}
},destruct:function(){this.setAutoSize(false);if(this.__wp){this.__wp.dispose();}
;}
});}
)();
