...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.data.Service.7df55b747519.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="qx.bom.request.Jsonp",b="callback",c="open",d="dispose",e="",f="qx",g="qx.debug",h="Expecting JavaScript response to call: ",i="_onNativeLoad",j=" already exists",k="Callback ",l="qx.debug.io",m=".callback",n="qx.bom.request.Jsonp.";qx.Bootstrap.define(a,{extend:qx.bom.request.Script,construct:function(){qx.bom.request.Script.apply(this);this.__vz();}
,members:{responseJson:null,__cr:null,__vs:null,__vt:null,__vu:null,__vv:null,__vw:null,__nB:null,__vx:e,open:function(t,p){if(this.__nB){return;}
;var r={},q,s,o=this;this.responseJson=null;this.__vu=false;q=this.__vs||b;s=this.__vt||this.__vx+n+this.__cr+m;if(!this.__vt){this.constructor[this.__cr]=this;}
else {if(!window[this.__vt]){this.__vv=true;window[this.__vt]=function(u){o.callback(u);}
;}
else {if(qx.core.Environment.get(l)){qx.Bootstrap.debug(qx.bom.request.Jsonp,k+this.__vt+j);}
;}
;}
;if(qx.core.Environment.get(l)){qx.Bootstrap.debug(qx.bom.request.Jsonp,h+s);}
;r[q]=s;this.__vw=p=qx.util.Uri.appendParamsToUrl(p,r);this.__hu(c,[t,p]);}
,callback:function(v){if(this.__nB){return;}
;this.__vu=true;if(qx.core.Environment.get(g)){v=qx.lang.Json.stringify(v);v=qx.lang.Json.parse(v);}
;this.responseJson=v;this.constructor[this.__cr]=undefined;this.__vy();}
,setCallbackParam:function(w){this.__vs=w;return this;}
,setCallbackName:function(name){this.__vt=name;return this;}
,setPrefix:function(x){this.__vx=x;}
,getGeneratedUrl:function(){return this.__vw;}
,dispose:function(){this.__vy();this.__hu(d);}
,_onNativeLoad:function(){this.status=this.__vu?200:500;this.__hu(i);}
,__vy:function(){if(this.__vv&&window[this.__vt]){window[this.__vt]=undefined;this.__vv=false;}
;}
,__hu:function(z,y){qx.bom.request.Script.prototype[z].apply(this,y||[]);}
,__vz:function(){this.__cr=f+(new Date().valueOf())+(e+Math.random()).substring(2,5);}
}});}
)();
