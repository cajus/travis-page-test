...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.bom.Window.f90c832318a2.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="Open Native Window",b="Open Native Modal Window",c="demobrowser.demo.bom.Window",d="Modal Window closed?",f="http://sourceforge.net",g="window1",h="window3",i="http://slashdot.org",j="Window closed?",k="http://qooxdoo.org",l="demobrowser/demo/html/ModalWindow.html",m="#eee",n="Open Faked Native Modal Window",o="window2",p="tap",q="button";qx.Class.define(c,{extend:qx.application.Native,members:{__Ac:null,main:function(){qx.application.Native.prototype.main.call(this);var r=qx.util.ResourceManager.getInstance();this.__Ac=[k,f,i,r.toUri(l)];var u=qx.bom.Input.create(q);qx.bom.Input.setValue(u,a);document.body.appendChild(u);qx.event.Registration.addListener(u,p,function(e){var x={width:400,height:200,top:200,left:100,scrollbars:false,menubar:true,status:false};this.window1=qx.bom.Window.open(this.__Ac[0],g,x);}
...
,this);var s=qx.bom.Input.create(q);qx.bom.Input.setValue(s,b);document.body.appendChild(s);qx.event.Registration.addListener(s,p,function(e){var y={width:400,height:200,top:200,left:100,scrollbars:false};this.window2=qx.bom.Window.open(this.__Ac[3],o,y,true);}
...
,this);var v=qx.bom.Input.create(q);qx.bom.Input.setValue(v,n);document.body.appendChild(v);qx.event.Registration.addListener(v,p,function(e){var A={width:800,height:600,top:200,left:100,scrollbars:false};var z=qx.bom.Window.getBlocker();z.setBlockerColor(m);z.setBlockerOpacity(0.5);this.window3=qx.bom.Window.open(this.__Ac[0],h,A,true,false);}
,this);}
...
(function(){var a="no",b="px",c="qx.bom.Window",d="Cross-Domain Scripting problem: Could not resize window!",e="' is not supported for native windows.",f="interval",g="dialogWidth",h="resizable",i=":",j="yes",k="dialogTop",l="qxNativeWindow",m="Cross-Domain Scripting problem: Could not move window!",n="",o="Option '",p="javascript:/",q="dialogLeft",r="dialogHeight",s="' is not supported for modal windows.",t='load',u="scrollbars",v="=",w=";",x="scroll",y=",";qx.Class.define(c,{statics:{__mf:null,__LO:null,__du:null,__LP:{"top":k,left:q,width:g,height:r,scrollbars:x,resizable:h},__LQ:{"top":1,left:1,width:1,height:1,dependent:1,resizable:1,status:1,location:1,menubar:1,scrollbars:1,toolbar:1},__LR:function(){return window.showModalDialog!=null;}
,open:function(z,name,H,E,A,D,self){var C=null;if(z==null){z=p;}
;if(name==null){name=l+new Date().getTime();}
;if(A==null){A=true;}
;var G=this.__LS(H,E&&A);if(E){if(this.__LR()&&A){C=window.showModalDialog(z,[window.self],G);}
else {this.getBlocker().block();if(this.__du==null){this.__du=new qx.event.Timer(500);this.__du.addListener(f,this.__LT,this);}
;this.__LO=window.open(z,name,G);this.__du.restart();C=this.__LO;}
;}
...
;return C;}
,__LS:function(K,O){var M;var J;var N=[];if(O&&this.__LR()){for(var L in K){if(qx.bom.Window.__LP[L]){var I=n;if(L!=u&&L!=h){I=b;}
;J=qx.bom.Window.__LP[L]+i+K[L]+I;N.push(J);}
else {qx.log.Logger.warn(o+L+s);}
;}
;M=N.join(w);}
else {for(var L in K){if(qx.bom.Window.__LQ[L]){if(qx.lang.Type.isBoolean(K[L])){J=L+v+(K[L]?j:a);}
else {J=L+v+K[L];}
;N.push(J);}
...
;M=N.join(y);}
;return M;}
,__LT:function(){if(this.isClosed(this.__LO)){this.getBlocker().unblock();this.__du.stop();}
;}
...
,members:{__LU:null,__ti:null,__LV:null,__LW:false,__LX:10000,__LY:0,__Ma:f,block:function(r){if(!this.__LW){this.__LV=r;var q=this.__Md();this.__Me(q);this.__LW=true;}
;}
,unblock:function(){if(this.__LW){this.__Mf();this.__LW=false;}
;}
,isBlocked:function(){return this.__LW;}
...
,__eF:function(){this.__Mb();if((qx.core.Environment.get(j)==b)){this.__Mc();}
;qx.event.Registration.addListener(window,a,this.__mR,this);}
,__Mb:function(){this.__ti=qx.dom.Element.create(m);qx.bom.element.Style.setStyles(this.__ti,{display:d,opacity:this.__LY,backgroundColor:this.__Ma});this.setBlockerZIndex(this.__LX);}
,__Mc:function(){this.__LU=qx.bom.Iframe.create();qx.bom.element.Attribute.set(this.__LU,l,false);qx.bom.element.Attribute.set(this.__LU,i,n);qx.bom.element.Style.setStyles(this.__LU,{display:d,opacity:this.__LY});}
,__Md:function(){var v={position:p};if(this.__Mh()){v.left=k;v.top=k;v.right=null;v.bottom=null;v.width=qx.bom.Document.getWidth()+g;v.height=qx.bom.Document.getHeight()+g;}
else {v.width=qx.bom.element.Dimension.getWidth(this.__LV)+g;v.height=qx.bom.element.Dimension.getHeight(this.__LV)+g;v.left=qx.bom.element.Location.getLeft(this.__LV)+g;v.top=qx.bom.element.Location.getTop(this.__LV)+g;}
;return v;}
,__Me:function(w){var x=document.body;qx.bom.element.Style.setStyles(this.__ti,w);qx.dom.Element.insertEnd(this.__ti,x);if((qx.core.Environment.get(j)==b)){w.zIndex=this.getBlockerZIndex()-1;qx.bom.element.Style.setStyles(this.__LU,w);qx.dom.Element.insertEnd(this.__LU,document.body);}
;}
,__Mf:function(){qx.dom.Element.remove(this.__ti);if((qx.core.Environment.get(j)==b)){qx.dom.Element.remove(this.__LU);}
;}
,__mR:function(e){if(this.__Mh()){this.__Mg({width:k,height:k});qx.event.Timer.once(function(){var y={width:qx.bom.Document.getWidth()+g,height:qx.bom.Document.getHeight()+g};this.__Mg(y);}
,this,0);}
;}
,__Mg:function(z){qx.bom.element.Style.setStyles(this.__ti,z);if((qx.core.Environment.get(j)==b)){qx.bom.element.Style.setStyles(this.__LU,z);}
;}
,__Mh:function(){return (this.__LV==null||qx.dom.Node.isWindow(this.__LV)||qx.dom.Node.isDocument(this.__LV));}
},destruct:function(){qx.event.Registration.removeListener(window,a,this.__mR,this);this.__LU=this.__ti=this.__LV=null;}
});}
)();
