...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.mobile.PingPong.5eb14fb6056a.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
;this.__NI=this.__NM(L);U.add(this.__NI);var Q=this.__NM(A);U.add(Q);this.__Nz=this.__NN(L);this.__NI.add(this.__Nz);this.__NI.addListener(M,qx.lang.Function.bind(this.__Av,this),this);this.__Ny=this.__NN(A);Q.add(this.__Ny);Q.addListener(M,qx.lang.Function.bind(this.__Av,this),this);this.__NA=this.__NO();U.add(this.__NA);this.__NG=this.__NP();this.__NI.add(this.__NG);this.__NH=this.__NP();Q.add(this.__NH);this.__NF=[0,0];this.__NJ();}
,__NJ:function(){this.__NA.setStyles({"left":k,"top":k});this.__NB=new qx.event.Timer(40);this.__NB.addListener(n,function(){var x=(parseInt(this.__NA.getStyle(L))+this.__NC*this.__ND);var y=(parseInt(this.__NA.getStyle(z))+this.__NC*this.__NE);this.__NA.setStyle(L,x+c);this.__NA.setStyle(z,y+c);this.__NL();}
,this);this.__NB.start();}
,__NK:function(V){this.__NB.stop();this.__NB.dispose();this.__NC=5;this.__NF[V]=this.__NF[V]+1;this.__NG.setAttribute(w,this.__NF[0]);this.__NH.setAttribute(w,this.__NF[1]);this.__NJ();}
,__NL:function(){var X=this.getBoundsFor(this.__NA);if(X.top<=0){this.__NE=1;}
;if(X.bottom>=window.innerHeight-5){this.__NE=-1;}
;if(X.left<=0||X.right>=window.innerWidth){this.__NK(X.left<=0?1:0);}
;var Y=this.getBoundsFor(this.__Nz);if(X.left<=Y.right&&X.bottom>=Y.top&&X.top<=Y.bottom){this.__ND=1;this.__NC=Math.min(this.__NC+1,20);}
;var W=this.getBoundsFor(this.__Ny);if(X.right>=W.left&&X.bottom>=W.top&&X.top<=W.bottom){this.__ND=-1;this.__NC=Math.min(this.__NC+1,20);}
;}
,__Av:function(e){var ba;if(qx.dom.Hierarchy.contains(this.__NI.getDomElement(),e.getTarget())){ba=this.__Nz;}
else {ba=this.__Ny;}
...
,__NM:function(bd){var bc={"width":C,"height":h,"position":N,"backgroundColor":a};if(bd==L){bc[J]=u;}
else {bc[L]=C;bc[d]=u;}
;return new qx.html.Element(g,bc);}
,__NN:function(bf){var be={"width":l,"height":t,"top":t,"position":N,"backgroundColor":K};be[bf]=F;return new qx.html.Element(g,be);}
,__NO:function(){var bg={"width":F,"height":F,"position":N,"backgroundColor":K,"userSelect":I};return new qx.html.Element(g,bg);}
,__NP:function(){var bh={"width":h,"height":h,"textAlign":r,"fontSize":H,"color":b,"fontFamily":B};var bi=new qx.html.Element(g,bh);bi.setAttribute(w,j);return bi;}
}});}
)();
