...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.ui.FormRendererDouble.80616773459f.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
,add:function(w,v){this.__xa.add(w);this._add(w,v);}
,remove:function(x){this.__xa.remove(x);this._remove(x);}
,removeAll:function(){var y=this.__xa.getItems();for(var i=y.length-1;i>=0;i-- ){this.__xa.remove(y[i]);}
;return this._removeAll();}
,getSelection:function(){return this.__xa.getSelection();}
,setSelection:function(z){this.__xa.setSelection(z);}
,resetSelection:function(){this.__xa.resetSelection();}
,isSelected:function(A){return this.__xa.isSelected(A);}
