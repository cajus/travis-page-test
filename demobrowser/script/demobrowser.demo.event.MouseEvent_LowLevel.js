...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.event.MouseEvent_LowLevel.ac3b8312a607.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
;}
,_initLogger:function(p,n,o){this.__Nq=f+p.join(c)+a;this.__Nr=o||50;this.__Ns=n;this._clearLog();}
,_clearLog:function(){this.__Ns.innerHTML=this.__Nq+k;this.__Nt=[];}
,_log:function(q){this.__Nt.unshift(q);this.__Nt=this.__Nt.slice(0,this.__Nr);var r=[this.__Nq];for(var i=0;i<this.__Nt.length;i++ ){r.push(g,this.__Nt[i].join(e),l);}
;r.push(k);this.__Ns.innerHTML=r.join(d);this.__Ns.scrollTop=0;}
,__Nq:null,__Nr:null,__Ns:null,__Nt:null},destruct:function(){this.__Ns=this.__Nt=null;}
});}
)();
...
(function(){var a="demobrowser.demo.event.MouseEvent_LowLevel",b="mouseout",c="mousedown",d="clientX",f="dblclick",g="relatedTarget",h="mouse",j="button",k="mousemove",l="screenX",m="logger",n="",o="_",p="mouseover",q="check_",r="click",s="Event",t="Target",u="clientY",v="mouseup",w="contextmenu",x="change",y="screenY";qx.Class.define(a,{extend:demobrowser.demo.event.EventDemo,members:{__Nv:null,main:function(){demobrowser.demo.event.EventDemo.prototype.main.call(this);this.__Nv=qx.lang.Function.bind(this.logMouseEvent,this);this._initLogger([t,s,j,d,u,l,y,g],document.getElementById(m),50);var z=document.getElementById(h);var B=[c,v,r,f,w,k,p,b];for(var i=0;i<B.length;i++ ){var A=document.getElementById(q+B[i]);if(A.checked){qx.bom.Event.addNativeListener(z,B[i],this.__Nv);}
;qx.bom.Event.addNativeListener(A,x,qx.lang.Function.bind(this.__Nu,this));}
;}
,__Nu:function(e){var E=qx.bom.Event.getTarget(e);var F=E.id.split(o)[1];var C=E.checked;var D=document.getElementById(h);if(C){qx.bom.Event.addNativeListener(D,F,this.__Nv);}
else {qx.bom.Event.removeNativeListener(D,F,this.__Nv);}
;}
