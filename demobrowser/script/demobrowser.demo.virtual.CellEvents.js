...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.virtual.CellEvents.4a9dcfb37317.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
,_onCellTap:function(e){var q=f+e.getRow()+i+e.getColumn()+h;this.__Oh(q);}
,_onContextMenu:function(e){var r=d+e.getRow()+i+e.getColumn()+h;this.__Oh(r);}
,_onDbltapPane:function(e){var s=g+e.getRow()+i+e.getColumn()+h;this.__Oh(s);}
,__Oh:function(t){this.logger.setHtml(this.logger.getHtml()+t);}
