...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.virtual.List.616db335148b.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
;var dc=qx.data.marshal.Json.createModel(cV);var cQ=this.__Oo=new qx.ui.list.List(dc).set({scrollbarX:ci,selectionMode:cx,height:280,width:150,labelPath:cH,iconPath:H,iconOptions:{converter:function(de){return bS+de+cm;}
...
;}
;var cU=new qx.ui.form.RadioButton(cg);var cL=new qx.ui.form.RadioButton(D);var cW=new qx.ui.form.RadioButton(W);var db=new qx.ui.form.RadioButton(cC);cU.setUserData(ct,cz);cL.setUserData(ct,cx);cW.setUserData(ct,t);db.setUserData(ct,c);cM.add(cU,{left:160,top:20});cM.add(cL,{left:160,top:40});cM.add(cW,{left:160,top:60});cM.add(db,{left:160,top:80});var cR=new qx.ui.form.RadioButton(P);var dd=new qx.ui.form.RadioButton(b);var cK=new qx.ui.form.RadioButton(I);cR.setUserData(ct,cH);dd.setUserData(ct,H);cK.setUserData(ct,co);cM.add(cR,{left:160,top:120});cM.add(dd,{left:160,top:140});cM.add(cK,{left:160,top:160});var cS=this.__Op=new qx.ui.form.CheckBox(G);var cY=this.__Oq=new qx.ui.form.CheckBox(Q).set({enabled:false});cM.add(cS,{left:160,top:200});cM.add(cY,{left:160,top:220});var da=new qx.ui.form.RadioGroup(cU,cL,cW,db);da.setSelection([cL]);da.addListener(m,this.onSelectionModeChange,this);var cO=new qx.ui.form.RadioGroup(cR,dd,cK);cO.setSelection([cK]);cO.addListener(m,this.onShowModeChange,this);cS.addListener(g,this.onDragCheckChange,this);cY.addListener(g,this.onQuickCheckChange,this);return cM;}
...
,onSelectionModeChange:function(e){var dy=e.getData()[0].getUserData(ct);this.__Oo.setSelectionMode(dy);if(dy==cz||dy==c){this.__Op.setEnabled(false);this.__Oq.setEnabled(true);}
else if(dy==cx||dy==bV){this.__Op.setEnabled(true);this.__Oq.setEnabled(false);}
;}
,onShowModeChange:function(e){var dz=e.getData()[0].getUserData(ct);this.setShowMode(dz);}
,onDragCheckChange:function(e){if(e.getData()){var dA=this.__Oo.getSelectionMode();if(dA==cz||dA==c){this.debug(M);}
;}
;this.__Oo.setDragSelection(e.getData());}
,onQuickCheckChange:function(e){if(e.getData()){var dB=this.__Oo.getSelectionMode();if(dB==cx||dB==t){this.debug(A);}
;}
;this.__Oo.setQuickSelection(e.getData());}
}});}
)();
