...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.data.TreeController.a1ea114875e5.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="open",b="abstract",c="__hd",d="qx.debug",e="'. It is not a child of this tree item.",f="__vP",g="addItem",h="visible",j="excluded",k="removeItem",m="Invalid child index: ",n="Cannot remove treeitem '",o="qx.ui.tree.core.AbstractTreeItem";qx.Class.define(o,{extend:qx.ui.tree.core.AbstractItem,type:b,construct:function(p){qx.ui.tree.core.AbstractItem.call(this,p);this.__hd=[];}
,properties:{parent:{check:o,nullable:true}},members:{__hd:null,__vP:null,getTree:function(){var r=this;while(r.getParent()){r=r.getParent();}
...
;}
;}
,getChildrenContainer:function(){if(!this.__vP){this.__vP=new qx.ui.container.Composite(new qx.ui.layout.VBox()).set({visibility:this.isOpen()?h:j});}
;return this.__vP;}
,hasChildrenContainer:function(){return this.__vP;}
...
;}
,__vQ:function(){if(this.getParentChildrenContainer()){this.getParentChildrenContainer()._addAfter(this.getChildrenContainer(),this);}
;}
...
;this.__hd.push(Q);if(!N){this.__vQ();}
...
;qx.lang.Array.insertAt(this.__hd,X,T);if(!V){this.__vQ();}
...
(function(){var a="Enter",b="_applyOpenMode",c="excluded",d="Space",f="Left",g="Boolean",h="changeOpenMode",j="_applyRootOpenClose",k="visible",l="changeSelection",m="qx.ui.tree.Tree",n="qx.event.type.Data",o="qx.ui.tree.core.AbstractTreeItem",p="tree",q="dbltap",r="_applyHideRoot",s="changeRoot",t="__vR",u="_applyRoot",v="keypress",w="none",x="pane",y="tap",z="Right";qx.Class.define(m,{extend:qx.ui.core.scroll.AbstractScrollArea,implement:[qx.ui.core.IMultiSelection,qx.ui.form.IModelSelection,qx.ui.form.IForm],include:[qx.ui.core.MMultiSelectionHandling,qx.ui.core.MContentPadding,qx.ui.form.MModelSelection,qx.ui.form.MForm],construct:function(){qx.ui.core.scroll.AbstractScrollArea.call(this);this.__vR=new qx.ui.container.Composite(new qx.ui.layout.VBox()).set({allowShrinkY:false,allowGrowX:true});this.getChildControl(x).add(this.__vR);this.initOpenMode();this.initRootOpenClose();this.addListener(l,this._onChangeSelection,this);this.addListener(v,this._onKeyPress,this);}
,events:{addItem:n,removeItem:n},properties:{openMode:{check:[y,q,w],init:q,apply:b,event:h,themeable:true},root:{check:o,init:null,nullable:true,event:s,apply:u},hideRoot:{check:g,init:false,apply:r},rootOpenClose:{check:g,init:false,apply:j},appearance:{refine:true,init:p},focusable:{refine:true,init:true}},members:{__vR:null,SELECTION_MANAGER:qx.ui.tree.selection.SelectionManager,getChildrenContainer:function(){return this.__vR;}
...
,_getContentPaddingTarget:function(){return this.__vR;}
...
(function(){var a="changeModel",b="_applyDelegate",c="qx.core.Object",d="_applyLabelPath",f="icon",g="change",h="label",k="' twice.",l="_applyTarget",m="changeTarget",n="_applyIconPath",o="Can not reverse bind the same target property '",p="_applyLabelOptions",q="_applyChildPath",r="_applyIconOptions",s="qx.data.controller.Tree",t="String",u="Can not bind the same target property '",v="_applyModel",w="get";qx.Class.define(s,{extend:qx.core.Object,include:qx.data.controller.MSelection,implement:qx.data.controller.ISelection,construct:function(y,z,A,x){qx.core.Object.call(this);this.__bd={};this.__zg=[];this.__LE={};if(A!=null){this.setChildPath(A);}
;if(x!=null){this.setLabelPath(x);}
;if(y!=null){this.setModel(y);}
;if(z!=null){this.setTarget(z);}
;}
,properties:{model:{check:c,apply:v,event:a,nullable:true,dereference:true},target:{apply:l,event:m,init:null,nullable:true,dereference:true},childPath:{check:t,apply:q,nullable:true},labelPath:{check:t,apply:d,nullable:true},iconPath:{check:t,apply:n,nullable:true},labelOptions:{apply:p,nullable:true},iconOptions:{apply:r,nullable:true},delegate:{apply:b,init:null,nullable:true}},members:{__LE:null,__bd:null,__zg:null,__LF:null,_applyDelegate:function(C,B){this._setConfigureItem(C,B);this._setCreateItem(C,B);this._setBindItem(C,B);}
,_applyIconOptions:function(E,D){this.__zs();}
,_applyLabelOptions:function(G,F){this.__zs();}
,_applyTarget:function(I,H){if(H!=undefined){this.__FH(H);}
;if(this.getModel()!=null){this.__LI();}
;this._addChangeTargetListener(I,H);}
,_applyModel:function(K,J){this.__LI();}
,_applyChildPath:function(M,L){this.__LF=L;this.__LI();this.__LF=null;}
,_applyIconPath:function(O,N){this.__zs();}
,_applyLabelPath:function(Q,P){this.__LI();}
,__LG:function(R){var T=R.getTarget();var S=this.__LE[T.toHashCode()].treeNode;var U=this.__LE[T.toHashCode()].modelNode;this.__LJ(S,U);this._updateSelection();}
,__LH:function(e){var X=e.getData();var bc=e.getOldData();var V=this.__LE[bc.toHashCode()];bc.removeListenerById(V.changeListenerId);delete this.__LE[bc.toHashCode()];V.modelNode.removeListenerById(V.changeChildernListenerId);var bd=V.modelNode;var bb=qx.Class.getPropertyDefinition(V.modelNode.constructor,this.getChildPath());var Y=bb.event;var ba=bd.addListener(Y,this.__LH,this);var W=V.treeNode;this.__LE[X.toHashCode()]={modelNode:bd,treeNode:W,changeListenerId:V.changeListenerId,changeChildernListenerId:ba};this.__LJ(W,bd);this._updateSelection();}
...
;return be;}
,__LI:function(){if(this.getTarget()==null||this.getChildPath()==null){return;}
...
;this.__FH();if(this.getModel()!=null){var bg=this._createItem();bg.setModel(this.getModel());this.__sA(this.getModel(),bg);this.__LJ(bg,this.getModel());this.getTarget().setRoot(bg);}
;}
,__LJ:function(bn,br){if(br[w+qx.lang.String.firstUp(this.getChildPath())]==undefined){return;}
;var bj=br[w+qx.lang.String.firstUp(this.getChildPath())]();if(this.__LE[bj.toHashCode()]==undefined){var bl=bj.addListener(g,this.__LG,this);var bp=qx.Class.getPropertyDefinition(br.constructor,this.getChildPath());var bm=bp.event;var bq=br.addListener(bm,this.__LH,this);this.__LE[bj.toHashCode()]={modelNode:br,treeNode:bn,changeListenerId:bl,changeChildernListenerId:bq};}
...
;}
else {var bo=this._createItem();bo.setModel(bj.getItem(i));bn.addAt(bo,i);this.__sA(bj.getItem(i),bo);this.__LJ(bo,bj.getItem(i));}
;}
;}
;for(var i=bn.getChildren().length-1;i>=bj.length;i-- ){var bk=bn.getChildren()[i];this.__LL(bk,bn);}
;}
,__FH:function(bt){if(bt==null){bt=this.getTarget();}
;if(bt==null){return;}
;var bv=bt.getRoot();if(bv!=null){bt.setRoot(null);this.__LK(bv);var bu=bv.getModel();if(bu){this.__LM(bu);}
;bv.destroy();this.__LE={};}
;}
,__LK:function(bw){var bx=bw.getChildren()||[];for(var i=bx.length-1;i>=0;i-- ){if(bx[i].getChildren().length>0){this.__LK(bx[i]);}
;this.__LL(bx[i],bw);}
;}
,__LL:function(bz,bC){var bD=bz.getModel();var by=this.__LF||this.getChildPath();var bA=w+qx.lang.String.firstUp(by);if(bD[bA]!=undefined){var bE=bD[bA]();var bB=this.__LE[bE.toHashCode()];bE.removeListenerById(bB.changeListenerId);bD.removeListenerById(bB.changeChildernListenerId);this.__LK(bz);delete this.__LE[bE.toHashCode()];}
;this.__LM(bD);bC.remove(bz);bz.destroy();}
...
;if(!qx.lang.Array.contains(this.__zg,bJ)){this.__zg.push(bJ);}
;}
...
;if(!qx.lang.Array.contains(this.__zg,bM)){this.__zg.push(bM);}
;}
...
;}
,__zs:function(){var bW;for(var ca in this.__bd){bW=ca;break;}
;for(var bX in this.__bd[bW]){var bV=this.__bd[bW][bX].treeNode;var bY=qx.core.ObjectRegistry.fromHashCode(bX);this.__LM(bY);this.__sA(bY,bV);}
;}
...
;}
,__LM:function(cg){for(var i=0;i<this.__zg.length;i++ ){var ce=this.__zg[i];var cf=this.__bd[ce][cg.toHashCode()];if(cf!=null){if(cf.id){cg.removeBinding(cf.id);cf.id=null;}
...
;this._startSelectionModification();this.__FH();this.__LI();this._endSelectionModification();this._updateSelection();}
,_setBindItem:function(cn,cm){if(cn!=null&&cn.bindItem!=null){if(cm!=null&&cm.bindItem!=null&&cn.bindItem==cm.bindItem){return;}
;this.__LI();}
;}
},destruct:function(){this.setTarget(null);this.setModel(null);this.__bd=this.__LE=this.__zg=null;}
});}
)();
...
(function(){var a="changeNames",b="changeName",c="Validation Error: ",d="- ",e="",f="changeChild",g="qx.data.Array",h="changeColor",j="Marge",k="AFFE",l="is no number (parseFloat says so!).",m="\n",n="Homer",o="__Nh",p="demobrowser.demo.data.model.Node",q="String",r="changeName2",s="changeChildren";qx.Class.define(p,{extend:qx.core.Object,construct:function(){qx.core.Object.call(this);this.setChildren(new qx.data.Array());}
,properties:{children:{check:g,event:s},child:{check:p,event:f,nullable:true},names:{check:g,event:a,init:new qx.data.Array(n,j)},name:{check:q,init:k,event:b},name2:{check:q,event:r},number:{init:10,validate:o},color:{event:h,nullable:true}},members:{__Nh:function(t){if(!isNaN(parseFloat(t))){if(/^\d+$/.test(t)){return;}
;}
