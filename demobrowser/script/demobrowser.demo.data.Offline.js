...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.data.Offline.57dcc6abb31c.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
;this._storeModel=qx.util.Function.debounce(this.__Er.bind(this),qx.data.store.Offline.STORE_MODEL_DELAY);this._marshaler=new qx.data.marshal.Json(i);this._key=j;this._initializeModel();}
,properties:{model:{nullable:true,event:d,apply:g}},statics:{STORE_MODEL_DELAY:400},members:{_storage:null,__Eq:null,__Er:function(){var k=qx.util.Serializer.toNativeObject(this.getModel());this._storage.setItem(this._key,k);}
,_applyModel:function(m,l){if(l){l.removeListenerById(this.__Eq);l.dispose();this.__Eq=null;}
;if(m){this.__Eq=m.addListener(f,this._storeModel,this);this._storeModel();}
...
(function(){var a="html.storage.local",b="html.storage.userdata",c="qx.bom.Storage";qx.Bootstrap.define(c,{statics:{__Es:null,getLocal:function(){if(qx.core.Environment.get(a)){return qx.bom.storage.Web.getLocal();}
...
(function(){var a="local",b="session",c="Storage",d="qx.bom.storage.Web",f="Storage full.";qx.Bootstrap.define(d,{statics:{__Et:null,__Eu:null,getLocal:function(){if(this.__Et){return this.__Et;}
;return this.__Et=new qx.bom.storage.Web(a);}
,getSession:function(){if(this.__Eu){return this.__Eu;}
;return this.__Eu=new qx.bom.storage.Web(b);}
...
(function(){var a="session",b="head",c="none",d="qx",e="qx.bom.storage.UserData",f="div",g="local",h="qxtest",j="#default#userdata",k="display";qx.Bootstrap.define(e,{statics:{__Et:null,__Eu:null,__cr:0,getLocal:function(){if(this.__Et){return this.__Et;}
;return this.__Et=new qx.bom.storage.UserData(g);}
,getSession:function(){if(this.__Eu){return this.__Eu;}
;return this.__Eu=new qx.bom.storage.UserData(a);}
},construct:function(m){this.__Ev=document.createElement(f);this.__Ev.style[k]=c;document.getElementsByTagName(b)[0].appendChild(this.__Ev);this.__Ev.addBehavior(j);this.__Ew=m;this.__Ev.load(this.__Ew);this.__fQ={};this.__Ex={};var l=this.__Ev.getAttribute(d+qx.bom.storage.UserData.__cr);while(l!=undefined){l=qx.lang.Json.parse(l);this.__fQ[l.key]=l.value;this.__Ex[l.key]=d+qx.bom.storage.UserData.__cr;qx.bom.storage.UserData.__cr++ ;l=this.__Ev.getAttribute(d+qx.bom.storage.UserData.__cr);}
;}
,members:{__Ev:null,__Ew:h,__fQ:null,__Ex:null,getStorage:function(){return this.__fQ;}
,getLength:function(){return Object.keys(this.__fQ).length;}
,setItem:function(n,p){if(this.__Ex[n]){var o=this.__Ex[n];}
else {var o=d+qx.bom.storage.UserData.__cr;qx.bom.storage.UserData.__cr++ ;}
;var q=qx.lang.Json.stringify({key:n,value:p});this.__Ev.setAttribute(o,q);this.__Ev.save(this.__Ew);this.__fQ[n]=p;this.__Ex[n]=o;}
,getItem:function(r){return this.__fQ[r]||null;}
,removeItem:function(v){var u=this.__Ex[v];if(u==undefined){return;}
;this.__Ev.removeAttribute(u);qx.bom.storage.UserData.__cr-- ;delete this.__fQ[v];delete this.__Ex[v];var t=d+qx.bom.storage.UserData.__cr;if(this.__Ev.getAttribute(t)){var w=this.__Ev.getAttribute(d+qx.bom.storage.UserData.__cr);this.__Ev.removeAttribute(t);this.__Ev.setAttribute(u,w);var s=qx.lang.Json.parse(w).key;this.__Ex[s]=u;}
;this.__Ev.save(this.__Ew);}
,clear:function(){for(var x in this.__Ex){this.__Ev.removeAttribute(this.__Ex[x]);}
;this.__Ev.save(this.__Ew);this.__fQ={};this.__Ex={};}
...
(function(){var a="qx.bom.storage.Memory";qx.Bootstrap.define(a,{statics:{__Et:null,__Eu:null,getLocal:function(){if(this.__Et){return this.__Et;}
;return this.__Et=new qx.bom.storage.Memory();}
,getSession:function(){if(this.__Eu){return this.__Eu;}
;return this.__Eu=new qx.bom.storage.Memory();}
