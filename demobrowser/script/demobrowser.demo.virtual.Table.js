...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.virtual.Table.1f01efd7be0f.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a=" / ",b="horizontal",c="demobrowser.demo.virtual.Table",d="__Oi",e="white",f="#EEE",g="vertical";qx.Class.define(c,{extend:qx.application.Standalone,members:{__Oi:null,main:function(){qx.application.Standalone.prototype.main.call(this);var h=new qx.ui.virtual.core.Scroller(10000,10000,20,100);for(var i=0;i<10000;i++ ){h.getPane().getRowConfig().setItemSize(i,20+Math.round(Math.random()*40));h.getPane().getColumnConfig().setItemSize(i,50+Math.round(Math.random()*80));}
;this.getRoot().add(h,{edge:20});h.getPane().addLayer(new qx.ui.virtual.layer.Row(e,f));h.getPane().addLayer(new qx.ui.virtual.layer.GridLines(b));h.getPane().addLayer(new qx.ui.virtual.layer.GridLines(g));h.getPane().addLayer(new qx.ui.virtual.layer.HtmlCell(this));this.__Oi=new qx.ui.virtual.cell.Cell();}
,getCellProperties:function(k,j){return this.__Oi.getCellProperties(k+a+j);}
...
;this.__xy={};this.__xz={};}
,properties:{colorEven:{nullable:true,check:c,apply:b,themeable:true},colorOdd:{nullable:true,check:c,apply:a,themeable:true}},members:{__xA:null,__xB:null,__xy:null,__xz:null,setColor:function(h,g){if(g){this.__xy[h]=qx.theme.manager.Color.getInstance().resolve(g);}
else {delete (this.__xy[h]);}
;}
,clearCustomColors:function(){this.__xy={};this.updateLayerData();}
,getColor:function(i){var j=this.__xy[i];if(j){return j;}
else {return i%2==0?this.__xA:this.__xB;}
;}
,_applyColorEven:function(l,k){if(l){this.__xA=qx.theme.manager.Color.getInstance().resolve(l);}
else {this.__xA=null;}
;this.updateLayerData();}
,_applyColorOdd:function(n,m){if(n){this.__xB=qx.theme.manager.Color.getInstance().resolve(n);}
else {this.__xB=null;}
;this.updateLayerData();}
,setBackground:function(o,p){if(p){this.__xz[o]=qx.theme.manager.Decoration.getInstance().resolve(p);}
else {delete (this.__xz[o]);}
;this.updateLayerData();}
,getBackground:function(q){return this.__xz[q];}
...
;}
,setColor:function(J,I){qx.ui.virtual.layer.AbstractBackground.prototype.setColor.call(this,J,I);if(this.__xC(J)){this.updateLayerData();}
;}
,setBackground:function(K,L){qx.ui.virtual.layer.AbstractBackground.prototype.setBackground.call(this,K,L);if(this.__xC(K)){this.updateLayerData();}
;}
,__xC:function(M){var O=this.getFirstRow();var N=O+this.getRowSizes().length-1;return M>=O&&M<=N;}
}});}
)();
