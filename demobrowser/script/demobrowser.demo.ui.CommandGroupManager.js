...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.ui.CommandGroupManager.28cc34af3643.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
,members:{__vX:null,__KN:null,add:function(j){if(qx.core.Environment.get(c)){this.assertInstance(j,qx.ui.command.Group,f);}
...
;}
;if(this.getActive()===m){this.__KN=null;}
...
;return false;}
;for(var i=0;i<this.__vX.length;i++ ){var n=this.__vX[i];if(n==o){n.setActive(true);this.__KN=n;continue;}
;n.setActive(false);}
;return true;}
,getActive:function(){return this.__KN;}
,block:function(){if(this.__KN){this.__KN.setActive(false);}
;}
,unblock:function(){if(this.__KN){this.__KN.setActive(true);}
;}
,_getGroup:function(q){var p=this.__vX.indexOf(q);if(p===-1){return null;}
;return this.__vX[p];}
},destruct:function(){this.__vX=this.__KN=null;}
});}
)();
