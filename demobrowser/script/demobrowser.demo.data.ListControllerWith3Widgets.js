...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.data.ListControllerWith3Widgets.5a45cf0d046f.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
,properties:{appearance:{refine:true,init:t}},members:{__wR:null,_createChildControlImpl:function(B,A){var z;switch(B){case s:z=new qx.ui.core.Spacer();this._add(z,{flex:1});break;case y:z=new qx.ui.basic.Atom(v);z.setCenter(false);z.setAnonymous(true);this._add(z,{flex:1});break;case n:z=new qx.ui.basic.Image();z.setAnonymous(true);this._add(z);break;};return z||qx.ui.form.AbstractSelectBox.prototype._createChildControlImpl.call(this,B);}
...
;}
;this.__yg();this.__yh();}
,__yg:function(){var F=this.getChildControl(l).getSelection()[0];var E=this.getChildControl(y);var G=F?F.getIcon():q;G==null?E.resetIcon():E.setIcon(G);}
,__yh:function(){var J=this.getChildControl(l).getSelection()[0];var H=this.getChildControl(y);var I=J?J.getLabel():q;var K=this.getFormat();if(K!=null){I=K.call(this,J);}
...
,_onKeyPress:function(e){var L=e.getKeyIdentifier();if(L==b||L==i){if(this.__wR){this.setSelection([this.__wR]);this.__wR=null;}
;this.toggle();}
...
,_onListPointerDown:function(e){if(this.__wR){this.setSelection([this.__wR]);this.__wR=null;}
;}
,_onListChangeSelection:function(e){var Q=e.getData();var O=e.getOldData();if(O&&O.length>0){O[0].removeListener(h,this.__yg,this);O[0].removeListener(g,this.__yh,this);}
;if(Q.length>0){var N=this.getChildControl(u);var P=this.getChildControl(l);var R=P.getSelectionContext();if(N.isVisible()&&(R==p||R==k)){this.__wR=Q[0];}
else {this.setSelection([Q[0]]);this.__wR=null;}
;Q[0].addListener(h,this.__yg,this);Q[0].addListener(g,this.__yh,this);}
...
,this);}
,properties:{appearance:{refine:true,init:t},placeholder:{check:n,nullable:true,apply:w}},events:{"changeValue":j},members:{__wR:null,__wS:null,_applyPlaceholder:function(A,z){this.getChildControl(p).setPlaceholder(A);}
...
,_setPreselectedItem:function(){if(this.__wR){var J=this.__wR.getLabel();if(this.getFormat()!=null){J=this.getFormat().call(this,this.__wR);}
;if(J&&J.translate){J=J.translate();}
;this.setValue(J);this.__wR=null;}
;}
,_onListChangeSelection:function(e){var K=e.getData();if(K.length>0){var M=this.getChildControl(o);var L=M.getSelectionContext();if(L==m||L==f){this.__wR=K[0];}
else {var N=K[0].getLabel();if(this.getFormat()!=null){N=this.getFormat().call(this,K[0]);}
;if(N&&N.translate){N=N.translate();}
;this.setValue(N);this.__wR=null;}
;}
;}
