...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.widget.ColorPopup.a220d41c0af0.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
;var bn=this._tables[this.__ED].values;var bo=this.__Ez[this.__ED];if(!bn){return;}
;var bp=this.getValue();if(!bp){return;}
;var bm=bn.indexOf(bp);if(bm!=-1){qx.lang.Array.removeAt(bn,bm);}
else if(bn.length==this.__EE){bn.shift();}
...
;this.__EB.setRed(bx);this.__EB.setGreen(bw);this.__EB.setBlue(bv);this.__EA.open();}
,_onColorSelectorOk:function(){var by=this.__EB;this.setValue(qx.util.ColorUtil.rgbToRgbString([by.getRed(),by.getGreen(),by.getBlue()]));this.__EA.close();}
,_onColorSelectorCancel:function(){this.__EA.close();}
...
;}
,_tables:{core:{label:qx.locale.Manager.tr(a),values:[n,k,g,J,w,F,U,T,I,o,b,d]},recent:{label:qx.locale.Manager.tr(Q),values:[]}}},destruct:function(){if(this.__EA){this.__EA.destroy();this.__EB.destroy();this.__EC.destroy();}
;this._tables=this.__Ez=null;}
});}
)();
...
;this.__Ep=true;this.setRed(cY[0]);this.setGreen(cY[1]);this.__Ep=false;this.setBlue(cY[2]);}
,getValue:function(){return this.__qm?null:qx.util.ColorUtil.rgbToHexString([this.getRed(),this.getGreen(),this.getBlue()]);}
,resetValue:function(){this.__qm=true;this.__Ep=true;this.setRed(255);this.setGreen(255);this.__Ep=false;this.setBlue(255);}
,__qo:function(){if(!this.__Ep){this.__qm=false;this.fireDataEvent(f,this.getValue());}
;}
,_applyRed:function(dc,db){if(this.__Ej===null){this.__Ej=bU;}
;if(this.__Ej!==cK){this.getChildControl(m).setValue(dc);}
;if(this.__Ej!==n){this._setHexFromRgb();}
;switch(this.__Ej){case cK:case n:case bU:this._setHueFromRgb();};this._setPreviewFromRgb();this.__qo();if(this.__Ej===bU){this.__Ej=null;}
;}
,_applyGreen:function(de,dd){if(this.__Ej===null){this.__Ej=cq;}
;if(this.__Ej!==cK){this.getChildControl(O).setValue(de);}
;if(this.__Ej!==n){this._setHexFromRgb();}
;switch(this.__Ej){case cK:case n:case cq:this._setHueFromRgb();};this._setPreviewFromRgb();this.__qo();if(this.__Ej===cq){this.__Ej=null;}
;}
,_applyBlue:function(dg,df){if(this.__Ej===null){this.__Ej=d;}
;if(this.__Ej!==cK){this.getChildControl(cG).setValue(dg);}
;if(this.__Ej!==n){this._setHexFromRgb();}
;switch(this.__Ej){case cK:case n:case d:this._setHueFromRgb();};this._setPreviewFromRgb();this.__qo();if(this.__Ej===d){this.__Ej=null;}
;}
,_applyHue:function(di,dh){if(this.__Ej===null){this.__Ej=cr;}
;if(this.__Ej!==F){this.getChildControl(cu).setValue(di);}
;if(this.__Ej!==R){if(this.getChildControl(V).getBounds()){this.getChildControl(V).setDomLeft(Math.round(di/1.40625)+this.getChildControl(cc).getPaddingLeft());}
else {this.getChildControl(V).setLayoutProperties({left:Math.round(di/1.40625)});}
;}
;switch(this.__Ej){case F:case R:case cr:this._setRgbFromHue();};this._setBrightnessGradiant();if(this.__Ej===cr){this.__Ej=null;}
;}
,_applySaturation:function(dk,dj){if(this.__Ej===null){this.__Ej=s;}
;if(this.__Ej!==F){this.getChildControl(cx).setValue(dk);}
;if(this.__Ej!==R){this._setBrightnessGradiant();if(this.getChildControl(V).getBounds()){this.getChildControl(V).setDomTop(256-Math.round(dk*2.56)+this.getChildControl(cc).getPaddingTop());}
else {this.getChildControl(V).setLayoutProperties({top:256-Math.round(dk*2.56)});}
;}
;switch(this.__Ej){case F:case R:case s:this._setRgbFromHue();};if(this.__Ej===s){this.__Ej=null;}
;}
,_applyBrightness:function(dn,dm){if(this.__Ej===null){this.__Ej=c;}
;if(this.__Ej!==F){this.getChildControl(bT).setValue(dn);}
;if(this.__Ej!==P){var dl=256-Math.round(dn*2.56);if(this.getChildControl(cM).getBounds()){this.getChildControl(cM).setDomTop(dl+this.getChildControl(cE).getPaddingTop());}
else {this.getChildControl(cM).setLayoutProperties({top:dl});}
;}
;switch(this.__Ej){case F:case P:case c:this._setRgbFromHue();};if(this.__Ej===c){this.__Ej=null;}
;}
,_onBrightnessHandlePointerDown:function(e){this.getChildControl(cM).capture();this.__El=cM;var dr=this.getChildControl(cf).getContentLocation();var dq=this.getChildControl(cM).getContentLocation();var dp=this.getChildControl(cf).getBounds();this.__Em=dr.top+(e.getDocumentTop()-dq.top)-dp.top;e.stopPropagation();}
,_onBrightnessHandlePointerUp:function(e){this.getChildControl(cM).releaseCapture();this.__El=null;}
,_onBrightnessHandlePointerMove:function(e){if(this.__El===cM){this._setBrightnessOnFieldEvent(e);e.stopPropagation();}
;}
,_onBrightnessFieldPointerDown:function(e){var location=this.getChildControl(cf).getContentLocation();var ds=this.getChildControl(cM).getBounds();this.__Em=location.top+(ds.height/2);this._setBrightnessOnFieldEvent(e);this.getChildControl(cM).capture();this.__El=cM;}
...
,_setBrightnessOnFieldEvent:function(e){var dt=qx.lang.Number.limit(e.getDocumentTop()-this.__Em,0,256);this.__Ej=P;if(this.getChildControl(cM).getBounds()){this.getChildControl(cM).setDomTop(dt);}
else {this.getChildControl(cM).setLayoutProperties({top:dt});}
;this.setBrightness(100-Math.round(dt/2.56));this.__Ej=null;}
,_onHueSaturationHandlePointerUp:function(e){if(this.__El){e.stopPropagation();this.getChildControl(V).releaseCapture();this.__El=null;}
;}
,_onHueSaturationHandlePointerMove:function(e){if(this.__El===V){this._setHueSaturationOnFieldEvent(e);e.stopPropagation();}
;}
,_onHueSaturationFieldPointerDown:function(e){var location=this.getChildControl(ca).getContentLocation();var du=this.getChildControl(V).getBounds();var dv=this.getChildControl(ca).getBounds();this.__En=location.top+(du.height/2)-dv.top;this.__Eo=location.left+(du.width/2)-dv.left;this._setHueSaturationOnFieldEvent(e);this.getChildControl(V).capture();this.__El=V;}
...
,_setHueSaturationOnFieldEvent:function(e){var dy=qx.lang.Number.limit(e.getDocumentTop()-this.__En,0,256);var dx=qx.lang.Number.limit(e.getDocumentLeft()-this.__Eo,0,256);this.getChildControl(V).setDomPosition(dx,dy);this.__Ej=R;this.setSaturation(100-Math.round(dy/2.56));this.setHue(Math.round(dx*1.40625));this.__Ej=null;}
,_setRedFromSpinner:function(){if(this.__Ej!==null){return;}
;this.__Ej=cK;this.setRed(this.getChildControl(m).getValue());this.__Ej=null;}
,_setGreenFromSpinner:function(){if(this.__Ej!==null){return;}
;this.__Ej=cK;this.setGreen(this.getChildControl(O).getValue());this.__Ej=null;}
,_setBlueFromSpinner:function(){if(this.__Ej!==null){return;}
;this.__Ej=cK;this.setBlue(this.getChildControl(cG).getValue());this.__Ej=null;}
,_setHueFromSpinner:function(){if(this.__Ej!==null){return;}
;this.__Ej=F;this.setHue(this.getChildControl(cu).getValue());this.__Ej=null;}
,_setSaturationFromSpinner:function(){if(this.__Ej!==null){return;}
;this.__Ej=F;this.setSaturation(this.getChildControl(cx).getValue());this.__Ej=null;}
,_setBrightnessFromSpinner:function(){if(this.__Ej!==null){return;}
;this.__Ej=F;this.setBrightness(this.getChildControl(bT).getValue());this.__Ej=null;}
,_onHexFieldChange:function(e){if(this.__Ej!==null){return;}
;try{var dA=this.getChildControl(cD);var dz=qx.util.ColorUtil.hexStringToRgb(J+dA.getValue());}
catch(dB){return;}
;this.__Ej=n;this.setRed(dz[0]);this.setGreen(dz[1]);this.setBlue(dz[2]);this.__Ej=null;}
...
,_setHueFromRgb:function(){switch(this.__Ej){case F:case R:case P:break;default:var dF=qx.util.ColorUtil.rgbToHsb([this.getRed(),this.getGreen(),this.getBlue()]);this.setHue(dF[0]);this.setSaturation(dF[1]);this.setBrightness(dF[2]);};}
,_setRgbFromHue:function(){switch(this.__Ej){case cK:case n:break;default:var dG=qx.util.ColorUtil.hsbToRgb([this.getHue(),this.getSaturation(),this.getBrightness()]);this.setRed(dG[0]);this.setGreen(dG[1]);this.setBlue(dG[2]);};}
...
,_applyValue:function(bi,bh){var bg=this.getChildControl(t);this._updateButtons();this.__wD=bi;if(bi!==null){if(this.getNumberFormat()){bg.setValue(this.getNumberFormat().format(bi));}
...
;}
;}
,_onKeyDown:function(e){switch(e.getKeyIdentifier()){case a:this.__wE=true;case p:this.getChildControl(y).press();break;case m:this.__wF=true;case h:this.getChildControl(q).press();break;default:return;};e.stopPropagation();e.preventDefault();}
,_onKeyUp:function(e){switch(e.getKeyIdentifier()){case a:this.getChildControl(y).release();this.__wE=false;break;case p:this.getChildControl(y).release();break;case m:this.getChildControl(q).release();this.__wF=false;break;case h:this.getChildControl(q).release();break;};}
...
;if(bx===this.__wD){this._applyValue(this.__wD);}
...
,_countUp:function(){if(this.__wE){var bE=this.getValue()+this.getPageStep();}
...
;}
;this.gotoValue(bE);}
,_countDown:function(){if(this.__wF){var bG=this.getValue()-this.getPageStep();}
