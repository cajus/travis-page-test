...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.bom.Placeholder.eaee5882c2de.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
;var U=W.getProperty(qx.module.Placeholder.PLACEHOLDER_NAME);if(!U){U=qx.module.Placeholder.__KF(W);}
;var V=W.isRendered();var X=U.isRendered();if(V&&!X){W.before(U);}
else if(!V&&X){U.remove();return this;}
;qx.module.Placeholder.__KE(W);}
;}
;return this;}
