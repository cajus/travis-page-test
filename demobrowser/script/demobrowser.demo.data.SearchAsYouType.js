...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.data.SearchAsYouType.17aed834950a.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="_applySearchString",b="demobrowser.demo.data.filter.SearchAsYouTypeFilter",c="String",d="";qx.Class.define(b,{extend:qx.core.Object,construct:function(e){qx.core.Object.call(this);this.__vh=e;this.filter=qx.lang.Function.bind(function(f){return f.search(this.getSearchString())!=-1;}
,this);this.__oi=null;}
,properties:{searchString:{check:c,apply:a,init:d}},members:{__oi:null,__vh:null,_applySearchString:function(h,g){var i=qx.util.TimerManager.getInstance();if(this.__oi!=null){i.stop(this.__oi);this.__oi=null;}
;this.__oi=i.start(function(){this.__vh.update();this.__oi=null;}
,0,this,null,200);}
,filter:null},destruct:function(){this.__vh=null;}
});}
)();
