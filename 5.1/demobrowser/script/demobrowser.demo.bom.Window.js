...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.bom.Window.bde63b37cac6.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="Open Native Window",b="Open Native Modal Window",c="demobrowser.demo.bom.Window",d="Modal Window closed?",f="http://sourceforge.net",g="window1",h="window3",i="http://slashdot.org",j="Window closed?",k="http://qooxdoo.org",l="demobrowser/demo/html/ModalWindow.html",m="#eee",n="Open Faked Native Modal Window",o="window2",p="tap",q="button";qx.Class.define(c,{extend:qx.application.Native,members:{__KV:null,main:function(){qx.application.Native.prototype.main.call(this);var r=qx.util.ResourceManager.getInstance();this.__KV=[k,f,i,r.toUri(l)];var u=qx.bom.Input.create(q);qx.bom.Input.setValue(u,a);document.body.appendChild(u);qx.event.Registration.addListener(u,p,function(e){var x={width:400,height:200,top:200,left:100,scrollbars:false,menubar:true,status:false};this.window1=qx.bom.Window.open(this.__KV[0],g,x);}
...
,this);var s=qx.bom.Input.create(q);qx.bom.Input.setValue(s,b);document.body.appendChild(s);qx.event.Registration.addListener(s,p,function(e){var y={width:400,height:200,top:200,left:100,scrollbars:false};this.window2=qx.bom.Window.open(this.__KV[3],o,y,true);}
...
,this);var v=qx.bom.Input.create(q);qx.bom.Input.setValue(v,n);document.body.appendChild(v);qx.event.Registration.addListener(v,p,function(e){var A={width:800,height:600,top:200,left:100,scrollbars:false};var z=qx.bom.Window.getBlocker();z.setBlockerColor(m);z.setBlockerOpacity(0.5);this.window3=qx.bom.Window.open(this.__KV[0],h,A,true,false);}
,this);}
...
(function(){var a="no",b="px",c="qx.bom.Window",d="Cross-Domain Scripting problem: Could not resize window!",e="' is not supported for native windows.",f="interval",g="dialogWidth",h="resizable",i=":",j="yes",k="dialogTop",l="qxNativeWindow",m="Cross-Domain Scripting problem: Could not move window!",n="",o="Option '",p="javascript:/",q="dialogLeft",r="dialogHeight",s="' is not supported for modal windows.",t='load',u="scrollbars",v="=",w=";",x="scroll",y=",";qx.Class.define(c,{statics:{__bY:null,__vw:null,__do:null,__vx:{"top":k,left:q,width:g,height:r,scrollbars:x,resizable:h},__vy:{"top":1,left:1,width:1,height:1,dependent:1,resizable:1,status:1,location:1,menubar:1,scrollbars:1,toolbar:1},__vz:function(){return window.showModalDialog!=null;}
,open:function(z,name,H,E,A,D,self){var C=null;if(z==null){z=p;}
;if(name==null){name=l+new Date().getTime();}
;if(A==null){A=true;}
;var G=this.__vA(H,E&&A);if(E){if(this.__vz()&&A){C=window.showModalDialog(z,[window.self],G);}
else {this.getBlocker().block();if(this.__do==null){this.__do=new qx.event.Timer(500);this.__do.addListener(f,this.__vB,this);}
;this.__vw=window.open(z,name,G);this.__do.restart();C=this.__vw;}
;}
...
;return C;}
,__vA:function(K,O){var M;var J;var N=[];if(O&&this.__vz()){for(var L in K){if(qx.bom.Window.__vx[L]){var I=n;if(L!=u&&L!=h){I=b;}
;J=qx.bom.Window.__vx[L]+i+K[L]+I;N.push(J);}
else {qx.log.Logger.warn(o+L+s);}
;}
;M=N.join(w);}
else {for(var L in K){if(qx.bom.Window.__vy[L]){if(qx.lang.Type.isBoolean(K[L])){J=L+v+(K[L]?j:a);}
else {J=L+v+K[L];}
;N.push(J);}
...
;M=N.join(y);}
;return M;}
,__vB:function(){if(this.isClosed(this.__vw)){this.getBlocker().unblock();this.__do.stop();}
;}
,getBlocker:function(){if(this.__bY==null){this.__bY=new qx.bom.Blocker;}
;return this.__bY;}
...
(function(){var a="resize",b="mshtml",c="backgroundColor",d="block",f="transparent",g="px",h="zIndex",i="src",j="engine.name",k="0px",l="allowTransparency",m="div",n="javascript:false;",o="qx.bom.Blocker",p="absolute";qx.Class.define(o,{extend:qx.core.Object,construct:function(){qx.core.Object.call(this);this.__qm();}
,members:{__vD:null,__jL:null,__vE:null,__vF:false,__vG:10000,__vH:0,__vI:f,block:function(r){if(!this.__vF){this.__vE=r;var q=this.__vL();this.__vM(q);this.__vF=true;}
;}
,unblock:function(){if(this.__vF){this.__vN();this.__vF=false;}
;}
,isBlocked:function(){return this.__vF;}
,getBlockerElement:function(){return this.__jL;}
,setBlockerColor:function(s){qx.bom.element.Style.set(this.__jL,c,s);}
,getBlockerColor:function(){return qx.bom.element.Style.get(this.__jL,c);}
,setBlockerOpacity:function(t){qx.bom.element.Opacity.set(this.__jL,t);}
,getBlockerOpacity:function(){return qx.bom.element.Opacity.get(this.__jL);}
,setBlockerZIndex:function(u){qx.bom.element.Style.set(this.__jL,h,u);}
,getBlockerZIndex:function(){return qx.bom.element.Style.get(this.__jL,h);}
,__qm:function(){this.__vJ();if((qx.core.Environment.get(j)==b)){this.__vK();}
;qx.event.Registration.addListener(window,a,this.__fU,this);}
,__vJ:function(){this.__jL=qx.dom.Element.create(m);qx.bom.element.Style.setStyles(this.__jL,{display:d,opacity:this.__vH,backgroundColor:this.__vI});this.setBlockerZIndex(this.__vG);}
,__vK:function(){this.__vD=qx.bom.Iframe.create();qx.bom.element.Attribute.set(this.__vD,l,false);qx.bom.element.Attribute.set(this.__vD,i,n);qx.bom.element.Style.setStyles(this.__vD,{display:d,opacity:this.__vH});}
,__vL:function(){var v={position:p};if(this.__vP()){v.left=k;v.top=k;v.right=null;v.bottom=null;v.width=qx.bom.Document.getWidth()+g;v.height=qx.bom.Document.getHeight()+g;}
else {v.width=qx.bom.element.Dimension.getWidth(this.__vE)+g;v.height=qx.bom.element.Dimension.getHeight(this.__vE)+g;v.left=qx.bom.element.Location.getLeft(this.__vE)+g;v.top=qx.bom.element.Location.getTop(this.__vE)+g;}
;return v;}
,__vM:function(w){var x=document.body;qx.bom.element.Style.setStyles(this.__jL,w);qx.dom.Element.insertEnd(this.__jL,x);if((qx.core.Environment.get(j)==b)){w.zIndex=this.getBlockerZIndex()-1;qx.bom.element.Style.setStyles(this.__vD,w);qx.dom.Element.insertEnd(this.__vD,document.body);}
;}
,__vN:function(){qx.dom.Element.remove(this.__jL);if((qx.core.Environment.get(j)==b)){qx.dom.Element.remove(this.__vD);}
;}
,__fU:function(e){if(this.__vP()){this.__vO({width:k,height:k});qx.event.Timer.once(function(){var y={width:qx.bom.Document.getWidth()+g,height:qx.bom.Document.getHeight()+g};this.__vO(y);}
,this,0);}
;}
,__vO:function(z){qx.bom.element.Style.setStyles(this.__jL,z);if((qx.core.Environment.get(j)==b)){qx.bom.element.Style.setStyles(this.__vD,z);}
;}
,__vP:function(){return (this.__vE==null||qx.dom.Node.isWindow(this.__vE)||qx.dom.Node.isDocument(this.__vE));}
},destruct:function(){qx.event.Registration.removeListener(window,a,this.__fU,this);this.__vD=this.__jL=this.__vE=null;}
});}
)();
