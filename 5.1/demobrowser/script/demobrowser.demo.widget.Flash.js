...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.widget.Flash.e2808ae6aea8.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="2) this html page is not loaded from the file system, but a webserver.",b="__Ot",c="Flash Player Version",d="__a",f="__mn",g="right",h="qooxdoo is the best!",i="Message from Flash:",j="execute",k="__Ov",l="Simple demo with FlashVars",m="bgcolor",n="demobrowser.demo.widget.Flash",o="demobrowser/demo/flash/TestFlash.swf",p="1) no pop-up or advertising blocker is activated.\n",q="Send to Flash",r="demobrowser/demo/flash/FlashVersion.swf",s="No message.",t="__Ou",u="Flash:",v="<b>qooxdoo:</b>",w="demobrowser.demo.widget.Flash.sendMessage",x="demobrowser.demo.widget.Flash.flashReady",y="Couldn't connect to Flash Player! Please make sure that:\n",z="demobrowser/demo/flash/fo_tester.swf",A="this is passed in via FlashVars",B="Two way communication (ActionScript <-> JavaScript)",C="Message to Flash:",D="Show Flash Player version",E="noscale",F="#FF6600";qx.Class.define(n,{extend:qx.application.Standalone,members:{__a:null,main:function(){qx.application.Standalone.prototype.main.call(this);var J=new qx.ui.tabview.TabView();J.setContentPadding([8,8,8,8]);var G=this.getRoot();G.add(J,{edge:0});var H=new qx.ui.tabview.Page(l);H.setLayout(new qx.ui.layout.Canvas());H.add(this.createFlashDemo1(),{edge:0});J.add(H);var I=new qx.ui.tabview.Page(B);I.setLayout(new qx.ui.layout.Canvas());I.add(this.createFlashDemo2(),{edge:0});J.add(I);this.__a=this.createWindow();G.add(this.__a,{top:20,left:20});}
...
,createFlashDemo1:function(){var N=new qx.ui.container.Composite(new qx.ui.layout.VBox(4));var L={flashVarText:A};var M=new qx.ui.embed.Flash(z).set({scale:E,variables:L});M.getContentElement().setParam(m,F);N.add(M,{flex:1});var O=new qx.ui.form.Button(D);O.addListener(j,function(){this.__a.open();}
,this);N.add(O);return N;}
,__mn:null,__Ot:null,__Ou:null,__Ov:null,createFlashDemo2:function(){this.self(arguments).setCallBackInstance(this);var R=new qx.ui.container.Composite(new qx.ui.layout.HBox(8));var Q=new qx.ui.container.Composite(new qx.ui.layout.VBox(4));R.add(Q,{flex:1});Q.add(new qx.ui.basic.Label(v).set({rich:true}));Q.add(new qx.ui.basic.Label(i));this.__Ot=new qx.ui.form.TextArea(s);this.__Ot.setEnabled(false);Q.add(this.__Ot,{flex:1});Q.add(new qx.ui.basic.Label(C));this.__Ou=new qx.ui.form.TextArea(h);Q.add(this.__Ou,{flex:1});var S=new qx.ui.container.Composite(new qx.ui.layout.HBox(0,g));this.__Ov=new qx.ui.form.Button(q);this.__Ov.setEnabled(false);this.__Ov.addListener(j,function(e){this.__mn.getFlashElement().sendMessage(this.__Ou.getValue());}
,this);S.add(this.__Ov);Q.add(S);var P=new qx.ui.container.Composite(new qx.ui.layout.VBox(4));R.add(P,{flex:1});P.add(new qx.ui.basic.Label(u).set({rich:true}));this.__mn=new qx.ui.embed.Flash(o);this.__mn.setVariables({init:x});P.add(this.__mn,{flex:1});return R;}
,sendMessage:function(T){this.__Ot.setValue(T);}
,initFlash:function(){if(this.__mn.getFlashElement().setup){this.__mn.getFlashElement().setup(w);this.__Ov.setEnabled(true);}
else {alert(y+p+a);}
;}
},statics:{__Ow:null,setCallBackInstance:function(U){demobrowser.demo.widget.Flash.__Ow=U;}
,sendMessage:function(V){demobrowser.demo.widget.Flash.__Ow.sendMessage(V);}
,flashReady:function(){demobrowser.demo.widget.Flash.__Ow.initFlash();}
},destruct:function(){this._disposeObjects(b,t,k,f,d);}
});}
)();
...
(function(){var a="bottom",b="button",c="qx.event.type.Data",d="lastTab",f="barRight",g="beforeChangeSelection",h="qx.debug",j="horizontal",k="changeSelection",m="bar",n="__fd",o="close-button",p="Index should be less than : ",q="tabview",r="vertical",s="page",t="Incompatible child for TabView: ",u="close",v="_applyBarPosition",w="barLeft",x="top",y="right",z="qx.ui.tabview.TabView",A="barTop",B="barBottom",C="pane",D="left",E="firstTab";qx.Class.define(z,{extend:qx.ui.core.Widget,implement:qx.ui.core.ISingleSelection,include:[qx.ui.core.MContentPadding],construct:function(G){qx.ui.core.Widget.call(this);this.__fc={top:A,right:f,bottom:B,left:w};this._createChildControl(m);this._createChildControl(C);var F=this.__fd=new qx.ui.form.RadioGroup;F.setWrap(false);F.addListener(k,this._onChangeSelection,this);if(G!=null){this.setBarPosition(G);}
else {this.initBarPosition();}
;}
,events:{"changeSelection":c},properties:{appearance:{refine:true,init:q},barPosition:{check:[D,y,x,a],init:x,apply:v}},members:{__fd:null,_createChildControlImpl:function(J,I){var H;switch(J){case m:H=new qx.ui.container.SlideBar();H.setZIndex(10);this._add(H);break;case C:H=new qx.ui.container.Stack;H.setZIndex(5);this._add(H,{flex:1});break;};return H||qx.ui.core.Widget.prototype._createChildControlImpl.call(this,J);}
...
;}
;var K=O.getButton();var L=this.getChildControl(m);var N=this.getChildControl(C);O.exclude();L.add(K);N.add(O);this.__fd.add(K);O.addState(this.__fc[this.getBarPosition()]);O.addState(d);var M=this.getChildren();if(M[0]==O){O.addState(E);}
...
;var R=U.getButton();var Q=this.getChildControl(m);var T=this.getChildControl(C);U.exclude();Q.addAt(R,P);T.addAt(U,P);this.__fd.add(R);U.addState(this.__fc[this.getBarPosition()]);S=this.getChildren();if(P==S.length-1){U.addState(d);}
...
;}
;W.remove(X);ba.remove(Y);this.__fd.remove(X);Y.removeState(this.__fc[this.getBarPosition()]);if(Y.hasState(E)){Y.removeState(E);if(bb[0]){bb[0].addState(E);}
;}
...
,__fc:null,_applyBarPosition:function(bg,bi){var bd=this.getChildControl(m);var bj=this.getChildControl(C);var bl=bg==D||bg==y;var bm=bg==y||bg==a;var bk=bl?qx.ui.layout.HBox:qx.ui.layout.VBox;var bn=this._getLayout();if(bn&&bn instanceof bk){}
else {this._setLayout(bn=new bk);}
;bn.setReversed(bm);bd.setOrientation(bl?r:j);var bh=this.getChildren();var i,l;if(bi){var bf=this.__fc[bi];bd.removeState(bf);bj.removeState(bf);for(i=0,l=bh.length;i<l;i++ ){bh[i].removeState(bf);}
;}
;if(bg){var be=this.__fc[bg];bd.addState(be);bj.addState(be);for(i=0,l=bh.length;i<l;i++ ){bh[i].addState(be);}
;}
;}
,getSelection:function(){var bo=this.__fd.getSelection();var bp=[];for(var i=0;i<bo.length;i++ ){bp.push(bo[i].getUserData(s));}
;return bp;}
,setSelection:function(br){var bq=[];for(var i=0;i<br.length;i++ ){bq.push(br[i].getChildControl(b));}
;this.__fd.setSelection(bq);}
,resetSelection:function(){this.__fd.resetSelection();}
,isSelected:function(bs){var bt=bs.getChildControl(b);return this.__fd.isSelected(bt);}
,isSelectionEmpty:function(){return this.__fd.isSelectionEmpty();}
,getSelectables:function(bv){var bu=this.__fd.getSelectables(bv);var bw=[];for(var i=0;i<bu.length;i++ ){bw.push(bu[i].getUserData(s));}
;return bw;}
...
},destruct:function(){this._disposeObjects(n);this.__fc=null;}
});}
)();
...
,__cI:function(e){var m=e.getOldData()[0];var n=e.getData()[0];if(m){if(this.isDynamic()){m.exclude();}
else {m.hide();}
;}
;if(n){n.show();}
;}
...
,_checkLoading:function(){var bo=this.getSource();if(bo!=F&&bo!=null&&bo!=bf){if(!this.isLoaded()){if(!this.__mi){this.__mi=new Date().getTime();}
;var bp=new Date().getTime()-this.__mi;if(this.getLoadTimeout()>bp){var bq=qx.util.TimerManager.getInstance();bq.start(this._checkLoading,0,this,null,10);this.fireEvent(x);}
else {if(qx.core.Environment.get(u)){this.debug(A+bp);}
;this.fireEvent(P);this.__mi=null;}
;}
else {this.fireEvent(p);this.__mi=null;}
;}
;}
...
,_applyQuality:function(bB,bA){this.__mj(c,bB);}
,_applyScale:function(bD,bC){this.__mj(h,bD);}
,_applyWmode:function(bF,bE){this.__mj(m,bF);}
,_applyPlay:function(bH,bG){this.__mj(I,bH);}
,_applyLoop:function(bJ,bI){this.__mj(s,bJ);}
,_applyMenu:function(bL,bK){this.__mj(v,bL);}
,_applyAllowScriptAccess:function(bN,bM){this.__mj(t,bN);}
,_applyLiveConnect:function(bP,bO){this.__mj(z,bP);}
,__mj:function(bQ,bR){this.getContentElement().setParam(bQ,bR);qx.ui.core.queue.Layout.add(this);}
}});}
)();
(function(){var a="$$",b="Invalid attribute 'value'.",c="The id cannot be modified after initial creation",d="The variables cannot be modified after initial creation",e="qx.debug",f="$$widget",g="Invalid attribute 'key'.",h="movie",i="div",j="The attributes cannot be modified after initial creation",k="The source cannot be modified after initial creation",l="The params cannot be modified after initial creation",m="Invalid attribute 'value' expected String, Boolean or null.",n="id",o="qx.html.Flash";qx.Class.define(o,{extend:qx.html.Element,construct:function(p,q){qx.html.Element.call(this,i,p,q);this.__mk={};this.__ml={};this.__mm={};}
,members:{__mk:null,__mm:null,__ml:null,__mn:null,_createDomElement:function(){return qx.dom.Element.create(i);}
,createFlash:function(){this.__mn=qx.bom.Flash.create(this.getDomElement(),this.getAttributes(),this.__ml,this.__mk);}
,setSource:function(r){if(qx.core.Environment.get(e)){qx.core.Assert.assertString(r,b);}
;if(this.__mn){throw new Error(k);}
;this.setAttribute(h,r);}
,setId:function(s){if(qx.core.Environment.get(e)){qx.core.Assert.assertString(s,b);}
;if(this.__mn){throw new Error(c);}
;this.setAttribute(n,s);}
,getVariables:function(){return this.__ml;}
,setVariables:function(t){if(qx.core.Environment.get(e)){qx.core.Assert.assertMap(t,b);}
;if(this.__mn){throw new Error(d);}
;this.__ml=t;}
,getAttributes:function(){return this.__mm;}
...
else if(this.__mn){throw new Error(j);}
;if(v===null||v===undefined){delete this.__mm[u];}
else {this.__mm[u]=v;}
;}
,getParams:function(){return this.__mk;}
...
;}
;}
;if(this.__mn){throw new Error(l);}
;if(x===null||x===undefined){delete this.__mk[w];}
else {this.__mk[w]=x;}
;}
,getFlashElement:function(){return this.__mn;}
},destruct:function(){if(this.__mn){qx.bom.Flash.destroy(this.__mn);}
;this.__mk=this.__ml=this.__mm=null;}
});}
)();
...
;}
;}
;var O=this.__mD(P,R,Q,M);this._flashObjects[R.id]=O;return O;}
,destroy:function(T,S){if(qx.core.Environment.get(D)==v&&qx.core.Environment.get(q)<11){T=this.__my(T);if(T.readyState==4){this.__mz(T);}
else {if(!S){S=window;}
;qx.bom.Event.addNativeListener(S,p,function(){qx.bom.Flash.__mz(T);}
);}
;}
else {T=this.__my(T);if(T.parentNode){T.parentNode.removeChild(T);}
;delete this._flashObjects[T.id];}
;}
,__my:function(U){if(!U){throw new Error(z);}
;if(U.tagName.toLowerCase()!==L){U=U.firstChild;}
;if(!U||U.tagName.toLowerCase()!==L){throw new Error(A);}
;return U;}
,__mz:qx.core.Environment.select(D,{"mshtml":qx.event.GlobalError.observeMethod(function(V){for(var i in V){if(typeof V[i]==b){V[i]=null;}
;}
;if(V.parentNode){V.parentNode.removeChild(V);}
;delete this._flashObjects[V.id];}
),"default":null}),__mA:qx.event.GlobalError.observeMethod(function(){for(var W in qx.bom.Flash._flashObjects){qx.bom.Flash.destroy(qx.bom.Flash._flashObjects[W]);}
;window.__mB=function(){}
;window.__mC=function(){}
;qx.bom.Event.removeNativeListener(window,F,qx.bom.Flash.__mA);}
),__mD:function(bb,bd,bc,X){if(qx.core.Environment.get(D)==v&&qx.core.Environment.get(q)<11){bc.movie=bd.data;delete bd.data;delete bd.classid;var Y=u;for(var name in bc){Y+=m+name+J+bc[name]+E;}
...
},defer:function(bf){if(qx.core.Environment.get(D)==v){qx.bom.Event.addNativeListener(window,F,bf.__mA);}
;}
});}
)();
