...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.bom.Storage.66bb730b881a.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="<em>no content</em>",b="Memory Storage",c="html.storage.local",d="html.storage.userdata",e="",f="list",g="save",h="value",i="Web Storage",j="demobrowser.demo.bom.Storage",k="<br>",l="tap",m="clear",n=":",o="using",p="remove",r="key",s="userData Storage";qx.Class.define(j,{extend:qx.application.Native,members:{__gK:null,main:function(){qx.application.Native.prototype.main.call(this);this.setUsing();this.__gK=qx.bom.Storage.getLocal();var v=document.getElementById(g);var t=document.getElementById(m);var u=document.getElementById(p);var self=this;q(v).on(l,function(){var w=qx.bom.Input.getValue(document.getElementById(r));var x=qx.bom.Input.getValue(document.getElementById(h));self.__gK.setItem(w,x);self.updateList();}
);q(t).on(l,function(){self.__gK.clear();self.updateList();}
);q(u).on(l,function(){self.__gK.removeItem(self.__gK.getKey(0));self.updateList();}
);this.updateList();}
,updateList:function(){var y=document.getElementById(f);y.innerHTML=e;this.__gK.forEach(function(z,A){y.innerHTML+=z+n+A+k;}
