...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.virtual.Table.fb497f013969.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a=" / ",b="horizontal",c="demobrowser.demo.virtual.Table",d="white",e="#EEE",f="vertical",g="__Og";qx.Class.define(c,{extend:qx.application.Standalone,members:{__Og:null,main:function(){qx.application.Standalone.prototype.main.call(this);var h=new qx.ui.virtual.core.Scroller(10000,10000,20,100);for(var i=0;i<10000;i++ ){h.getPane().getRowConfig().setItemSize(i,20+Math.round(Math.random()*40));h.getPane().getColumnConfig().setItemSize(i,50+Math.round(Math.random()*80));}
;this.getRoot().add(h,{edge:20});h.getPane().addLayer(new qx.ui.virtual.layer.Row(d,e));h.getPane().addLayer(new qx.ui.virtual.layer.GridLines(b));h.getPane().addLayer(new qx.ui.virtual.layer.GridLines(f));h.getPane().addLayer(new qx.ui.virtual.layer.HtmlCell(this));this.__Og=new qx.ui.virtual.cell.Cell();}
,getCellProperties:function(k,j){return this.__Og.getCellProperties(k+a+j);}
