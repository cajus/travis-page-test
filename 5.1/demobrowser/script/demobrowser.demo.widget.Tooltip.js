...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.widget.Tooltip.ad530e481eb1.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
,__OG:4,__OH:0,add:function(B){this.container.add(B,{row:Math.floor(this.__OH/this.__OG),column:this.__OH%this.__OG});this.__OH+=1;}
