...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.mobile.Fingers.d6dc4a24c922.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
;this.__MV=[];this.__MW=[];O.addListener(t,this._onPointerDown,this);O.addListener(C,this._onPointerMove,this);}
,_onPointerDown:function(e){this.__MV[e.getPointerId()]=parseInt(e.getTarget().style.left)-e.getDocumentLeft();this.__MW[e.getPointerId()]=parseInt(e.getTarget().style.top)-e.getDocumentTop();}
,_onPointerMove:function(e){if(e.getTarget()==document.body){return;}
;qx.bom.element.Style.setStyles(e.getTarget(),{"left":(e.getDocumentLeft()+this.__MV[e.getPointerId()])+b,"top":(e.getDocumentTop()+this.__MW[e.getPointerId()])+b});e.preventDefault();}
}});}
)();
