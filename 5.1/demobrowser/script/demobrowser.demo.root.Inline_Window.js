...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.root.Inline_Window.c8ddaab499e7.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="resize",b="qx.ui.root.Page",c="engine.name",d="mshtml",f="gecko",g="paddingLeft",h="$$widget",i="The root widget does not support 'left', or 'top' paddings!",j="div",k="left",l="paddingTop",m="qxIsRootPage",n="absolute";qx.Class.define(b,{extend:qx.ui.root.Abstract,construct:function(o){this.__b=o;qx.ui.root.Abstract.call(this);this._setLayout(new qx.ui.layout.Basic());this.setZIndex(10000);qx.ui.core.queue.Layout.add(this);this.addListener(a,this.__fU,this);qx.ui.core.FocusHandler.getInstance().connectTo(this);if((qx.core.Environment.get(c)==d)){this.setKeepFocus(true);}
;}
,members:{__do:null,__b:null,_createContentElement:function(){var q=this.__b.createElement(j);this.__b.body.appendChild(q);var p=new qx.html.Root(q);p.setStyles({position:n,textAlign:k});p.setAttribute(h,this.toHashCode());if((qx.core.Environment.get(c)==f)){p.setAttribute(m,1);}
;return p;}
...
,__fU:function(e){this.getContentElement().setStyles({width:0,height:0});}
...
;this.__dr=w;w.style.overflow=p;w.style.textAlign=r;this.__ds=x||false;this.__dt=v||false;this.__du();qx.ui.root.Abstract.call(this);this._setLayout(new qx.ui.layout.Basic());qx.ui.core.queue.Layout.add(this);qx.ui.core.FocusHandler.getInstance().connectTo(this);if((qx.core.Environment.get(c)==b)){this.setKeepFocus(true);}
...
,members:{__ds:false,__dt:false,__dr:null,__du:function(){if(this.__ds||this.__dt){var y=qx.bom.element.Dimension.getSize(this.__dr);if(this.__ds&&y.width<1){throw new Error(s+this.__dr+t+this+k);}
;if(this.__dt){if(y.height<1){throw new Error(s+this.__dr+t+this+g);}
;if(y.height>=1&&qx.bom.element.Style.get(this.__dr,j,3)==f){qx.bom.element.Style.set(this.__dr,j,y.height+h);}
;}
;qx.event.Registration.addListener(this.__dr,a,this._onResize,this);}
;}
,_createContentElement:function(){var z=this.__dr;if(this.__ds||this.__dt){var B=document.createElement(q);z.appendChild(B);}
else {B=z;}
...
,this,0);return A;}
,_onResize:function(e){var C=e.getData();if((C.oldWidth!==C.width)&&this.__ds||(C.oldHeight!==C.height)&&this.__dt){qx.ui.core.queue.Layout.add(this);}
;}
...
;}
,_computeSizeHint:function(){var H=this.__ds;var E=this.__dt;if(!H||!E){var D=qx.ui.root.Abstract.prototype._computeSizeHint.call(this);}
else {D={};}
;var I=qx.bom.element.Dimension;if(H){var G=I.getContentWidth(this.__dr);D.width=G;D.minWidth=G;D.maxWidth=G;}
;if(E){var F=I.getContentHeight(this.__dr);D.height=F;D.minHeight=F;D.maxHeight=F;}
;return D;}
},defer:function(J,K){qx.ui.core.MLayoutHandling.remap(K);}
,destruct:function(){qx.event.Registration.removeListener(this.__dr,a,this._onResize,this);this.__dr=null;}
});}
)();
(function(){var a="resize",b="__do",c="interval",d="body",f="qx.event.handler.ElementResize";qx.Class.define(f,{extend:qx.core.Object,implement:qx.event.IEventHandler,construct:function(g){qx.core.Object.call(this);this.__u=g;this.__dv={};this.__do=new qx.event.Timer(200);this.__do.addListener(c,this._onInterval,this);}
,statics:{PRIORITY:qx.event.Registration.PRIORITY_NORMAL,SUPPORTED_TYPES:{resize:true},TARGET_CHECK:qx.event.IEventHandler.TARGET_DOMNODE,IGNORE_CAN_HANDLE:false},members:{__dv:null,__u:null,__do:null,canHandleEvent:function(i,h){return i.tagName.toLowerCase()!==d;}
,registerEvent:function(m,n,j){var l=qx.core.ObjectRegistry.toHashCode(m);var k=this.__dv;if(!k[l]){k[l]={element:m,width:qx.bom.element.Dimension.getWidth(m),height:qx.bom.element.Dimension.getHeight(m)};this.__do.start();}
;}
,unregisterEvent:function(r,s,o){var q=qx.core.ObjectRegistry.toHashCode(r);var p=this.__dv;if(p[q]){delete p[q];if(qx.lang.Object.isEmpty(p)){this.__do.stop();}
;}
;}
,_onInterval:function(e){var u=this.__dv;for(var x in u){var y=u[x];var t=y.element;var w=qx.bom.element.Dimension.getWidth(t);var v=qx.bom.element.Dimension.getHeight(t);if(y.height!==v||y.width!==w){qx.event.Registration.fireNonBubblingEvent(t,a,qx.event.type.Data,[{width:w,oldWidth:y.width,height:v,oldHeight:y.height}]);y.width=w;y.height=v;}
;}
;}
},destruct:function(){this.__u=this.__dv=null;this._disposeObjects(b);}
