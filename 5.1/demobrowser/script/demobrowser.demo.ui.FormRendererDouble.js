...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.ui.FormRendererDouble.2cafa078f43b.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
,_applyValue:function(bi,bh){var bg=this.getChildControl(t);this._updateButtons();this.__MS=bi;if(bi!==null){if(this.getNumberFormat()){bg.setValue(this.getNumberFormat().format(bi));}
...
;this._applyValue(this.__MS,undefined);}
...
;}
;}
,_onKeyDown:function(e){switch(e.getKeyIdentifier()){case a:this.__MT=true;case p:this.getChildControl(y).press();break;case m:this.__MU=true;case h:this.getChildControl(q).press();break;default:return;};e.stopPropagation();e.preventDefault();}
,_onKeyUp:function(e){switch(e.getKeyIdentifier()){case a:this.getChildControl(y).release();this.__MT=false;break;case p:this.getChildControl(y).release();break;case m:this.getChildControl(q).release();this.__MU=false;break;case h:this.getChildControl(q).release();break;};}
...
;if(bx===this.__MS){this._applyValue(this.__MS);}
else {this.setValue(bx);}
;}
else {this._applyValue(this.__MS,undefined);}
;}
...
,_countUp:function(){if(this.__MT){var bE=this.getValue()+this.getPageStep();}
...
;}
;this.gotoValue(bE);}
,_countDown:function(){if(this.__MU){var bG=this.getValue()-this.getPageStep();}
...
(function(){var a="Boolean",b="_applyValid",c="",d="changeRequired",f="changeValid",g="changeInvalidMessage",h="changeSelection",j="__fd",k="_applyInvalidMessage",l="String",m="qx.ui.form.RadioButtonGroup",n="qx.event.type.Data";qx.Class.define(m,{extend:qx.ui.core.Widget,include:[qx.ui.core.MLayoutHandling,qx.ui.form.MModelSelection],implement:[qx.ui.form.IForm,qx.ui.core.ISingleSelection,qx.ui.form.IModelSelection],construct:function(o){qx.ui.core.Widget.call(this);if(o==null){this.setLayout(new qx.ui.layout.VBox(4));}
else {this.setLayout(o);}
;this.__fd=new qx.ui.form.RadioGroup();this.__fd.addListener(h,function(e){this.fireDataEvent(h,e.getData(),e.getOldData());}
,this);}
,properties:{valid:{check:a,init:true,apply:b,event:f},required:{check:a,init:false,event:d},invalidMessage:{check:l,init:c,event:g,apply:k},requiredInvalidMessage:{check:l,nullable:true,event:g}},events:{"changeSelection":n},members:{__fd:null,_applyInvalidMessage:function(r,p){var q=this._getChildren();for(var i=0;i<q.length;i++ ){q[i].setInvalidMessage(r);}
;}
,_applyValid:function(u,s){var t=this._getChildren();for(var i=0;i<t.length;i++ ){t[i].setValid(u);}
;}
,getRadioGroup:function(){return this.__fd;}
,getChildren:function(){return this._getChildren();}
,add:function(w,v){this.__fd.add(w);this._add(w,v);}
,remove:function(x){this.__fd.remove(x);this._remove(x);}
,removeAll:function(){var y=this.__fd.getItems();for(var i=y.length-1;i>=0;i-- ){this.__fd.remove(y[i]);}
;return this._removeAll();}
,getSelection:function(){return this.__fd.getSelection();}
,setSelection:function(z){this.__fd.setSelection(z);}
,resetSelection:function(){this.__fd.resetSelection();}
,isSelected:function(A){return this.__fd.isSelected(A);}
,isSelectionEmpty:function(){return this.__fd.isSelectionEmpty();}
,getSelectables:function(B){return this.__fd.getSelectables(B);}
