...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.event.Event.d5eea1cdb4d7.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
;}
,_initLogger:function(p,n,o){this.__MG=f+p.join(c)+a;this.__MH=o||50;this.__MI=n;this._clearLog();}
,_clearLog:function(){this.__MI.innerHTML=this.__MG+k;this.__MJ=[];}
,_log:function(q){this.__MJ.unshift(q);this.__MJ=this.__MJ.slice(0,this.__MH);var r=[this.__MG];for(var i=0;i<this.__MJ.length;i++ ){r.push(g,this.__MJ[i].join(e),l);}
;r.push(k);this.__MI.innerHTML=r.join(d);this.__MI.scrollTop=0;}
,__MG:null,__MH:null,__MI:null,__MJ:null},destruct:function(){this.__MI=this.__MJ=null;}
});}
)();
