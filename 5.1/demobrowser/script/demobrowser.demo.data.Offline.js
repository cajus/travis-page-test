...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.data.Offline.cb14db950af5.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
;this._storeModel=qx.util.Function.debounce(this.__lH.bind(this),qx.data.store.Offline.STORE_MODEL_DELAY);this._marshaler=new qx.data.marshal.Json(i);this._key=j;this._initializeModel();}
,properties:{model:{nullable:true,event:d,apply:g}},statics:{STORE_MODEL_DELAY:400},members:{_storage:null,__lG:null,__lH:function(){var k=qx.util.Serializer.toNativeObject(this.getModel());this._storage.setItem(this._key,k);}
,_applyModel:function(m,l){if(l){l.removeListenerById(this.__lG);l.dispose();this.__lG=null;}
;if(m){this.__lG=m.addListener(f,this._storeModel,this);this._storeModel();}
...
(function(){var a="html.storage.local",b="html.storage.userdata",c="qx.bom.Storage";qx.Bootstrap.define(c,{statics:{__go:null,getLocal:function(){if(qx.core.Environment.get(a)){return qx.bom.storage.Web.getLocal();}
...
(function(){var a="local",b="session",c="Storage",d="qx.bom.storage.Web",f="Storage full.";qx.Bootstrap.define(d,{statics:{__gr:null,__gs:null,getLocal:function(){if(this.__gr){return this.__gr;}
;return this.__gr=new qx.bom.storage.Web(a);}
,getSession:function(){if(this.__gs){return this.__gs;}
;return this.__gs=new qx.bom.storage.Web(b);}
},construct:function(g){this.__gt=g;}
,members:{__gt:null,getStorage:function(){return window[this.__gt+c];}
,getLength:function(){return this.getStorage(this.__gt).length;}
,setItem:function(h,j){j=qx.lang.Json.stringify(j);try{this.getStorage(this.__gt).setItem(h,j);}
catch(e){throw new Error(f);}
;}
,getItem:function(l){var k=this.getStorage(this.__gt).getItem(l);if(qx.lang.Type.isString(k)){k=qx.lang.Json.parse(k);}
else if(k&&k.value&&qx.lang.Type.isString(k.value)){k=qx.lang.Json.parse(k.value);}
;return k;}
,removeItem:function(m){this.getStorage(this.__gt).removeItem(m);}
,clear:function(){var n=this.getStorage(this.__gt);if(!n.clear){for(var i=n.length-1;i>=0;i-- ){n.removeItem(n.key(i));}
;}
else {n.clear();}
;}
,getKey:function(o){return this.getStorage(this.__gt).key(o);}
,forEach:function(p,r){var length=this.getLength();for(var i=0;i<length;i++ ){var q=this.getKey(i);p.call(r,q,this.getItem(q));}
;}
}});}
)();
(function(){var a="session",b="head",c="none",d="qx",e="qx.bom.storage.UserData",f="div",g="local",h="qxtest",j="#default#userdata",k="display";qx.Bootstrap.define(e,{statics:{__gr:null,__gs:null,__gH:0,getLocal:function(){if(this.__gr){return this.__gr;}
;return this.__gr=new qx.bom.storage.UserData(g);}
,getSession:function(){if(this.__gs){return this.__gs;}
;return this.__gs=new qx.bom.storage.UserData(a);}
},construct:function(m){this.__gI=document.createElement(f);this.__gI.style[k]=c;document.getElementsByTagName(b)[0].appendChild(this.__gI);this.__gI.addBehavior(j);this.__gJ=m;this.__gI.load(this.__gJ);this.__gK={};this.__gL={};var l=this.__gI.getAttribute(d+qx.bom.storage.UserData.__gH);while(l!=undefined){l=qx.lang.Json.parse(l);this.__gK[l.key]=l.value;this.__gL[l.key]=d+qx.bom.storage.UserData.__gH;qx.bom.storage.UserData.__gH++ ;l=this.__gI.getAttribute(d+qx.bom.storage.UserData.__gH);}
;}
,members:{__gI:null,__gJ:h,__gK:null,__gL:null,getStorage:function(){return this.__gK;}
,getLength:function(){return Object.keys(this.__gK).length;}
,setItem:function(n,p){if(this.__gL[n]){var o=this.__gL[n];}
else {var o=d+qx.bom.storage.UserData.__gH;qx.bom.storage.UserData.__gH++ ;}
;var q=qx.lang.Json.stringify({key:n,value:p});this.__gI.setAttribute(o,q);this.__gI.save(this.__gJ);this.__gK[n]=p;this.__gL[n]=o;}
,getItem:function(r){return this.__gK[r]||null;}
,removeItem:function(v){var u=this.__gL[v];if(u==undefined){return;}
;this.__gI.removeAttribute(u);qx.bom.storage.UserData.__gH-- ;delete this.__gK[v];delete this.__gL[v];var t=d+qx.bom.storage.UserData.__gH;if(this.__gI.getAttribute(t)){var w=this.__gI.getAttribute(d+qx.bom.storage.UserData.__gH);this.__gI.removeAttribute(t);this.__gI.setAttribute(u,w);var s=qx.lang.Json.parse(w).key;this.__gL[s]=u;}
;this.__gI.save(this.__gJ);}
,clear:function(){for(var x in this.__gL){this.__gI.removeAttribute(this.__gL[x]);}
;this.__gI.save(this.__gJ);this.__gK={};this.__gL={};}
,getKey:function(y){return Object.keys(this.__gK)[y];}
,forEach:function(z,B){var length=this.getLength();for(var i=0;i<length;i++ ){var A=this.getKey(i);z.call(B,A,this.getItem(A));}
;}
}});}
)();
(function(){var a="qx.bom.storage.Memory";qx.Bootstrap.define(a,{statics:{__gr:null,__gs:null,getLocal:function(){if(this.__gr){return this.__gr;}
;return this.__gr=new qx.bom.storage.Memory();}
,getSession:function(){if(this.__gs){return this.__gs;}
;return this.__gs=new qx.bom.storage.Memory();}
},construct:function(){this.__gK={};}
,members:{__gK:null,getStorage:function(){return this.__gK;}
,getLength:function(){return Object.keys(this.__gK).length;}
,setItem:function(b,c){c=qx.lang.Json.stringify(c);this.__gK[b]=c;}
,getItem:function(e){var d=this.__gK[e];if(qx.lang.Type.isString(d)){d=qx.lang.Json.parse(d);}
;return d;}
,removeItem:function(f){delete this.__gK[f];}
,clear:function(){this.__gK={};}
,getKey:function(h){var g=Object.keys(this.__gK);return g[h];}
