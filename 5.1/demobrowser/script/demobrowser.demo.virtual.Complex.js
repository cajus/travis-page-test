...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.virtual.Complex.eaff49594f65.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="icon/",b=" / ",c="",d="folder.png",e="places/",f="demobrowser.demo.virtual.DemoLayer",g="pointerover",h="network-server.png",i="row",k="user-trash.png",l="foobar!",m="changeValue",n="column",o="network-workgroup.png",p="qx.ui.basic.Atom",q="/",r="user-desktop.png";qx.Class.define(f,{extend:qx.ui.virtual.layer.WidgetCell,construct:function(){qx.ui.virtual.layer.WidgetCell.call(this,this);this._pool={atom:[],checkbox:[]};this.__vT=[];}
,members:{_pool:null,__vT:null,getCellData:function(t,s){if(!this.__vT[t]){this.__vT[t]=[];}
;if(!this.__vT[t][s]){this.__vT[t][s]={label:this.__Oh(),icon:this.__Oi()};}
;return this.__vT[t][s];}
,getCellWidget:function(w,u){var v;if(u%2==0){v=this._pool.atom.pop();if(!v){v=new qx.ui.basic.Atom();v.addListener(g,function(){var x=this.__Oi();v.setIcon(x);this.__vT[w][u].icon=x;}
,this);}
...
;}
,__Oh:function(){var name=c;for(var j=0;j<10;j++ ){name+=String.fromCharCode(Math.floor(Math.random()*25)+65);}
;return name;}
,__Oi:function(){var z=a;var B=e;var A=[d,k,h,o,r];var C=Math.floor(Math.random()*4);return (z+16+q+B+A[C]);}
