...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.widget.Canvas.d07fe264f589.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
;}
,events:{"redraw":j},properties:{syncDimension:{check:d,init:false},canvasWidth:{check:i,init:300,apply:b},canvasHeight:{check:i,init:150,apply:f}},members:{__mL:null,_createContentElement:function(){return new qx.html.Canvas();}
,__mM:function(){var n=this.getContentElement();var p=n.getHeight();var m=n.getWidth();var o=n.getContext2d();this._draw(m,p,o);this.fireNonBubblingEvent(c,qx.event.type.Data,[{width:m,height:p,context:o}]);}
,_applyCanvasWidth:function(r,q){this.getContentElement().setWidth(r);this.__mL.schedule();}
,_applyCanvasHeight:function(t,s){this.getContentElement().setHeight(t);this.__mL.schedule();}
,update:function(){this.__mL.schedule();}
...
(function(){var a="canvas",b="2d",c="qx.html.Canvas";qx.Class.define(c,{extend:qx.html.Element,construct:function(d,e){qx.html.Element.call(this,a,d,e);this.__ey=document.createElement(a);}
,members:{__ey:null,_createDomElement:function(){return this.__ey;}
,getCanvas:function(){return this.__ey;}
,setWidth:function(f){this.__ey.width=f;}
,getWidth:function(){return this.__ey.width;}
,setHeight:function(g){this.__ey.height=g;}
,getHeight:function(){return this.__ey.height;}
,getContext2d:function(){return this.__ey.getContext(b);}
},destruct:function(){this.__ey=null;}
});}
)();
