...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.data.ListControllerWith3Widgets.b28f95dc6d97.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
,this);}
,properties:{appearance:{refine:true,init:t},placeholder:{check:n,nullable:true,apply:w}},events:{"changeValue":j},members:{__Lu:null,__ME:null,_applyPlaceholder:function(A,z){this.getChildControl(p).setPlaceholder(A);}
...
,_setPreselectedItem:function(){if(this.__Lu){var J=this.__Lu.getLabel();if(this.getFormat()!=null){J=this.getFormat().call(this,this.__Lu);}
;if(J&&J.translate){J=J.translate();}
;this.setValue(J);this.__Lu=null;}
;}
,_onListChangeSelection:function(e){var K=e.getData();if(K.length>0){var M=this.getChildControl(o);var L=M.getSelectionContext();if(L==m||L==f){this.__Lu=K[0];}
else {var N=K[0].getLabel();if(this.getFormat()!=null){N=this.getFormat().call(this,K[0]);}
;if(N&&N.translate){N=N.translate();}
;this.setValue(N);this.__Lu=null;}
;}
;}
