...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.widget.ColorPopup.b83ed8f4fb1c.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
;var bn=this._tables[this.__kh].values;var bo=this.__kd[this.__kh];if(!bn){return;}
;var bp=this.getValue();if(!bp){return;}
;var bm=bn.indexOf(bp);if(bm!=-1){qx.lang.Array.removeAt(bn,bm);}
else if(bn.length==this.__ki){bn.shift();}
...
;this.__kf.setRed(bx);this.__kf.setGreen(bw);this.__kf.setBlue(bv);this.__ke.open();}
,_onColorSelectorOk:function(){var by=this.__kf;this.setValue(qx.util.ColorUtil.rgbToRgbString([by.getRed(),by.getGreen(),by.getBlue()]));this.__ke.close();}
...
;}
,_tables:{core:{label:qx.locale.Manager.tr(a),values:[n,k,g,J,w,F,U,T,I,o,b,d]},recent:{label:qx.locale.Manager.tr(Q),values:[]}}},destruct:function(){if(this.__ke){this.__ke.destroy();this.__kf.destroy();this.__kg.destroy();}
...
,setValue:function(da){var cY;if(da==null){this.__jt=true;cY=[255,255,255];}
else {cY=qx.util.ColorUtil.stringToRgb(da);this.__jt=false;}
;this.__ju=true;this.setRed(cY[0]);this.setGreen(cY[1]);this.__ju=false;this.setBlue(cY[2]);}
,getValue:function(){return this.__jt?null:qx.util.ColorUtil.rgbToHexString([this.getRed(),this.getGreen(),this.getBlue()]);}
,resetValue:function(){this.__jt=true;this.__ju=true;this.setRed(255);this.setGreen(255);this.__ju=false;this.setBlue(255);}
,__jv:function(){if(!this.__ju){this.__jt=false;this.fireDataEvent(f,this.getValue());}
;}
,_applyRed:function(dc,db){if(this.__jn===null){this.__jn=bU;}
;if(this.__jn!==cK){this.getChildControl(m).setValue(dc);}
;if(this.__jn!==n){this._setHexFromRgb();}
;switch(this.__jn){case cK:case n:case bU:this._setHueFromRgb();};this._setPreviewFromRgb();this.__jv();if(this.__jn===bU){this.__jn=null;}
;}
,_applyGreen:function(de,dd){if(this.__jn===null){this.__jn=cq;}
;if(this.__jn!==cK){this.getChildControl(O).setValue(de);}
;if(this.__jn!==n){this._setHexFromRgb();}
;switch(this.__jn){case cK:case n:case cq:this._setHueFromRgb();};this._setPreviewFromRgb();this.__jv();if(this.__jn===cq){this.__jn=null;}
;}
,_applyBlue:function(dg,df){if(this.__jn===null){this.__jn=d;}
;if(this.__jn!==cK){this.getChildControl(cG).setValue(dg);}
;if(this.__jn!==n){this._setHexFromRgb();}
;switch(this.__jn){case cK:case n:case d:this._setHueFromRgb();};this._setPreviewFromRgb();this.__jv();if(this.__jn===d){this.__jn=null;}
;}
,_applyHue:function(di,dh){if(this.__jn===null){this.__jn=cr;}
;if(this.__jn!==F){this.getChildControl(cu).setValue(di);}
;if(this.__jn!==R){if(this.getChildControl(V).getBounds()){this.getChildControl(V).setDomLeft(Math.round(di/1.40625)+this.getChildControl(cc).getPaddingLeft());}
else {this.getChildControl(V).setLayoutProperties({left:Math.round(di/1.40625)});}
;}
;switch(this.__jn){case F:case R:case cr:this._setRgbFromHue();};this._setBrightnessGradiant();if(this.__jn===cr){this.__jn=null;}
;}
,_applySaturation:function(dk,dj){if(this.__jn===null){this.__jn=s;}
;if(this.__jn!==F){this.getChildControl(cx).setValue(dk);}
;if(this.__jn!==R){this._setBrightnessGradiant();if(this.getChildControl(V).getBounds()){this.getChildControl(V).setDomTop(256-Math.round(dk*2.56)+this.getChildControl(cc).getPaddingTop());}
else {this.getChildControl(V).setLayoutProperties({top:256-Math.round(dk*2.56)});}
;}
;switch(this.__jn){case F:case R:case s:this._setRgbFromHue();};if(this.__jn===s){this.__jn=null;}
;}
,_applyBrightness:function(dn,dm){if(this.__jn===null){this.__jn=c;}
;if(this.__jn!==F){this.getChildControl(bT).setValue(dn);}
;if(this.__jn!==P){var dl=256-Math.round(dn*2.56);if(this.getChildControl(cM).getBounds()){this.getChildControl(cM).setDomTop(dl+this.getChildControl(cE).getPaddingTop());}
else {this.getChildControl(cM).setLayoutProperties({top:dl});}
;}
;switch(this.__jn){case F:case P:case c:this._setRgbFromHue();};if(this.__jn===c){this.__jn=null;}
;}
,_onBrightnessHandlePointerDown:function(e){this.getChildControl(cM).capture();this.__jp=cM;var dr=this.getChildControl(cf).getContentLocation();var dq=this.getChildControl(cM).getContentLocation();var dp=this.getChildControl(cf).getBounds();this.__jq=dr.top+(e.getDocumentTop()-dq.top)-dp.top;e.stopPropagation();}
,_onBrightnessHandlePointerUp:function(e){this.getChildControl(cM).releaseCapture();this.__jp=null;}
,_onBrightnessHandlePointerMove:function(e){if(this.__jp===cM){this._setBrightnessOnFieldEvent(e);e.stopPropagation();}
;}
,_onBrightnessFieldPointerDown:function(e){var location=this.getChildControl(cf).getContentLocation();var ds=this.getChildControl(cM).getBounds();this.__jq=location.top+(ds.height/2);this._setBrightnessOnFieldEvent(e);this.getChildControl(cM).capture();this.__jp=cM;}
...
,_setBrightnessOnFieldEvent:function(e){var dt=qx.lang.Number.limit(e.getDocumentTop()-this.__jq,0,256);this.__jn=P;if(this.getChildControl(cM).getBounds()){this.getChildControl(cM).setDomTop(dt);}
else {this.getChildControl(cM).setLayoutProperties({top:dt});}
;this.setBrightness(100-Math.round(dt/2.56));this.__jn=null;}
,_onHueSaturationHandlePointerUp:function(e){if(this.__jp){e.stopPropagation();this.getChildControl(V).releaseCapture();this.__jp=null;}
;}
,_onHueSaturationHandlePointerMove:function(e){if(this.__jp===V){this._setHueSaturationOnFieldEvent(e);e.stopPropagation();}
;}
,_onHueSaturationFieldPointerDown:function(e){var location=this.getChildControl(ca).getContentLocation();var du=this.getChildControl(V).getBounds();var dv=this.getChildControl(ca).getBounds();this.__jr=location.top+(du.height/2)-dv.top;this.__js=location.left+(du.width/2)-dv.left;this._setHueSaturationOnFieldEvent(e);this.getChildControl(V).capture();this.__jp=V;}
...
,_setHueSaturationOnFieldEvent:function(e){var dy=qx.lang.Number.limit(e.getDocumentTop()-this.__jr,0,256);var dx=qx.lang.Number.limit(e.getDocumentLeft()-this.__js,0,256);this.getChildControl(V).setDomPosition(dx,dy);this.__jn=R;this.setSaturation(100-Math.round(dy/2.56));this.setHue(Math.round(dx*1.40625));this.__jn=null;}
,_setRedFromSpinner:function(){if(this.__jn!==null){return;}
;this.__jn=cK;this.setRed(this.getChildControl(m).getValue());this.__jn=null;}
,_setGreenFromSpinner:function(){if(this.__jn!==null){return;}
;this.__jn=cK;this.setGreen(this.getChildControl(O).getValue());this.__jn=null;}
,_setBlueFromSpinner:function(){if(this.__jn!==null){return;}
;this.__jn=cK;this.setBlue(this.getChildControl(cG).getValue());this.__jn=null;}
,_setHueFromSpinner:function(){if(this.__jn!==null){return;}
;this.__jn=F;this.setHue(this.getChildControl(cu).getValue());this.__jn=null;}
,_setSaturationFromSpinner:function(){if(this.__jn!==null){return;}
;this.__jn=F;this.setSaturation(this.getChildControl(cx).getValue());this.__jn=null;}
,_setBrightnessFromSpinner:function(){if(this.__jn!==null){return;}
;this.__jn=F;this.setBrightness(this.getChildControl(bT).getValue());this.__jn=null;}
,_onHexFieldChange:function(e){if(this.__jn!==null){return;}
;try{var dA=this.getChildControl(cD);var dz=qx.util.ColorUtil.hexStringToRgb(J+dA.getValue());}
catch(dB){return;}
;this.__jn=n;this.setRed(dz[0]);this.setGreen(dz[1]);this.setBlue(dz[2]);this.__jn=null;}
...
,_setHueFromRgb:function(){switch(this.__jn){case F:case R:case P:break;default:var dF=qx.util.ColorUtil.rgbToHsb([this.getRed(),this.getGreen(),this.getBlue()]);this.setHue(dF[0]);this.setSaturation(dF[1]);this.setBrightness(dF[2]);};}
,_setRgbFromHue:function(){switch(this.__jn){case cK:case n:break;default:var dG=qx.util.ColorUtil.hsbToRgb([this.getHue(),this.getSaturation(),this.getBrightness()]);this.setRed(dG[0]);this.setGreen(dG[1]);this.setBlue(dG[2]);};}
