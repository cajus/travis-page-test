...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.event.MouseEvent.969bf9ae9254.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
;qx.bom.Element.addListener(F,A,this.__MQ,this);}
...
,this);}
,__MQ:function(e){var K=e.getTarget().id.split(q)[1];var I=e.getTarget().checked;var J=document.getElementById(h);if(I){qx.bom.Element.addListener(J,K,this.logMouseEvent,this);}
