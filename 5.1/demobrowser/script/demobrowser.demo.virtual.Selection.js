...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.virtual.Selection.c941f1d4de33.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
;this.__jM=[];this.__jN=[];this._isHorizontal=(w||c)==c;}
,properties:{defaultLineColor:{init:h,check:s,themeable:true},defaultLineSize:{init:1,check:t,themeable:true}},members:{__jM:null,__jN:null,isHorizontal:function(){return this._isHorizontal;}
...
;this.__jM[B]=A;if(this.__jO(B)){this.updateLayerData();}
;}
...
;this.__jN[C]=D;if(this.__jO(C)){this.updateLayerData();}
;}
,__jO:function(E){if(this._isHorizontal){var I=this.getFirstColumn();var G=I+this.getColumnSizes().length-1;return E>=I&&E<=G;}
else {var H=this.getFirstRow();var F=H+this.getRowSizes().length-1;return E>=H&&E<=F;}
;}
,getLineSize:function(J){return this.__jN[J]||this.getDefaultLineSize();}
,getLineColor:function(K){return this.__jM[K]||this.getDefaultLineColor();}
,__jP:function(P,M,O){var top=0;var L,N;for(var y=0;y<O.length-1;y++ ){L=this.getLineColor(M+y);N=this.getLineSize(M+y);top+=O[y];P.push(m,g,f+N+q,j,d,top-((N>1)?Math.floor(N/2):1),q,b,L,n,a);}
;}
,__jQ:function(T,Q,S){var V=0;var R,U;for(var x=0;x<S.length-1;x++ ){R=this.getLineColor(Q+x);U=this.getLineSize(Q+x);V+=S[x];T.push(m,g,k+U+q,l,u,p,V-((U>1)?Math.floor(U/2):1),q,b,R,n,a);}
;}
,_fullUpdate:function(ba,bb,X,W){var Y=[];if(this._isHorizontal){this.__jP(Y,ba,X);}
else {this.__jQ(Y,bb,W);}
...
;this.__gM=qx.bom.Stylesheet.createElement(p);this.__gN={};this.__gO={};}
,members:{__gM:null,__gN:null,__gO:null,getStylesheet:function(){return this.__gM;}
,getCssClass:function(q){return this.__gN[q]||null;}
,computeClassForStyles:function(t,r){var s=this.__gO[r];if(!s){var s=this.__gP();qx.bom.Stylesheet.addRule(this.__gM,k+s,r);this.__gO[r]=s;}
;this.__gN[t]=s;return s;}
,__gP:function(){return e+this.toHashCode()+a+(this.__gQ++ );}
,__gQ:0},destruct:function(){this.__gM=this.__gN=this.__gO=null;}
});}
)();
(function(){var a="-",b="backgroundColor",c="_applyTextAlign",d="px",e="paddingLeft",f="_applyFont",g="Integer",h="_applyBackgroundColor",j="_applyPadding",k="cell",l="center",m="font",n=":",o="shorthand",p="Color",q="String",r="_applyAppearance",s="background-color:",t="",u="textAlign",v="qx-cell ",w="left",x="textColor",y="text-align:",z="Font",A="paddingBottom",B="paddingTop",C="right",D="_applyTextColor",E="justify",F="color:",G="paddingRight",H=" ",I=";",J="qx.ui.virtual.cell.Cell";qx.Class.define(J,{extend:qx.ui.virtual.cell.Abstract,construct:function(){qx.ui.virtual.cell.Abstract.call(this);this.__gM=qx.ui.virtual.cell.CellStylesheet.getInstance();this.__gY={};this.__ha={};this.__hb={};this.__hc={};this.__eS={};this.__hd={};this.initAppearance();this.__hh();}
,properties:{appearance:{check:q,init:k,apply:r},backgroundColor:{nullable:true,check:p,apply:h,themeable:true},textColor:{nullable:true,check:p,apply:D,themeable:true},textAlign:{check:[w,l,C,E],nullable:true,themeable:true,apply:c},font:{nullable:true,apply:f,check:z,themeable:true},paddingTop:{check:g,init:0,apply:j,themeable:true},paddingRight:{check:g,nullable:true,apply:j,themeable:true},paddingBottom:{check:g,nullable:true,apply:j,themeable:true},paddingLeft:{check:g,nullable:true,apply:j,themeable:true},padding:{group:[B,G,A,e],mode:o,themeable:true}},members:{__he:null,__hf:null,__eS:null,__hd:null,__ha:null,__gY:null,__hb:null,__hc:null,__hg:false,__gM:null,__hh:function(){var M=qx.util.PropertyUtil;var K=qx.lang.Object.fromArray(this._getCssProperties());this.__he=[];var O=this.constructor;while(O){var L=M.getProperties(O);for(var N in L){if(!K[N]){this.__he.push(N);}
;}
;O=O.superclass;}
;}
,_getCssProperties:function(){return [b,x,m,u,B,G,A,e];}
,_applyAppearance:function(Q,P){if(P){this.__ha={};}
;}
,_getValue:function(R){if(this.__hg){return qx.util.PropertyUtil.getThemeValue(this,R);}
else {return qx.util.PropertyUtil.getUserValue(this,R);}
;}
,_storeStyle:function(T,S){var U;if(this.__hg){U=this.__ha;}
else {U=this.__gY;}
...
;}
,_applyPadding:function(bh,bg,name){var bh=this._getValue(name);if(this.__hg){var bi=this.__hc;}
else {bi=this.__hb;}
...
;}
,getCellProperties:function(bk,bj){this.__hi(bj);return {classes:this.getCssClasses(bk,bj),style:this.getStyles(bk,bj),attributes:this.getAttributes(bk,bj),content:this.getContent(bk,bj),insets:this.getInsets(bk,bj)};}
,getAttributes:function(bm,bl){return t;}
,getContent:function(bo,bn){return bo;}
,getCssClasses:function(br,bp){var bq=this.__gM.getCssClass(this.__hf)||t;return v+bq;}
,__hi:function(bs){if(!bs){bs={};}
;var bu=this.getAppearance();var bt=bu+a+Object.keys(bs).sort().join(H);if(this.__hf==bt){return;}
;this.__hf=bt;var bv=this.__eS[this.__hf];if(!bv){this.__hj();this.__hk(bs);this.__hl(bs);this.__hm();this.__eS[this.__hf]=1;}
;this.__hn();}
,__hj:function(){var bw=qx.util.PropertyUtil;var bx=this._getCssProperties();for(var i=0;i<bx.length;i++ ){bw.deleteThemeValue(this,bx[i]);}
;}
,__hk:function(bz){this.__ha={};this.__hg=true;var bB=this.getAppearance();var bA=qx.util.PropertyUtil;var by=qx.theme.manager.Appearance.getInstance().styleFrom(bB,bz);for(var bC in by){if(by[bC]!==undefined){bA.setThemed(this,bC,by[bC]);}
;}
;this.__hg=false;}
,__hl:function(){var bD=qx.lang.Object.getValues(this.__ha).join(I);this.__gM.computeClassForStyles(this.__hf,bD);}
,__hm:function(){var bI=this.__he;var bE=qx.util.PropertyUtil;var bG={};for(var i=0;i<bI.length;i++ ){var bH=bI[i];var bF=bE.getThemeValue(this,bH);if(bF!==undefined){bG[bH]=bF;}
;}
;this.__hd[this.__hf]=bG;}
,__hn:function(){var bK=qx.util.PropertyUtil;var bJ=this.__hd[this.__hf]||{};for(var bL in bJ){bK.setThemed(this,bL,bJ[bL]);}
;}
,getStyles:function(bN,bM){return qx.lang.Object.getValues(this.__gY).join(I);}
,getInsets:function(bQ,bR){var bT=this.__hb;var bS=this.__hc;var top=(bT.paddingTop!==undefined?bT.paddingTop:bS.paddingTop)||0;var bO=(bT.paddingRight!==undefined?bT.paddingRight:bS.paddingRight)||0;var bP=(bT.paddingBottom!==undefined?bT.paddingBottom:bS.paddingBottom)||0;var bU=(bT.paddingLeft!==undefined?bT.paddingLeft:bS.paddingLeft)||0;return [bU+bO,top+bP];}
},destruct:function(){this.__gM=this.__gY=this.__ha=this.__hb=this.__hc=this.__eS=this.__hd=this.__he=null;}
});}
)();
