...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.data.Form.11c1e0fe19f1.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
;var cK=this.getContentElement();if(cF&&this.__HY){if(this.__HY){var cH=this.getInsets();this._getPlaceholderElement().setStyles({paddingTop:cH.top+cM,paddingRight:cH.right+cM,paddingBottom:cH.bottom+cM,paddingLeft:cH.left+cM});}
;}
;if(cJ||cL.margin){if(this.__HY){var cH=this.getInsets();this._getPlaceholderElement().setStyles({"width":(innerWidth-cH.left-cH.right)+cM,"height":(innerHeight-cH.top-cH.bottom)+cM});}
;cK.setStyles({"width":innerWidth+cM,"height":innerHeight+cM});this._renderContentElement(innerHeight,cK);}
;if(cL.position){if(this.__HY){this._getPlaceholderElement().setStyles({"left":cN+cM,"top":top+cM});}
;}
;}
...
;return cP;}
,_applyEnabled:function(cS,cR){qx.ui.core.Widget.prototype._applyEnabled.call(this,cS,cR);this.getContentElement().setEnabled(cS);if(this.__HY){if(cS){this._showPlaceholder();}
else {this._removePlaceholder();}
;}
else {var cQ=this.getContentElement();cQ.setAttribute(bW,cS?this.getPlaceholder():cm);}
;}
,__Ia:{width:16,height:16},_getContentHint:function(){return {width:this.__Ia.width*10,height:this.__Ia.height||16};}
,_applyFont:function(cV,cU){if(cU&&this.__vd&&this.__vg){this.__vd.removeListenerById(this.__vg);this.__vg=null;}
;var cT;if(cV){this.__vd=qx.theme.manager.Font.getInstance().resolve(cV);if(this.__vd instanceof qx.bom.webfonts.WebFont){this.__vg=this.__vd.addListener(C,this._onWebFontStatusChange,this);}
;cT=this.__vd.getStyles();}
...
;if(this.__HY){delete cT[F];this._getPlaceholderElement().setStyles(cT);}
;if(cV){this.__Ia=qx.bom.Label.getTextSize(D,cT);}
...
,_onHtmlInput:function(e){var dd=e.getData();var dc=true;this.__jt=false;if(this.__vv&&this.__vv===dd){dc=false;}
...
;}
;if(dc){this.fireDataEvent(r,dd,this.__vv);this.__vv=dd;if(this.getLiveUpdate()){this.__jv(dd);}
;}
;}
,_onWebFontStatusChange:function(dh){if(dh.getData().valid===true){var dg=this.__vd.getStyles();this.__Ia=qx.bom.Label.getTextSize(D,dg);qx.ui.core.queue.Layout.add(this);}
;}
,__jv:function(dj){var di=this.__eM;this.__eM=dj;if(di!=dj){this.fireNonBubblingEvent(c,qx.event.type.Data,[dj,di]);}
;}
,setValue:function(dn){if(this.isDisposed()){return null;}
;if(dn===null){if(this.__jt){return dn;}
;dn=cm;this.__jt=true;}
else {this.__jt=false;if(this.__HY){this._removePlaceholder();}
;}
;if(qx.lang.Type.isString(dn)){var dm=this.getContentElement();if(dm.getValue()!=dn){var dk=dm.getValue();dm.setValue(dn);var dl=this.__jt?null:dn;this.__eM=dk;this.__jv(dl);this.__vv=this.__eM;}
;if(this.__HY){this._showPlaceholder();}
;return dn;}
;throw new Error(J+dn);}
,getValue:function(){return (this.isDisposed()||this.__jt)?null:this.getContentElement().getValue();}
,resetValue:function(){this.setValue(null);}
,_onChangeContent:function(e){this.__jt=e.getData()===null;this.__jv(e.getData());}
...
,setLayoutParent:function(parent){qx.ui.core.Widget.prototype.setLayoutParent.call(this,parent);if(this.__HY){if(parent){this.getLayoutParent().getContentElement().add(this._getPlaceholderElement());}
...
.bind(this),0);}
,_removePlaceholder:function(){if(this.hasState(j)){if(this.__HY){this._getPlaceholderElement().setStyle(cv,Y);}
;this.removeState(j);}
;}
,_syncPlaceholder:function(){if(this.hasState(j)&&this.__HY){this._getPlaceholderElement().setStyle(cv,M);}
;}
...
;if(!this.__HY&&qx.ui.form.AbstractField.__gM){qx.bom.Stylesheet.removeSheet(qx.ui.form.AbstractField.__gM);qx.ui.form.AbstractField.__gM=null;qx.ui.form.AbstractField.__HX();}
;}
,_applyPlaceholder:function(dw,dv){if(this.__HY){this._getPlaceholderElement().setValue(dw);if(dw!=null){this.addListener(V,this._removePlaceholder,this);this.addListener(ct,this._showPlaceholder,this);this._showPlaceholder();}
...
;this._placeholder=this.__vd=null;if(qx.core.Environment.get(s)){qx.locale.Manager.getInstance().removeListener(cg,this._onChangeLocale,this);}
;if(this.__vd&&this.__vg){this.__vd.removeListenerById(this.__vg);}
...
;qx.html.Element.call(this,t,q,r);this.__gt=s;}
,members:{__gt:null,__Ib:null,__Ic:null,_createDomElement:function(){return qx.bom.Input.create(this.__gt);}
...
;}
,setEnabled:function(w){this.__Ic=w;this.setAttribute(l,w===false);if(qx.core.Environment.get(a)==g){if(!w){this.setStyles({"userModify":m,"userSelect":d});}
else {this.setStyles({"userModify":null,"userSelect":this.__Ib?null:d});}
;}
;}
,setSelectable:qx.core.Environment.select(a,{"webkit":function(x){this.__Ib=x;qx.html.Element.prototype.setSelectable.call(this,this.__Ic&&x);}
...
,properties:{appearance:{refine:true,init:t}},members:{__Lu:null,_createChildControlImpl:function(B,A){var z;switch(B){case s:z=new qx.ui.core.Spacer();this._add(z,{flex:1});break;case y:z=new qx.ui.basic.Atom(v);z.setCenter(false);z.setAnonymous(true);this._add(z,{flex:1});break;case n:z=new qx.ui.basic.Image();z.setAnonymous(true);this._add(z);break;};return z||qx.ui.form.AbstractSelectBox.prototype._createChildControlImpl.call(this,B);}
...
,__cI:function(e){var D=e.getData()[0];var C=this.getChildControl(l);if(C.getSelection()[0]!=D){if(D){C.setSelection([D]);}
else {C.resetSelection();}
;}
;this.__Lv();this.__Lw();}
,__Lv:function(){var F=this.getChildControl(l).getSelection()[0];var E=this.getChildControl(y);var G=F?F.getIcon():q;G==null?E.resetIcon():E.setIcon(G);}
,__Lw:function(){var J=this.getChildControl(l).getSelection()[0];var H=this.getChildControl(y);var I=J?J.getLabel():q;var K=this.getFormat();if(K!=null){I=K.call(this,J);}
...
,_onKeyPress:function(e){var L=e.getKeyIdentifier();if(L==b||L==i){if(this.__Lu){this.setSelection([this.__Lu]);this.__Lu=null;}
;this.toggle();}
...
,_onListPointerDown:function(e){if(this.__Lu){this.setSelection([this.__Lu]);this.__Lu=null;}
;}
,_onListChangeSelection:function(e){var Q=e.getData();var O=e.getOldData();if(O&&O.length>0){O[0].removeListener(h,this.__Lv,this);O[0].removeListener(g,this.__Lw,this);}
;if(Q.length>0){var N=this.getChildControl(u);var P=this.getChildControl(l);var R=P.getSelectionContext();if(N.isVisible()&&(R==p||R==k)){this.__Lu=Q[0];}
else {this.setSelection([Q[0]]);this.__Lu=null;}
;Q[0].addListener(h,this.__Lv,this);Q[0].addListener(g,this.__Lw,this);}
...
(function(){var a="Widgets supporting selection can only be validated ",b="Added widget not supported.",c="",d="in the form validator",f="mouse",g="changeValid",h="qx.event.type.Event",j="complete",k="value instanceof Function || qx.Class.isSubClassOf(value.constructor, qx.ui.form.validation.AsyncValidator)",l="qx.ui.form.validation.Manager",m="This field is required",n="String",o="qx.event.type.Data";qx.Class.define(l,{extend:qx.core.Object,construct:function(){qx.core.Object.call(this);this.__Lz=[];this.__LA={};this.setRequiredFieldMessage(qx.locale.Manager.tr(m));}
,events:{"changeValid":o,"complete":h},properties:{validator:{check:k,init:null,nullable:true},invalidMessage:{check:n,init:c},requiredFieldMessage:{check:n,init:c},context:{nullable:true}},members:{__Lz:null,__LB:null,__LA:null,__LC:null,add:function(s,p,r){if(!this.__LF(s)){throw new Error(b);}
;if(this.__LG(s)&&!s.getValue){if(p!=null){throw new Error(a+d);}
;}
;var q={item:s,validator:p,valid:null,context:r};this.__Lz.push(q);}
,remove:function(v){var t=this.__Lz;for(var i=0,u=t.length;i<u;i++ ){if(v===t[i].item){t.splice(i,1);return v;}
;}
;return null;}
,getItems:function(){var w=[];for(var i=0;i<this.__Lz.length;i++ ){w.push(this.__Lz[i].item);}
;return w;}
,validate:function(){var B=true;this.__LC=true;var y=[];for(var i=0;i<this.__Lz.length;i++ ){var z=this.__Lz[i].item;var C=this.__Lz[i].validator;y.push(z);if(C==null){var x=this._validateRequired(z);B=B&&x;this.__LC=x&&this.__LC;continue;}
;var x=this._validateItem(this.__Lz[i],z.getValue());B=x&&B;if(x!=null){this.__LC=x&&this.__LC;}
;}
;var A=this.__LD(y);if(qx.lang.Type.isBoolean(A)){this.__LC=A&&this.__LC;}
;B=A&&B;this._setValid(B);if(qx.lang.Object.isEmpty(this.__LA)){this.fireEvent(j);}
;return B;}
,_validateRequired:function(E){if(E.getRequired()){if(this.__LG(E)){var D=!!E.getSelection()[0];}
...
;return true;}
,_validateItem:function(K,L){var M=K.item;var O=K.context;var N=K.validator;if(this.__LE(N)){this.__LA[M.toHashCode()]=null;N.validate(M,M.getValue(),this,O);return null;}
...
,__LD:function(Q){var R=this.getValidator();var S=this.getContext()||this;if(R==null){return true;}
;this.setInvalidMessage(c);if(this.__LE(R)){this.__LA[this.toHashCode()]=null;R.validateForm(Q,this,S);return null;}
...
;}
;return T;}
,__LE:function(V){var U=false;if(!qx.lang.Type.isFunction(V)){U=qx.Class.isSubClassOf(V.constructor,qx.ui.form.validation.AsyncValidator);}
;return U;}
,__LF:function(W){var X=W.constructor;return qx.Class.hasInterface(X,qx.ui.form.IForm);}
,__LG:function(Y){var ba=Y.constructor;return qx.Class.hasInterface(ba,qx.ui.core.ISingleSelection);}
,_setValid:function(bb){this._showToolTip(bb);var bc=this.__LB;this.__LB=bb;if(bc!=bb){this.fireDataEvent(g,bb,bc);}
;}
,_showToolTip:function(bg){if(!qx.ui.tooltip||!qx.ui.tooltip.Manager){return;}
;var be=qx.ui.tooltip.Manager.getInstance().getSharedErrorTooltip();if(!bg){var bd;for(var i=0;i<this.__Lz.length;i++ ){var bf=this.__Lz[i].item;if(!bf.isValid()){bd=bf;if(!(bf.getContentLocation)){return;}
...
;}
,getValid:function(){return this.__LB;}
,isValid:function(){return this.getValid();}
,getInvalidMessages:function(){var bh=[];for(var i=0;i<this.__Lz.length;i++ ){var bi=this.__Lz[i].item;if(!bi.getValid()){bh.push(bi.getInvalidMessage());}
;}
;if(this.getInvalidMessage()!=c){bh.push(this.getInvalidMessage());}
;return bh;}
,getInvalidFormItems:function(){var bj=[];for(var i=0;i<this.__Lz.length;i++ ){var bk=this.__Lz[i].item;if(!bk.getValid()){bj.push(bk);}
;}
;return bj;}
,reset:function(){for(var i=0;i<this.__Lz.length;i++ ){var bl=this.__Lz[i];bl.item.setValid(true);}
;this.__LB=null;this._showToolTip(true);}
,setItemValid:function(bn,bm){this.__LA[bn.toHashCode()]=bm;bn.setValid(bm);this.__LH();}
,setFormValid:function(bo){this.__LA[this.toHashCode()]=bo;this.__LH();}
,__LH:function(){var bq=this.__LC;for(var br in this.__LA){var bp=this.__LA[br];bq=bp&&bq;if(bp==null){return;}
;}
;this._setValid(bq);this.__LA={};this.fireEvent(j);}
},destruct:function(){this.__Lz=null;}
});}
)();
(function(){var a="qx.ui.form.validation.AsyncValidator";qx.Class.define(a,{extend:qx.core.Object,construct:function(b){qx.core.Object.call(this);this.__LI=b;}
,members:{__LI:null,__LJ:null,__u:null,__LK:null,validate:function(c,e,d,f){this.__LK=false;this.__LJ=c;this.__u=d;this.__LI.call(f||this,this,e);}
,validateForm:function(g,h,i){this.__LK=true;this.__u=h;this.__LI.call(i,g,this);}
,setValid:function(k,j){if(this.__LK){if(j!==undefined){this.__u.setInvalidMessage(j);}
;this.__u.setFormValid(k);}
else {if(j!==undefined){this.__LJ.setInvalidMessage(j);}
;this.__u.setItemValid(this.__LJ,k);}
;}
},destruct:function(){this.__u=this.__LJ=null;}
});}
)();
