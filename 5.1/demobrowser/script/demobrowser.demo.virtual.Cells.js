...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.virtual.Cells.e3f5a222df43.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
,testStringCell:function(){var J={value:[A,p,r,null],states:[{},{selected:1}]};var I=new qx.ui.virtual.cell.String;qx.util.Permutation.permute(J,function(L){var K=this.__tE(I,L.value,L.states);this.container.add(K);}
,this);}
...
;var O=this.__tE(N,P.value,P.states);this.container.add(O);}
,this);}
...
;var S=this.__tE(R,T.value,T.states);this.container.add(S);}
,this);}
,testHtmlCell:function(){var U={value:[A,p,r,null],states:[{},{selected:1}]};var V=new qx.ui.virtual.cell.Html;qx.util.Permutation.permute(U,function(X){var W=this.__tE(V,X.value,X.states);this.container.add(W);}
,this);}
,testImageCell:function(){var Y={value:[{url:C,tooltip:E},{url:w,tooltip:u},null],states:[{},{selected:1}]};var ba=new qx.ui.virtual.cell.Image;qx.util.Permutation.permute(Y,function(bc){var bb=this.__tE(ba,bc.value,bc.states);this.container.add(bb);}
,this);}
,testBooleanCell:function(){var bd={value:[true,false,null],states:[{},{selected:1}]};var be=new qx.ui.virtual.cell.Boolean;qx.util.Permutation.permute(bd,function(bg){var bf=this.__tE(be,bg.value,bg.states);this.container.add(bf);}
,this);}
,testBooleanCellCustomImage:function(){var bh={value:[true,false,null],states:[{},{selected:1}]};var bi=new qx.ui.virtual.cell.Boolean;bi.setIconFalse(B);bi.setIconTrue(D);qx.util.Permutation.permute(bh,function(bk){var bj=this.__tE(bi,bk.value,bk.states);this.container.add(bj);}
,this);}
,__tE:function(bn,bo,bq){var br=100;var bp=30;var bt=new qx.ui.embed.Html().set({width:br,height:bp,decorator:bq.selected?null:z});var bm=bn.getCellProperties(bo,bq);var bl=bm.insets;var bs=[d,F,this._getCellSizeStyle(br,bp,bl[0],bl[1]),bm.style,e,g,bm.classes,e,bm.attributes,l,bm.content,c].join(r);bt.setHtml(bs);return bt;}
...
,members:{__lC:16,__lD:16,_aliasManager:null,__lF:function(v){var w=qx.util.ResourceManager.getInstance();var u=qx.io.ImageLoader;var t,x;if(w.has(v)){t=w.getImageWidth(v),x=w.getImageHeight(v);}
else if(u.isLoaded(v)){t=u.getWidth(v);x=u.getHeight(v);}
else {t=this.__lC;x=this.__lD;}
;return {width:t,height:x};}
,__mt:function(z){if(typeof (z)==r){z={url:z};}
...
(function(){var a="_applyIconFalse",b="qx.ui.virtual.cell.Boolean",c="_applyIconTrue",d="String",e="cell-boolean";qx.Class.define(b,{extend:qx.ui.virtual.cell.AbstractImage,construct:function(){qx.ui.virtual.cell.AbstractImage.call(this);this.__lL=qx.util.AliasManager.getInstance();}
,properties:{appearance:{refine:true,init:e},iconTrue:{check:d,themeable:true,apply:c},iconFalse:{check:d,themeable:true,apply:a}},members:{__oc:null,__od:null,__lL:null,_applyIconTrue:function(f){this.__oc=this.__lL.resolve(f);}
,_applyIconFalse:function(g){this.__od=this.__lL.resolve(g);}
,_identifyImage:function(h){return h==true?this.__oc:this.__od;}
}});}
)();
