...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.virtual.CellEvents.ffe42850670f.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
,_onCellTap:function(e){var q=f+e.getRow()+i+e.getColumn()+h;this.__Of(q);}
,_onContextMenu:function(e){var r=d+e.getRow()+i+e.getColumn()+h;this.__Of(r);}
,_onDbltapPane:function(e){var s=g+e.getRow()+i+e.getColumn()+h;this.__Of(s);}
