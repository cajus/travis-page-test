...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.bom.PageVisibility.a47ddb4e76ec.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
;return this.$$instance;}
},construct:function(document){this.__b=document||window.document;this.__nH();var self=this;qx.bom.Event.addNativeListener(this.__b,this.__nG,function(e){self.emit(a,e);}
);}
,events:{"change":h},members:{__b:null,__sS:null,__sT:null,__nG:null,__nH:function(){var l=qx.bom.Style.VENDOR_PREFIXES;for(var i=0;i<l.length;i++ ){var m=l[i].toLowerCase()+f;if(this.__b[m]!=undefined){this.__sS=m;this.__nG=l[i].toLowerCase()+c;break;}
;}
;for(var i=0;i<l.length;i++ ){var m=l[i].toLowerCase()+j;if(this.__b[m]!=undefined){this.__sT=m;break;}
;}
;if(this.__sS==null){this.__sS=k;this.__nG=c;}
;if(this.__sT==null){this.__sT=b;}
;}
,isHidden:function(){return !!this.__b[this.__sS];}
,getVisibilityState:function(){return this.__b[this.__sT]||d;}
}});}
)();
