...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.widget.Iframe.7142ff11748d.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
,properties:{appearance:{refine:true,init:r},scrollbarX:{check:[u,q,o],init:u,themeable:true,apply:i},scrollbarY:{check:[u,q,o],init:u,themeable:true,apply:i},scrollbar:{group:[k,l]}},members:{__jI:null,__jJ:null,_getIframeElement:function(){return this.getChildControl(j).getContentElement();}
...
;}
,_startIframeObserver:function(){if(this.__jJ){this._stopIframeObserver();}
;var F=qx.event.Idle.getInstance();this.__jJ=F.addListener(c,this._onIframeObserverInterval,this);}
,_stopIframeObserver:function(){this.__jI=null;if(!this.__jJ){return;}
;var G=qx.event.Idle.getInstance();G.removeListenerById(this.__jJ);}
,_onIframeObserverInterval:function(){var H=this._getIframeSize();if(!H){this._disableScollbars();return;}
;if(this.__jI&&H.width==this.__jI.width&&H.height==this.__jI.height){return;}
;this.__jI=H;this._preventIframeScrolling();this._updateScrollbars();}
...
;}
,_updateScrollbars:function(){var K=this.__jI;var N=this.getChildControl(j).getBounds();var L=this.getChildControl(j).getInnerSize();if(!K||!L||!L){return;}
...
;}
},destruct:function(){this._stopIframeObserver();this.__jI=null;}
});}
)();
