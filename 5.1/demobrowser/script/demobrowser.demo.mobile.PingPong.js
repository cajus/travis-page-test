...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.mobile.PingPong.1451699932b5.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
;this.__Ni=this.__Nn(L);U.add(this.__Ni);var Q=this.__Nn(A);U.add(Q);this.__MY=this.__No(L);this.__Ni.add(this.__MY);this.__Ni.addListener(M,qx.lang.Function.bind(this.__Nm,this),this);this.__MX=this.__No(A);Q.add(this.__MX);Q.addListener(M,qx.lang.Function.bind(this.__Nm,this),this);this.__Na=this.__Np();U.add(this.__Na);this.__Ng=this.__Nq();this.__Ni.add(this.__Ng);this.__Nh=this.__Nq();Q.add(this.__Nh);this.__Nf=[0,0];this.__Nj();}
...
;var Y=this.getBoundsFor(this.__MY);if(X.left<=Y.right&&X.bottom>=Y.top&&X.top<=Y.bottom){this.__Nd=1;this.__Nc=Math.min(this.__Nc+1,20);}
;var W=this.getBoundsFor(this.__MX);if(X.right>=W.left&&X.bottom>=W.top&&X.top<=W.bottom){this.__Nd=-1;this.__Nc=Math.min(this.__Nc+1,20);}
;}
,__Nm:function(e){var ba;if(qx.dom.Hierarchy.contains(this.__Ni.getDomElement(),e.getTarget())){ba=this.__MY;}
else {ba=this.__MX;}
...
,__Nn:function(bd){var bc={"width":C,"height":h,"position":N,"backgroundColor":a};if(bd==L){bc[J]=u;}
else {bc[L]=C;bc[d]=u;}
;return new qx.html.Element(g,bc);}
,__No:function(bf){var be={"width":l,"height":t,"top":t,"position":N,"backgroundColor":K};be[bf]=F;return new qx.html.Element(g,be);}
,__Np:function(){var bg={"width":F,"height":F,"position":N,"backgroundColor":K,"userSelect":I};return new qx.html.Element(g,bg);}
,__Nq:function(){var bh={"width":h,"height":h,"textAlign":r,"fontSize":H,"color":b,"fontFamily":B};var bi=new qx.html.Element(g,bh);bi.setAttribute(w,j);return bi;}
}});}
)();
