...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.virtual.Gallery.3f995642f935.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
;}
}});qx.Class.define(f,{extend:demobrowser.demo.virtual.AbstractGallery,construct:function(bv){demobrowser.demo.virtual.AbstractGallery.call(this,bv);this.__Oj=new demobrowser.demo.virtual.GalleryCell();}
,members:{__Oj:null,_createScroller:function(){var bw=new qx.ui.virtual.core.Scroller(1,this.itemPerLine,this.itemHeight,this.itemWidth);this.layer=new qx.ui.virtual.layer.WidgetCell(this);bw.getPane().addLayer(this.layer);new qx.ui.virtual.behavior.Prefetch(bw,{minLeft:0,maxLeft:0,minRight:0,maxRight:0,minAbove:200,maxAbove:300,minBelow:600,maxBelow:800}).set({interval:500});return bw;}
...
;if(by){this.__Oj.updateStates(bx,{selected:1});}
else {this.__Oj.updateStates(bx,{});}
;}
;}
...
;var bE=this.__Oj.getCellWidget(bF,bD);bE.setUserData(n,bH);return bE;}
,poolCellWidget:function(bJ){this.__Oj.pool(bJ);}
},destruct:function(){this._disposeObjects(o,r);}
...
;var bS=this.manager.isItemSelected({row:bV,column:bR});var bU=bS?l:v;return {style:[J,h,this._fontCss,bU].join(v),content:[p,bT.resolvedIcon,q,N,bT.label].join(v)};}
...
(function(){var a="_applyInterval",b="__do",c="appear",d="qx.debug",e="interval",f="qx.ui.virtual.behavior.Prefetch",g="scroll",h="_applyScroller",i="qx.ui.virtual.core.Scroller",j="scrollbar-x",k="Integer",l="scrollbar-y";qx.Class.define(f,{extend:qx.core.Object,construct:function(m,n){if(qx.core.Environment.get(d)){this.assertObject(n);this.assertPositiveInteger(n.minLeft);this.assertPositiveInteger(n.maxLeft);this.assertPositiveInteger(n.minRight);this.assertPositiveInteger(n.maxRight);this.assertPositiveInteger(n.minAbove);this.assertPositiveInteger(n.maxAbove);this.assertPositiveInteger(n.minBelow);this.assertPositiveInteger(n.maxBelow);}
;qx.core.Object.call(this);this.setPrefetchX(n.minLeft,n.maxLeft,n.minRight,n.maxRight);this.setPrefetchY(n.minAbove,n.maxAbove,n.minBelow,n.maxBelow);this.__do=new qx.event.Timer(this.getInterval());this.__do.addListener(e,this._onInterval,this);if(m){this.setScroller(m);}
;}
,properties:{scroller:{check:i,nullable:true,init:null,apply:h},interval:{check:k,init:200,apply:a}},members:{__zA:null,__zB:null,__do:null,__zC:null,__zD:null,setPrefetchX:function(o,r,p,q){this.__zA=[o,r,p,q];}
,setPrefetchY:function(v,u,t,s){this.__zB=[v,u,t,s];}
,_onInterval:function(){var w=this.__zA;if(w[1]&&w[3]){this.getScroller().getPane().prefetchX(w[0],w[1],w[2],w[3]);qx.ui.core.queue.Manager.flush();}
;var x=this.__zB;if(x[1]&&x[3]){this.getScroller().getPane().prefetchY(x[0],x[1],x[2],x[3]);qx.ui.core.queue.Manager.flush();}
;}
,_applyScroller:function(z,y){if(y){if(this.__zC){y.getChildControl(j).removeListenerById(this.__zC);}
;if(this.__zD){y.getChildControl(l).removeListenerById(this.__zD);}
;}
;if(z){if(!z.getContentElement().getDomElement()){this.__do.stop();z.addListenerOnce(c,this.__do.start,this.__do);}
else {this.__do.restart();}
;this.__zC=z.getChildControl(j).addListener(g,this.__do.restart,this.__do);this.__zD=z.getChildControl(l).addListener(g,this.__do.restart,this.__do);}
else {this.__do.stop();}
;}
,_applyInterval:function(B,A){this.__do.setInterval(B);}
},destruct:function(){this.setScroller(null);this.__zA=this.__zB=null;this._disposeObjects(b);}
});}
)();
