...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.ui.CommandGroupManager.1129756cad1e.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="qx.ui.command.GroupManager",b="Group must be an instance of qx.ui.command.Group",c="qx.debug",d="Group was not added before. Please use ",e="'add()' method to add the group.",f="Given group is not an instance of qx.ui.command.Group",g="Group was not added before! You have to use 'addCommand()' method before activating!",h="Group is already added!";qx.Class.define(a,{extend:qx.core.Object,construct:function(){qx.core.Object.call(this);this.__tu=[];}
,members:{__tu:null,__tv:null,add:function(j){if(qx.core.Environment.get(c)){this.assertInstance(j,qx.ui.command.Group,f);}
;if(qx.lang.Array.contains(this.__tu,j)){if(qx.core.Environment.get(c)){this.debug(h);}
;return false;}
;this.__tu.push(j);j.setActive(false);return true;}
...
;var l=this.__tu.indexOf(m);if(l===-1){if(qx.core.Environment.get(c)){this.debug(d+e);}
;}
;if(this.getActive()===m){this.__tv=null;}
;this.__tu.splice(l,1);return m;}
...
;return false;}
;for(var i=0;i<this.__tu.length;i++ ){var n=this.__tu[i];if(n==o){n.setActive(true);this.__tv=n;continue;}
;n.setActive(false);}
;return true;}
,getActive:function(){return this.__tv;}
,block:function(){if(this.__tv){this.__tv.setActive(false);}
;}
,unblock:function(){if(this.__tv){this.__tv.setActive(true);}
;}
,_getGroup:function(q){var p=this.__tu.indexOf(q);if(p===-1){return null;}
;return this.__tu[p];}
},destruct:function(){this.__tu=this.__tv=null;}
});}
)();
